...
If FormAddEditMode = cFORM_ADDMODE Then
    ...
    Rem Vigen database
    CreateVgnCmpDatabase mAddMode:=True, FormProgStatus:=MyProgStatForm
    CreateVgnMastDatabase mAddMode:=True, FormProgStatus:=MyProgStatForm
    CreateVgnTranDatabase mAddMode:=False, FormProgStatus:=MyProgStatForm    ' already created just above
