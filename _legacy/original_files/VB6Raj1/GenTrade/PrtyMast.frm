...
Dim clsAH As clsAccountHead, clsPRT As clsGtdMasterEntry, clsARA As clsComMastEntry, clsSTN As clsComMastEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
Dim fcmbAhName As clsComFlexSearch, fcmbAraName As clsComFlexSearch, fcmbStnName As clsComFlexSearch
Dim fcmbPrtName As clsGtdFlexSearch
...
fcmbAhName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbGtdDatabase, mTableName:="PartyMast", mColumnName:="PrtAhCode", mOrderByColName:="PrtCode", mRtnDefValue:=0))
txtAhName.Text = fcmbAhName.Text

fcmbAraName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbGtdDatabase, mTableName:="PartyMast", mColumnName:="PrtAraCode", mOrderByColName:="PrtCode", mRtnDefValue:=0))
txtAraName.Text = fcmbAraName.Text

fcmbStnName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbGtdDatabase, mTableName:="PartyMast", mColumnName:="PrtStnCode", mOrderByColName:="PrtCode", mRtnDefValue:=0))
