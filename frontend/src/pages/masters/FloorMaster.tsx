      ...
      {(!isEditing && !selectedItem) ? (
        ...
        <form ref={formRef} onSubmit={handleSave} className="space-y-6 max-w-lg">
          <div>
            ...
            <input type="text" required disabled={!isEditing} value={formData.FlrName} onChange={(e) => setFormData({ ...formData, FlrName: e.target.value })} className="input-field" placeholder="e.g. First Floor" />
          </div>
          <div>
