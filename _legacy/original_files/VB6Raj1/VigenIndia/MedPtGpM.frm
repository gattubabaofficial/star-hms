...
Begin VB.Form frmMedPartyGrpMast 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ClientHeight    =   8220
   ClientLeft      =   60
   ...
   Begin VB.ComboBox cmbFormEntryMode 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "MedPtGpM.frx":0000
      Left            =   0
      List            =   "MedPtGpM.frx":000D
   ...
   End
End
Attribute VB_Name = "frmMedPartyGrpMast"
...
Dim clsMPG As clsVgnMasterEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
...
Set clsMPG = New clsVgnMasterEntry
Set clsMPG.dbVgnDatabase = dbVgnDatabase
...
If txtMpgName.Text <> mMpgName_old Then
    If ChkIsDuplicate(dbVgnDatabase, "MedPrtGrpMst", "MpgName", txtMpgName.Text, "MpgCode", Val(mskFormBoundField.Text)) = True Then
