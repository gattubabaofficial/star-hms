...
If FormAddEditMode = cFORM_ADDMODE Then
    ...
    Rem general trading database
    CreateKgtCmpDatabase mAddMode:=True, FormProgStatus:=MyProgStatForm
    CreateKgtMastDatabase mAddMode:=True, FormProgStatus:=MyProgStatForm
    CreateKgtTranDatabase mAddMode:=False, FormProgStatus:=MyProgStatForm    ' already created just above
