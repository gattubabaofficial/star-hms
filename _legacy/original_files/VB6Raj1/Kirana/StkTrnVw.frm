...
If optMonthwise.Value = True Or optDatewise.Value = True Or optPartywise.Value = True Or optItemWise.Value = True Or optVTypewise.Value = True Then
    If optMonthwise.Value = True Then
        ...
        clsListStru.AddFields mExpr:="TrnOutPckQty_sum", mTitle:="Pack/Bag", mShowItem:=True, mAlign:=7, mWidth:=1500
        ...
        mQryStr = "Select format(TrnDate,'yyyy/MM') as TrnYrMonth" _
         & ",Count(TrnCode) as TrnCount" _
         & ",Sum(TrnOutPckQty) as TrnOutPckQty_sum" _
    ...
    ElseIf optPartywise.Value = True Then
        ...
        mQryStr = "Select prt.PrtName,t1.TrnPrtCode" _
         & ",Count(TrnCode) as TrnCount" _
         & ",Sum(t1.TrnOutPckQty) as TrnOutPckQty_sum" _
         & ",Sum(t1.TrnQty) as TrnQty_sum" _
         & ",Sum(t1.TrnAmount) as TrnAmount_sum"
        mQryStr = mQryStr & " from ("
        Rem reserved query string producing no records
        mQryStr = mQryStr & "Select PuhPrtCode as TrnPrtCode" _
         & ",PuhVtmCode as TrnVtmCode" _
         & ",PurCode as TrnCode" _
         & ",PurOutPckQty as TrnOutPckQty" _
         & ",PurQty as TrnQty" _
        ...
        If chkFBySale.Value = vbChecked = True Then
            mQryStr = mQryStr & " UNION ALL "
            mQryStr = mQryStr & " Select SahPrtCode as TrnPrtCode" _
             & ",SahVtmCode as TrnVtmCode" _
             & ",SalCode as TrnCode" _
             & ",SalOutPckQty as TrnOutPckQty" _
             & ",SalQty as TrnQty" _
    ...
    ElseIf optVTypewise.Value = True Then
        ...
        mQryStr = "Select vtm.VtmName,t1.TrnVtmCode" _
         & ",Count(TrnCode) as TrnCount" _
         & ",Sum(t1.TrnOutPckQty) as TrnOutPckQty_sum" _
         & ",Sum(t1.TrnQty) as TrnQty_sum" _
         & ",Sum(t1.TrnAmount) as TrnAmount_sum"
        ...
        Rem ----------------------------------
        mQryStr = mQryStr & ")"
        mQryStr = mQryStr & " as t1 inner join VTypMast vtm on t1.TrnVtmCode = vtm.VtmCode" _
         & " group by vtm.VtmName,t1.TrnVtmCode" _
         & " order by vtm.VtmName,t1.TrnVtmCode"
...
If .EOF = False Then
    Do While .EOF = False
        If optMonthwise.Value = True Then
            ...
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnOutPckQty_sum")) = ToMyNumFmt(.fields("TrnOutPckQty_sum"), mDecimals:=-1)
...
'''            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("PatStnName")) = .fields("StnName")
        ...
        Else
            ...
            mOutPckQty_Tot = mOutPckQty_Tot + .fields("TrnOutPckQty_sum")
...
If optMonthwise.Value = True Then
    ...
    Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnOutPckQty_sum")) = ToMyNumFmt(mOutPckQty_Tot, mDecimals:=-1)
