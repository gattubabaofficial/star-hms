...
Dim clsSIG As clsHmsMasterEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
...
If txtSigName.Text <> mSigName_old Then
    If ChkIsDuplicate(dbHmsDatabase, "SubItmGrpMst", "SigName", txtSigName.Text, "SigCode", Val(mskFormBoundField.Text)) = True Then
