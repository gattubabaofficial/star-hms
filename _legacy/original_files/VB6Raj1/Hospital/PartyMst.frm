...
Dim clsAH As clsAccountHead, clsPRT As clsHmsMasterEntry, clsARA As clsComMastEntry, clsSTN As clsComMastEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
Dim fcmbAhName As clsComFlexSearch, fcmbAraName As clsComFlexSearch, fcmbStnName As clsComFlexSearch
Dim fcmbPgmName As clsHmsFlexSearch
...
Set fcmbPgmName = New clsHmsFlexSearch
Set fcmbPgmName.dbHmsDatabase = dbHmsDatabase
...
fcmbAhName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbHmsDatabase, mTableName:="PartyMast", mColumnName:="PrtAhCode", mOrderByColName:="PrtCode", mRtnDefValue:=0))
txtAhName.Text = fcmbAhName.Text
fcmbPgmName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbHmsDatabase, mTableName:="PartyMast", mColumnName:="PrtPgmCode", mOrderByColName:="PrtCode", mRtnDefValue:=0))
txtPgmName.Text = fcmbPgmName.Text
