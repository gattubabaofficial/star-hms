...
Dim fcmbAdmIpdByIpdNo As clsHmsFlexSearch, fcmbAdmIpdByPttRegNo As clsHmsFlexSearch, fcmbAdmIpdByPttName As clsHmsFlexSearch, fcmbPttName As clsHmsFlexSearch, fcmbPttRegNo As clsHmsFlexSearch, fcmbPcgName As clsHmsFlexSearch, fcmbCDctName As clsHmsFlexSearch, fcmbRByName As clsHmsFlexSearch, fcmbFDigName As clsHmsFlexSearch, fcmbBdmName As clsHmsFlexSearch, fcmbNextBdmName As clsHmsFlexSearch
Dim fcmbWrdName As clsHmsFlexSearch, fcmbFlrName As clsHmsFlexSearch
Dim frmTrn As Form
...
Const X2TRNDRAMT_COL = 7
Const X2TRNCRAMT_COL = 8
Const X2TRNRUNBALAMT_COL = 9
Const X2TRNDISCAMT_COL = 10
...
Set fcmbAdmIpdByIpdNo = New clsHmsFlexSearch
Set fcmbAdmIpdByIpdNo.dbHmsDatabase = dbHmsDatabase
Set fcmbAdmIpdByIpdNo.dbComDatabase = dbComDatabase
fcmbAdmIpdByIpdNo.blnAdmIpgListByIpgNo = True
fcmbAdmIpdByIpdNo.Init

Set fcmbAdmIpdByPttRegNo = New clsHmsFlexSearch
Set fcmbAdmIpdByPttRegNo.dbHmsDatabase = dbHmsDatabase
...
Set fcmbAdmIpdByPttName = New clsHmsFlexSearch
Set fcmbAdmIpdByPttName.dbHmsDatabase = dbHmsDatabase
...
colcnt = X2TRNAMTAFTDISC_COL: Mfgrd2.ColWidth(colcnt) = 0: Mfgrd2.TextMatrix(0, colcnt) = "Amount": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2TRNDRAMT_COL: Mfgrd2.ColWidth(colcnt) = 1500: Mfgrd2.TextMatrix(0, colcnt) = "Bill/Refd Amt": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2TRNCRAMT_COL: Mfgrd2.ColWidth(colcnt) = 1500: Mfgrd2.TextMatrix(0, colcnt) = "Pymt.Amt": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2TRNRUNBALAMT_COL: Mfgrd2.ColWidth(colcnt) = 1500: Mfgrd2.TextMatrix(0, colcnt) = "Bal.Amt": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2TRNDISCAMT_COL: Mfgrd2.ColWidth(colcnt) = 1500: Mfgrd2.TextMatrix(0, colcnt) = "Disc.Amt": Mfgrd2.ColAlignment(colcnt) = 7
        ...
        If mIbsDischTime <> mIbsDischTime_old Then
            ...
            If .RecordCount > 0 Then
                If .fields("IbbsToTime") > mIbsDischTime Then
                    If IsNull(.fields("IbhCode")) = False Then
                        ErrorBox "Bed Charges Already Charged in Indoor Bill No." & CStr(.fields("IbhVchNo")) & " Dated " & Dtoc(.fields("IbhDate")) & "/" & MinToTime(.fields("IbbsToTime")) & " " & MinToTime(.fields("IbhTime")) & " !!!"
                    Else
...
'fcmbAraName.BoundText = CStr(clsHOPT.GetIndrRegOptBoundCode("IpgAraCode")): txtAraName.Text = fcmbAraName.Text
'fcmbStnName.BoundText = CStr(clsHOPT.GetIndrRegOptBoundCode("IpgStnCode")): txtStnName.Text = fcmbStnName.Text
'fcmbPcgName.BoundText = CStr(clsHOPT.GetIndrRegOptBoundCode("IpgPcgCode")): txtPcgName.Text = fcmbPcgName.Text
'fcmbAhName.BoundText = CStr(clsHOPT.GetIndrRegOptBoundCode("IpgPttAhCode")): txtAhName.Text = fcmbAhName.Text
'
'Call ShowPatAge
'Call ShowPatBal
...
'
'fcmbVtmName.BoundText = CStr(clsHOPT.GetIndrRegOptBoundCode("IpgVtmCode")): txtVtmName(0).Text = fcmbVtmName.Text
'fcmbCDctName.BoundText = CStr(clsHOPT.GetIndrRegOptBoundCode("IpgCDctCode")): txtCDctName.Text = fcmbCDctName.Text
'fcmbRByName.BoundText = CStr(clsHOPT.GetIndrRegOptBoundCode("IpgRByCode")): txtRByName.Text = fcmbRByName.Text
'fcmbFDigName.BoundText = CStr(clsHOPT.GetIndrRegOptBoundCode("IpgFDigCode")): txtFDigName.Text = fcmbFDigName.Text
'fcmbBdmName.BoundText = CStr(clsHOPT.GetIndrRegOptBoundCode("IpgBdmCode")): txtBdmName(0).Text = fcmbBdmName.Text
'
'mIpgVchNo = GetNextVTypeNo(dbHmsDatabase, dbAcDatabase, dbComDatabase, mTableName:="IndrReg", mFieldName:="IpgVchNo", mVtmFieldName:="IpgVtmCode", mVtmFieldValue:=Val(fcmbVtmName.BoundText), mFinYrFieldName:="IpgCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="IpgDate", mDateFieldValue:=Ctod(dtpIpgDate.Text), mModuleCode:=mFormUIdCode, mModuleName:=Me.Name, mAcsPermFileName:=mFormIpgAcsPermFileName)
'mskIpgVchNo(0).Text = ToMyNumFmt(mIpgVchNo, mDecimals:=0)
'
...
mQryStr = mQryStr & " Select " _
 ...
 & ",IhrAmtAftDisc as TrnDrAmt" _
 & ",IhrRecdAmt as TrnCrAmt" _
 & " from IndrHdr" _
...
If .EOF = False Then
    mRunBalAmt = 0
    Do While .EOF = False
        mRunBalAmt = mRunBalAmt + .fields("TrnDrAmt") - .fields("TrnCrAmt")
        ...
        Mfgrd2.TextMatrix(srow, X2TRNAMTAFTDISC_COL) = ToMyNumFmt(.fields("TrnAmtAftDisc"))
        Mfgrd2.TextMatrix(srow, X2TRNDRAMT_COL) = ToMyNumFmt(.fields("TrnDrAmt"))
        Mfgrd2.TextMatrix(srow, X2TRNCRAMT_COL) = ToMyNumFmt(.fields("TrnCrAmt"))
        Mfgrd2.TextMatrix(srow, X2TRNRUNBALAMT_COL) = ToMyNumFmt(mRunBalAmt)
        Mfgrd2.TextMatrix(srow, X2TRNDISCAMT_COL) = ToMyNumFmt(.fields("TrnDiscAmt"))
...
ElseIf Shift = vbCtrlMask And KeyCode = vbKeyB Then
    If mTrnCode > 0 And mTrnSysType = cHMS_VTYPE_INDOOR_REG Then
        mEntryAccessed = True
        mLastRowAccessed = Mfgrd2.Row
        Set frmTrn = New frmIndoorReg
        frmTrn.BedStatusAccessCode = mTrnCode
        Load frmTrn
        frmTrn.Show 1
        Me.ZOrder
    End If
