...
Begin VB.Form frmMedicalPurch 
   ...
   Begin VB.ComboBox cmbFormEntryMode 
      ...
      Enabled         =   0   'False
      Height          =   315
      ItemData        =   "MediPur.frx":0000
      Left            =   0
      List            =   "MediPur.frx":000D
   ...
   Begin VB.Frame frFormDtl 
      ...
      Begin VB.TextBox mskPurItmCode 
         ...
         Width           =   1335
      End
      Begin VB.TextBox txtPurMdiRefNo 
         Appearance      =   0  'Flat
         BeginProperty DataFormat 
            Type            =   0
            Format          =   "0"
      ...
      Begin VB.Frame frFooter 
         ...
         Begin VB.Label lblTaxSmry 
            ...
            Caption         =   "Opening / Purchase Tax Summary"
            BeginProperty Font 
               Name            =   "Verdana"
               Size            =   8.25
               Charset         =   0
   ...
   Begin VB.Label lblFormHeading 
      ...
      BackColor       =   &H00E0E0E0&
      BorderStyle     =   1  'Fixed Single
      Caption         =   "Purchase / Opening Stock Voucher"
      BeginProperty Font 
         Name            =   "Verdana"
         Size            =   14.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmMedicalPurch"
...
Dim mFormSysVchType As Integer, mFormVchTypeList As String, mPurCode As Long, mPurStkCode As Long, mQryMptCode As Long, mQryVtmCode As Long, dtlAddEditMode As Boolean, dtlAddMode As Boolean, dtlEditCanceled As Boolean
...
Dim mPurCode_old As Long, mPurStkCode_old As Long, mPurMptCode_old As Long, mPurDate_old As Date, mPurVtmCode_old As Long, mPurVchNo_old As Long, mPurTime_old As Long
Dim mPurMdiCode_old As Long, mPurItmCode_old As Long, mPurItrCode_old As Long, mPurMdiRefNo_old As String, mPurAmtBefDisc_old As Double, mPurDiscPer_old As Double, mPurAmtBefTax_old As Double, mPurTaxPer_old As Double
Dim mPuhAmount_old As Double
Dim clsAH As clsAccountHead, clsSTK As clsStockJrn, clsPUR As clsVgnMultiTranEntry, clsARA As clsComMastEntry, clsSTN As clsComMastEntry, clsVTM As clsComMastEntry
Dim clsMPT As clsVgnMasterEntry, clsMDI As clsVgnMasterEntry
Dim mActiveControl As Object, clsListStru As clsSelectQueryStructure
Dim fcmbVtmName As clsComFlexSearch
Dim fcmbMptName As clsVgnFlexSearch, fcmbMdiName As clsVgnFlexSearch
Rem Dim mPartyMastTblName As String, mMptNameTitle As String, mMptNameField As String, mMptCodeField As String, mPuhMptCodeField As String, mPrtAraCodeField As String, mPrtStnCodeField As String, mPrtAddrField As String, mPrtTelNoField As String, mPrtSmsNoField As String
...
Const X2PURMDIREFNO_COL = 3
Const X2PURQTY_COL = 4
Const X2PURRATE_COL = 5
Const X2PURMRP_COL = 6
Const X2PURSRATE_COL = 7
Const X2PURAMTBEFDISC_COL = 8
Const X2PURDISCPER_COL = 9
Const X2PURDISCAMT_COL = 10
Const X2PURAMTBEFTAX_COL = 11
Const X2PURTAXPER_COL = 12
Const X2PURTAXAMT_COL = 13
Const X2PURAMOUNT_COL = 14
Const X2PURNARR_COL = 15
Const X2PURMDICODE_COL = 16
Const X2PURITMCODE_COL = 17
Const X2PURITRCODE_COL = 18
Const X2PURSTKICODE_COL = 19
Const X2PURRECSTATE_COL = 20
...
'    If mFormSysVchType = cVGN_VTYPE_MEDRETNINW Then
'        .mPurPttCode_lng = Val(fcmbMptName.BoundText)
'        .mPurMptCode_lng = 0
'    Else
        .mPurMptCode_lng = Val(fcmbMptName.BoundText)
        .mPurPttCode_lng = 0
'    End If
    .mPurMdiCode_lng = Val(fcmbMdiName.BoundText)
    .mPurNarr_str = txtPurNarr.Text
    .mPurItmCode_lng = Val(mskPurItmCode.Text)
    .mPurItrCode_lng = Val(mskPurItrCode.Text)
    .mPurMdiRefNo_str = txtPurMdiRefNo.Text
    ...
    .mStkItmRef1Name_str = txtPurMdiRefNo.Text
    .mStkItmRef2Name_str = ""
    ...
    If dtlAddMode = True Then
        ...
        End If
    Else
        If Val(fcmbMdiName.BoundText) <> mPurMdiCode_old Or Val(mskPurItmCode.Text) <> mPurItmCode_old Or txtPurMdiRefNo.Text <> mPurMdiRefNo_old Then
    ...
    Rem updating StkICode in MedPurchDtl
    With clsPUR
    ...
    With tRecset
    .open "Select * from MedPurchDtl where PurCode = " & CStr(mPurCode) & " and PurICode = " & CStr(mPurICode) & "", dbVgnDatabase, adOpenKeyset, adLockOptimistic
    
    clsMDI.GetData .fields("PurMdiCode")
    ...
    Mfgrd2.TextMatrix(srow, X2MDINAME_COL) = clsMDI.mName_str
    Mfgrd2.TextMatrix(srow, X2PURMDIREFNO_COL) = .fields("PurMdiRefNo")
    ...
    Mfgrd2.TextMatrix(srow, X2PURMDICODE_COL) = .fields("PurMdiCode")
...
mFormUIdFileName = "MedPurchDtl.Uid"
mFormAcsPermFileName = "MedPurchDtl.Acp"
...
'    mMptNameTitle = "Patient"
'    mMptCodeField = "PttCode"
'    mMptNameField = "PttName"
'    mPuhMptCodeField = "PuhPttCode"
...
'    fcmbMptName.blnPatMastListByName = True
'    fcmbMptName.Init
'    ' -----------------------
'    Set clsMPT = New clsVgnMasterEntry
'    Set clsMPT.dbAcDatabase = dbAcDatabase
'    Set clsMPT.dbVgnDatabase = dbVgnDatabase
'    clsMPT.blnPatMast = True
'    clsMPT.Init
'
'Else
'    mPartyMastTblName = "PartyMast"
'    mMptCodeField = "MptCode"
'    mMptNameField = "MptName"
'    mPuhMptCodeField = "PuhMptCode"
'    mPrtAddrField = "MptAddr"
'    mPrtAraCodeField = "MptAraCode"
'    mPrtStnCodeField = "MptStnCode"
'    mPrtTelNoField = "MptTelNo"
'    mPrtSmsNoField = "MptSmsNo"
...
If mRemoteAccess = True Then
    datRecset.open "Select * from MedPurchHdr puh" _
      & " inner join MedPrtMast mpt on puh.PuhMptCode = mpt.MptCode" _
      & " where puh.PuhCode = " & CStr(mPurCode) _
      & " and PuhVtmCode in (" & mFormVchTypeList & ")" _
      & " order by PuhDate,PuhTime", dbComDatabase, adOpenKeyset, adLockOptimistic
...
colcnt = X2PURMDIREFNO_COL: Mfgrd2.ColWidth(colcnt) = txtPurMdiRefNo.Width: Mfgrd2.TextMatrix(0, colcnt) = "Ref.No": Mfgrd2.ColAlignment(colcnt) = 1
...
colcnt = X2PURSRATE_COL: Mfgrd2.ColWidth(colcnt) = mskPurSRate.Width: Mfgrd2.TextMatrix(0, colcnt) = "S.Rate": Mfgrd2.ColAlignment(colcnt) = 7
...
colcnt = X2PURMDICODE_COL: Mfgrd2.ColWidth(colcnt) = 0: Mfgrd2.TextMatrix(0, colcnt) = "X2PURMDICODE_COL": Mfgrd2.ColAlignment(colcnt) = 7
...
colcnt = X2PURMDIREFNO_COL: txtPurMdiRefNo.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
...
colcnt = X2PURSRATE_COL: mskPurSRate.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
...
txtPurNarr.Left = txtMdiName.Left
...
If FormAddEditMode = cFORM_EDITMODE And Val(mskFormBoundField.Text) < 1 Then
    ...
    GoTo EndSub
End If
If Val(fcmbMptName.BoundText) < 1 Then
...
If TimeToMin(txtPurTime_str.Text) > cDAYMINUTES Then
    ...
    GoTo EndSub
End If
If mFormSysVchType = cVGN_VTYPE_MEDPURCH Then
...
If KeyAscii = vbKeyReturn Then
    ...
    If dtlAddMode = True Then
        ...
        ary1 = Split(txtMptName.Text, Space(1))
        txtPurMdiRefNo.Text = Left(ary1(0) & "/" & Format(Ctod(dtpPurDate.Text), "yymmdd") & "/" & txtPurTrnRefNo.Text, 25)
        Erase ary1
    Else
        ...
        fcmbMdiName.BoundText = Mfgrd2.TextMatrix(srow, X2PURMDICODE_COL): txtMdiName.Text = fcmbMdiName.Text
        ...
        txtPurMdiRefNo.Text = Mfgrd2.TextMatrix(srow, X2PURMDIREFNO_COL)
    ...
    mPurMdiCode_old = Val(fcmbMdiName.BoundText)
    mPurItmCode_old = Val(mskPurItmCode.Text)
    mPurItrCode_old = Val(mskPurItrCode.Text)
    mPurMdiRefNo_old = txtPurMdiRefNo.Text
...
Private Sub txtPurMdiRefNo_GotFocus()
FlashActiveControl txtPurMdiRefNo, True
End Sub

Private Sub txtPurMdiRefNo_LostFocus()
FlashActiveControl txtPurMdiRefNo, False
End Sub

Private Sub txtPurMdiRefNo_Validate(Cancel As Boolean)
If Trim(txtPurMdiRefNo.Text) = "" Then
    ErrorBox "Invalid Input !!!"
    txtPurMdiRefNo.SetFocus
    Cancel = True
ElseIf dtlAddMode = False And txtPurMdiRefNo.Text <> mPurMdiRefNo_old Then
...
Private Sub txtMptName_Change()
If fcmbMptName.CallFromText_Change = False Then
    fcmbMptName.CallFromText_Change = True
    If InterActiveChange(txtMptName) = True Then
        fcmbMptName.UserText = Array(txtMptName.Text, txtMptName.SelStart)
        fcmbMptName.Show
        txtMptName.Text = fcmbMptName.Text
...
Private Sub txtMptName_KeyDown(KeyCode As Integer, Shift As Integer)
If MyDropDownKey(Shift, KeyCode) = True Then
    Call txtMptName_Change
End If
...
ElseIf ChkAnyMisLinkedIsuExist() = True Then
    ...
    fcmbMptName.BoundText = CStr(mPurMptCode_old)
    txtMptName.Text = fcmbMptName.Text
Else
    ShowPartyData Val(fcmbMptName.BoundText)
End If

End Sub

Private Sub ShowPartyData(ByVal mPurMptCode As Long)
...
With tRecset
.open "Select * from (MedPrtMast mpt inner join AreaMast ara on mpt.MptAraCode = ara.AraCode) inner join StsnMast stn on mpt.MptStnCode = stn.StnCode where mpt.MptCode = " & CStr(mPurMptCode) & "", dbComDatabase, adOpenKeyset, adLockOptimistic
If .EOF = False Then
    txtMptAddr.Text = .fields("MptAddr")
    txtAraName.Text = .fields("AraName")
    txtStnName.Text = .fields("StnName")
    txtMptTelNo.Text = .fields("MptTelNo")
    txtMptSMSNo.Text = .fields("MptSmsNo")
End If
End With
CloseTable tRecset
...
'If mFormSysVchType = cVGN_VTYPE_MEDRETNINW Then
'    fcmbMptName.BoundText = CStr(.mPuhPttCode_lng)
'Else
    fcmbMptName.BoundText = CStr(.mPuhMptCode_lng)
'End If
txtMptName.Text = fcmbMptName.Text
...
'If mFormSysVchType = cVGN_VTYPE_MEDRETNINW Then
'    ShowPartyData .mPuhPttCode_lng
'Else
    ShowPartyData .mPuhMptCode_lng
'End If
...
With tRecset
.open "Select top 1 * from MedPurchHdr where PuhVtmCode IN (" & mFormVchTypeList & ") and PuhCmpCode = " & CStr(sFinYrCmpCode) & " order by PuhCode desc", dbVgnDatabase, adOpenKeyset, adLockOptimistic
If .EOF = False Then
    dtpPurDate.Text = Dtoc(DefaultEntryDate)    '''  Dtoc(.fields("PuhDate"))
...
mPurMptCode_old = Val(fcmbMptName.BoundText)
...
With tRecset
.open "Select * from MedPurchDtl where PurCode=" & CStr(mPurCode) & " order by PurSno", dbVgnDatabase, adOpenKeyset, adLockOptimistic
...
'If mFormSysVchType = cVGN_VTYPE_MEDRETNINW Then
'    .mPuhPttCode_lng = Val(fcmbMptName.BoundText)
'    .mPuhMptCode_lng = 0
'Else
    .mPuhMptCode_lng = Val(fcmbMptName.BoundText)
    .mPuhPttCode_lng = 0
'End If
...
If .mTrnCode_lng > 0 Then   ' updated successfully
    ...
    If .mShrCode_lng > 0 Then
        If FormAddEditMode = cFORM_ADDMODE Then
            ...
            dbVgnDatabase.Execute "Update MedPurchHdr set PuhStkCode=" & CStr(mPurStkCode) & " where PuhCode=" & CStr(mPurCode)
            dbVgnDatabase.Execute "Update MedPurchDtl set PurStkCode=" & CStr(mPurStkCode) & " where PurCode=" & CStr(mPurCode)
...
If optMonthwise.Value = True Or optDatewise.Value = True Or optPartywise.Value = True Or optVTypewise.Value = True Then
    If optMonthwise.Value = True Then
    ...
    ElseIf optPartywise.Value = True Then
        clsListStru.AddFields mExpr:="MptName", mTitle:="Party Name", mShowItem:=True, mAlign:=flexAlignLeftCenter, mWidth:=3000
        clsListStru.AddFields mExpr:="PurCount", mTitle:="Count", mShowItem:=True, mAlign:=flexAlignRightCenter, mWidth:=1500
        clsListStru.AddFields mExpr:="PurQty_sum", mTitle:="Qty", mShowItem:=True, mAlign:=flexAlignRightCenter, mWidth:=1500
        clsListStru.AddFields mExpr:="PurAmount_sum", mTitle:="Amount", mShowItem:=True, mAlign:=flexAlignRightCenter, mWidth:=1500
        
        datRecset.open "Select mpt.MptName,hdr.PuhMptCode" _
         & ",Count(PuhCode) as PurCount" _
         & ",Sum(PuhQty) as PurQty_sum" _
         & ",Sum(PuhAmount) as PurAmount_sum" _
         & " from MedPurchHdr hdr inner join MedPrtMast mpt on hdr.PuhMptCode = mpt.MptCode" _
         & " where PuhDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
         & " and PuhCode > 0 and PuhVtmCode in (" & mFormVchTypeList & ")" _
         & IIf(mQryMptCode > 0, " and hdr.PuhMptCode = " & CStr(mQryMptCode), "") _
         & IIf(mQryVtmCode > 0, " and hdr.PuhVtmCode = " & CStr(mQryVtmCode), "") _
         & " group by mpt.MptName,hdr.PuhMptCode" _
         & " order by mpt.MptName,hdr.PuhMptCode" _
         , dbComDatabase, adOpenKeyset, adLockReadOnly
    ...
    ElseIf optVTypewise.Value = True Then
        ...
        datRecset.open "Select vtm.VtmName,hdr.PuhVtmCode" _
         & ",Count(PuhCode) as PurCount" _
         & ",Sum(PuhQty) as PurQty_sum" _
         & ",Sum(PuhAmount) as PurAmount_sum" _
         & " from MedPurchHdr hdr inner join VTypMast vtm on hdr.PuhVtmCode = vtm.VtmCode" _
         & " where PuhDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
         & " and PuhCode > 0 and PuhVtmCode in (" & mFormVchTypeList & ")" _
         & IIf(mQryMptCode > 0, " and hdr.PuhMptCode = " & CStr(mQryMptCode), "") _
         & IIf(mQryVtmCode > 0, " and hdr.PuhVtmCode = " & CStr(mQryVtmCode), "") _
         & " group by vtm.VtmName,hdr.PuhVtmCode" _
         & " order by vtm.VtmName,hdr.PuhVtmCode" _
         , dbComDatabase, adOpenKeyset, adLockReadOnly
...
ElseIf optDetailed.Value = True Then
    ...
    clsListStru.AddFields mExpr:="MptName", mTitle:="Party Name", mAlign:=flexAlignLeftCenter, mWidth:=2500, mShowItem:=True
    ' --------------------------------------
    ...
    datRecset.open "Select hdr.*,mpt.*" _
...
If Val(fcmbMdiName.BoundText) <= 0 Then
    ...
    Cancel = True
Else
    If FormAddEditMode = cFORM_ADDMODE Or dtlAddMode = True Or Val(fcmbMdiName.BoundText) <> mPurMdiCode_old Then
        clsMDI.GetData Val(fcmbMdiName.BoundText)
        mskPurItmCode.Text = clsMDI.mMdiItmCode_lng
        mskPurRate.Text = ToMyNumFmt(clsMDI.mMdiPurchRate_dbl)
        mskPurMRP.Text = ToMyNumFmt(clsMDI.mMdiMRPRate_dbl)
        mskPurSRate.Text = ToMyNumFmt(clsMDI.mMdiSaleRate_dbl)
        Call CalcPurChg
    End If
End If
Call ValidDtl
...
Dim tRecset As New ADODB.Recordset, mPurDate As Date, mPurMptCode As Long

mPurMptCode = Val(fcmbMptName.BoundText)
mPurDate = Ctod(dtpPurDate.Text)
With tRecset
'If FormAddEditMode = cFORM_ADDMODE Then
'    .Open "Select top 1 puh.*,vtm.VtmName from MedPurchHdr puh inner join VTypMast vtm on puh.PuhVtmCode=vtm.VtmCode where puh.PuhMptCode=" & CStr(mPurMptCode) & " order by puh.PuhDate Desc", dbComDatabase, adOpenKeyset, adLockOptimistic
'Else
    .open "Select top 1 puh.*,vtm.VtmName from MedPurchHdr puh" _
        & " inner join VTypMast vtm on puh.PuhVtmCode = vtm.VtmCode" _
        & " where puh.PuhMptCode = " & CStr(mPurMptCode) _
...
Else
    lblOldPurCodeDesc.Caption = "#" & CStr(mPurMptCode) & "#"
End If
End With
CloseTable tRecset
...
.open "Select * from ((MedSaleDtl sal" _
    ...
    & " inner join MedItmMast mdi on sal.SalMdiCode = mdi.MdiCode)" _
...
If .EOF = False Then
    Do While .EOF = False
        mLinkTranStr = mLinkTranStr & .fields("VtmName") & " No." & CStr(.fields("SahVchNo")) & " Dt." & Dtoc(.fields("SahDate")) & " It." & .fields("MdiName") & " Rf." & .fields("SalMdiRefNo") & " Qty." & ToMyNumFmt(.fields("SalQty"), mDecimals:=0) & vbCrLf
...
.open "Select top 1 * from ((MedPurchDtl" _
    ...
    , dbVgnDatabase, adOpenKeyset, adLockOptimistic
    Rem SahMptCode <> " & CStr(Val(fcmbMptName.BoundText)) & " or

If .EOF = False Then
    clsVTM.GetData .fields("SahVtmCode")
    'If .fields("SahMptCode") <> Val(fcmbMptName.BoundText) Then
...
.open "Select top 1 * from (" _
    ...
    & " inner join MedPurchDtl on MedSaleDtl.SalPurICode = MedPurchDtl.PurICode" _
    ...
    & ")" _
    & " group by PurICode,MdiCode,ItmCode,ItrCode,MdiRefNo" _
    & " order by PurICode,MdiCode,ItmCode,ItrCode,MdiRefNo" _
    & ") as a" _
    & " inner join MedItmMast on a.MdiCode = MedItmMast.MdiCode" _
    & " where Qty_sum < 0" _
    , dbComDatabase, adOpenKeyset, adLockOptimistic
If .EOF = False Then
    ErrorBox "Purchase going Short for Item " & vbCrLf & .fields("MdiName") & " Ref.No." & CStr(.fields("MdiRefNo")) & " by Qty " & CStr(.fields("Qty_sum"))
