...
Begin VB.Form frmMedItemGrpMast 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ClientHeight    =   8220
   ClientLeft      =   60
   ...
   Begin VB.ComboBox cmbFormEntryMode 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "MedItGpM.frx":0000
      Left            =   0
      List            =   "MedItGpM.frx":000D
   ...
   End
End
Attribute VB_Name = "frmMedItemGrpMast"
...
Dim clsMIG As clsVgnMasterEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
...
Set clsMIG = New clsVgnMasterEntry
Set clsMIG.dbVgnDatabase = dbVgnDatabase
...
If txtMigName.Text <> mMigName_old Then
    If ChkIsDuplicate(dbVgnDatabase, "MedItmGrpMst", "MigName", txtMigName.Text, "MigCode", Val(mskFormBoundField.Text)) = True Then
