   ...
   Begin VB.Frame frFormDtl 
      ...
      Begin VB.Frame frExtRateSys 
         ...
         Begin VB.CheckBox chkSgpRBywseShareSys 
            ...
            Width           =   5055
         End
         Begin VB.CheckBox chkSgpEtgwseShareSys 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
         ...
         Begin VB.CheckBox chkSgpRBywseBargSys 
            ...
            Width           =   5055
         End
         Begin VB.CheckBox chkSgpEtgwseBargSys 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
         ...
         Begin VB.CheckBox chkSgpRBywseDiscSys 
            ...
            Width           =   5055
         End
         Begin VB.CheckBox chkSgpEtgwseDiscSys 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
         ...
         Begin VB.CheckBox chkSgpRBywseRateSys 
            ...
            Width           =   5055
         End
         Begin VB.CheckBox chkSgpEtgwseRateSys 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
...
Dim clsSGP As clsBdkMasterEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
...
Private Sub chkSgpEtgwseRateSys_GotFocus()
FlashActiveControl chkSgpEtgwseRateSys, True
End Sub

Private Sub chkSgpEtgwseRateSys_LostFocus()
FlashActiveControl chkSgpEtgwseRateSys, False
End Sub
...
Private Sub chkSgpEtgwseDiscSys_GotFocus()
FlashActiveControl chkSgpEtgwseDiscSys, True
End Sub

Private Sub chkSgpEtgwseDiscSys_LostFocus()
FlashActiveControl chkSgpEtgwseDiscSys, False
End Sub
...
Private Sub chkSgpEtgwseBargSys_GotFocus()
FlashActiveControl chkSgpEtgwseBargSys, True
End Sub

Private Sub chkSgpEtgwseBargSys_LostFocus()
FlashActiveControl chkSgpEtgwseBargSys, False
End Sub
...
Private Sub chkSgpEtgwseShareSys_GotFocus()
FlashActiveControl chkSgpEtgwseShareSys, True
End Sub

Private Sub chkSgpEtgwseShareSys_LostFocus()
FlashActiveControl chkSgpEtgwseShareSys, False
End Sub
...
If mRemoteAccess = True Then
    datRecset.open "Select * from ServGrpMst where SgpCode=" & CStr(mSgpCode) & " order by SgpName", dbBdkDatabase, adOpenKeyset, adLockOptimistic
Else
    datRecset.open "Select * from ServGrpMst order by SgpName", dbBdkDatabase, adOpenKeyset, adLockOptimistic
End If
Call SmryList
...
If txtSgpName.Text <> mSgpName_old Then
    If ChkIsDuplicate(dbBdkDatabase, "ServGrpMst", "SgpName", txtSgpName.Text, "SgpCode", Val(mskFormBoundField.Text)) = True Then
...
Else
    With tRecset
    .open "Select SgpCode from ServGrpMst order by SgpCode", dbBdkDatabase, adOpenKeyset, adLockOptimistic
...
chkSgpEtgwseRateSys.Value = vbUnchecked
...
chkSgpEtgwseDiscSys.Value = vbUnchecked
...
chkSgpEtgwseBargSys.Value = vbUnchecked
...
chkSgpEtgwseShareSys.Value = vbUnchecked
...
chkSgpEtgwseRateSys.Value = IIf(.fields("SgpEtgwseRateSys") = True, vbChecked, vbUnchecked)
...
chkSgpEtgwseDiscSys.Value = IIf(.fields("SgpEtgwseDiscSys") = True, vbChecked, vbUnchecked)
...
chkSgpEtgwseBargSys.Value = IIf(.fields("SgpEtgwseBargSys") = True, vbChecked, vbUnchecked)
...
chkSgpEtgwseShareSys.Value = IIf(.fields("SgpEtgwseShareSys") = True, vbChecked, vbUnchecked)
...
.mSgpDctwseRateSys_bln = (chkSgpDctwseRateSys.Value = vbChecked)
.mSgpEtgwseRateSys_bln = (chkSgpEtgwseRateSys.Value = vbChecked)
...
.mSgpEtgwseDiscSys_bln = (chkSgpEtgwseDiscSys.Value = vbChecked)
...
.mSgpEtgwseBargSys_bln = (chkSgpEtgwseBargSys.Value = vbChecked)
...
.mSgpEtgwseShareSys_bln = (chkSgpEtgwseShareSys.Value = vbChecked)
...
If .mCode_lng > 0 Then   ' updated successfully
    ...
    tRecset.open "Select * from ServGrpMst where SgpCode<>" & CStr(.mCode_lng) & " and SgpIndex=" & .mSgpIndex_int & "", dbBdkDatabase, adOpenKeyset, adLockOptimistic
...
If clsSGP.CanDeleteMast(mSgpCode) = True Then
    ...
    If clsSGP.BeginMast(mSgpCode) = True Then
        ...
        dbBdkDatabase.BeginTrans
        dbBdkDatabase.Execute "Update ServGrpMst set SgpIndex=SgpIndex-1 where SgpIndex>=" & CStr(clsSGP.mSgpIndex_int) & " and SgpCode<>" & CStr(mSgpCode) & ""
        dbBdkDatabase.CommitTrans
