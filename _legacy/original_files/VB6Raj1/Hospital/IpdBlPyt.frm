...
Dim clsJRN As clsJournal, clsAH As clsAccountHead, clsIPG As clsHmsSnglTranEntry, clsIBL As clsHmsIpdMultiTranEntry, clsIBPY As clsHmsIpdMultiTranEntry, clsARA As clsComMastEntry, clsSTN As clsComMastEntry, clsVTM As clsComMastEntry, clsHOPT As clsHmsIpdOptionsEntry
...
Dim fcmbDueIpgByIpgNo As clsHmsFlexSearch, fcmbDueIpgByPttRegNo As clsHmsFlexSearch, fcmbDueIpgByPttName As clsHmsFlexSearch, fcmbPttName As clsHmsFlexSearch, fcmbPttRegNo As clsHmsFlexSearch, fcmbIblVchNo As clsHmsFlexSearch
...
If cmdOK.Caption = "&OK" And dtlEditCanceled = False Then
    ...
    With tRecset
    .open "Select * from IndrBlPymtDtl where IbpyCode=" & CStr(mIbpyCode) & " and IbpyICode=" & CStr(mIbpyICode) & "", dbHmsDatabase, adOpenKeyset, adLockOptimistic
...
clsHOPT.blnIndrBlPymtOptMast = True
clsHOPT.Init
clsHOPT.GetIndrBlPymtOptData
...
Set clsIBPY = New clsHmsIpdMultiTranEntry
Set clsIBPY.dbAcDatabase = dbAcDatabase
Set clsIBPY.dbHmsDatabase = dbHmsDatabase
...
fcmbIbpyVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cHMS_VTYPE_INDOOR_BLPYMT) & " order by VtmName"
...
Set fcmbDueIpgByIpgNo = New clsHmsFlexSearch
Set fcmbDueIpgByIpgNo.dbHmsDatabase = dbHmsDatabase
Set fcmbDueIpgByIpgNo.dbComDatabase = dbComDatabase
fcmbDueIpgByIpgNo.blnDueIpgListByIpgNo = True
fcmbDueIpgByIpgNo.mFiltCond = "0 = 1"
fcmbDueIpgByIpgNo.Init

Set fcmbDueIpgByPttRegNo = New clsHmsFlexSearch
Set fcmbDueIpgByPttRegNo.dbHmsDatabase = dbHmsDatabase
Set fcmbDueIpgByPttRegNo.dbComDatabase = dbComDatabase
fcmbDueIpgByPttRegNo.blnDueIpgListByPttRegNo = True
fcmbDueIpgByPttRegNo.mFiltCond = "0 = 1"
fcmbDueIpgByPttRegNo.Init

Set fcmbDueIpgByPttName = New clsHmsFlexSearch
Set fcmbDueIpgByPttName.dbHmsDatabase = dbHmsDatabase
Set fcmbDueIpgByPttName.dbComDatabase = dbComDatabase
fcmbDueIpgByPttName.blnDueIpgListByPttName = True
fcmbDueIpgByPttName.mFiltCond = "0 = 1"
fcmbDueIpgByPttName.Init
...
If mRemoteAccess = True Then
    datRecset.open "Select * from IndrBlPymtHdr inner join PatMast on IndrBlPymtHdr.IbphPttCode = PatMast.PttCode where IbphCode = " & CStr(mIbpyCode) & " order by IbphDate,IbphTime", dbHmsDatabase, adOpenKeyset, adLockOptimistic
    dtpFromDate.Text = Dtoc(datRecset.fields("IbphDate"))
    dtpToDate.Text = Dtoc(datRecset.fields("IbphDate"))
    AddSmryParaLayer mClear:=True
    
Else
    datRecset.open "Select * from IndrBlPymtHdr inner join PatMast on IndrBlPymtHdr.IbphPttCode=PatMast.PttCode order by IbphDate,IbphTime", dbHmsDatabase, adOpenKeyset, adLockOptimistic
End If
Mfgrd1.FixedCols = 0
Call SmryList
...
Set clsSTN = Nothing
Set clsVTM = Nothing
Set fcmbDueIpgByIpgNo = Nothing
Set fcmbDueIpgByPttRegNo = Nothing
Set fcmbDueIpgByPttName = Nothing
...
If mPttRegNo < 0 Then
    ...
    GoTo EndSub
Else
    If mPttRegNo = 0 And clsHOPT.mIbpyPttRegNoNotZero_bln = True Then
    ...
    If mIbpyVchNo <> mIbpyVchNo_old Or Val(fcmbIbpyVtmName.BoundText) <> mIbpyVtmCode_old Or Ctod(dtpIbpyDate.Text) <> mIbpyDate_old Or FormAddEditMode = cFORM_ADDMODE Then
        If ChkIsDuplVTypeNo(dbHmsDatabase, dbAcDatabase, mTableName:="IndrBlPymtHdr", mChkFieldName:="IbphVchNo", mChkFieldValue:=mIbpyVchNo, mKeyFieldName:="IbphCode", mKeyFieldValue:=mIbpyCode, mVtmFieldName:="IbphVtmCode", mVtmFieldValue:=Val(fcmbIbpyVtmName.BoundText), mFinYrFieldName:="IbphCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="IbphDate", mDateFieldValue:=Ctod(dtpIbpyDate.Text)) = True Then
            ...
            If FormAddEditMode = True Then
                mIbpyVchNo = GetNextVTypeNo(dbHmsDatabase, dbAcDatabase, dbComDatabase, mTableName:="IndrBlPymtHdr", mFieldName:="IbphVchNo", mVtmFieldName:="IbphVtmCode", mVtmFieldValue:=Val(fcmbIbpyVtmName.BoundText), mFinYrFieldName:="IbphCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="IbphDate", mDateFieldValue:=Ctod(dtpIbpyDate.Text), mModuleCode:=mFormUIdCode, mModuleName:=Me.Name, mAcsPermFileName:=mFormAcsPermFileName)
            Else
...
fcmbIbpyVtmName.BoundText = CStr(clsHOPT.GetIndrBlPymtOptBoundCode("IbpyVtmCode")): txtIbpyVtmName(0).Text = fcmbIbpyVtmName.Text
...
With tRecset
.open "Select * from IndrBlPymtDtl where IbpyCode=" & CStr(mIbpyCode) & " order by IbpySno", dbHmsDatabase, adOpenKeyset, adLockOptimistic
...
If .mTrnCode_lng > 0 Then   ' updated successfully
    ...
    clsHOPT.mIbpyVtmCodeOld_lng = .mTrnVtmCode_lng
    clsHOPT.UpdateIndrBlPymtOld
...
With tRecset
.open "Select * from IndrBlPymtHdr where IbphCode=" & CStr(mOldIblCode) & "", dbHmsDatabase, adOpenKeyset, adLockOptimistic
If .RecordCount > 0 Then
    clsVTM.GetData .fields("IbphVtmCode")
...
With tRecset
.open "Select top 1 * from IndrBlPymtHdr where IbphPttCode=" & CStr(mPttCode) & " order by IbphDate desc,IbphVchNo desc,IbphCode desc", dbHmsDatabase, adOpenKeyset, adLockOptimistic
If .RecordCount > 0 Then
...
If fcmbDueIpgByIpgNo.CallFromText_Change = False Then
    fcmbDueIpgByIpgNo.CallFromText_Change = True
    If InterActiveChange(txtIpgVtmName) = True Then
        If fcmbDueIpgByIpgNo.LRecordCount = 0 Then
            fcmbDueIpgByIpgNo.mFiltCond = ""
            fcmbDueIpgByIpgNo.ReInit
        End If
        
        fcmbDueIpgByIpgNo.UserText = Array("", 0)
        fcmbDueIpgByIpgNo.Show
        If FormAddEditMode = cFORM_ADDMODE And Mfgrd2.Rows = 2 And fcmbDueIpgByIpgNo.ListSelected = True And Val(fcmbDueIpgByIpgNo.BoundText) > 0 Then
            mOldIpgCode = Val(fcmbDueIpgByIpgNo.BoundText)
            ...
            End If
        Else
            If fcmbDueIpgByIpgNo.ListSelected = True And Val(fcmbDueIpgByIpgNo.BoundText) > 0 Then
        ...
        End If
    End If
    fcmbDueIpgByIpgNo.CallFromText_Change = False
End If
CloseTable tRecset, mCheckOpen:=True
...
If fcmbDueIpgByPttRegNo.CallFromText_Change = False Then
    fcmbDueIpgByPttRegNo.CallFromText_Change = True
    If InterActiveChange(mskPttRegNo) = True Then
        If fcmbDueIpgByPttRegNo.LRecordCount = 0 Then
            fcmbDueIpgByPttRegNo.mFiltCond = ""
            fcmbDueIpgByPttRegNo.ReInit
        End If
        
        fcmbDueIpgByPttRegNo.UserText = Array("", 0)
        fcmbDueIpgByPttRegNo.Show
        If FormAddEditMode = cFORM_ADDMODE And Mfgrd2.Rows = 2 And fcmbDueIpgByPttRegNo.ListSelected = True And Val(fcmbDueIpgByPttRegNo.BoundText) > 0 Then
            mOldIpgCode = Val(fcmbDueIpgByPttRegNo.LFieldValue("IpgCode"))
            tRecset.open "Select * from IndrReg where IpgCode=" & CStr(mOldIpgCode) & "", dbHmsDatabase, adOpenKeyset, adLockOptimistic
            If tRecset.RecordCount > 0 Then
                mOldIpgPttCode = tRecset.fields("IpgPttCode")
            End If
            ...
            End If
        Else
            If fcmbDueIpgByPttRegNo.ListSelected = True And Val(fcmbDueIpgByPttRegNo.BoundText) > 0 Then
                If FormAddEditMode = cFORM_EDITMODE Then
                    AlertBox "Prohibited in Edit Mode !!!"
                ElseIf Mfgrd2.Rows > 2 Then
                    AlertBox "Prohibited After Depositing Amount !!!"
        ...
        End If
    End If
    fcmbDueIpgByPttRegNo.CallFromText_Change = False
End If
CloseTable tRecset, mCheckOpen:=True
...
If fcmbDueIpgByPttName.CallFromText_Change = False Then
    fcmbDueIpgByPttName.CallFromText_Change = True
    If InterActiveChange(txtPttName) = True Then
        If fcmbDueIpgByPttName.LRecordCount = 0 Then
            fcmbDueIpgByPttName.mFiltCond = ""
            fcmbDueIpgByPttName.ReInit
        End If
        
        fcmbDueIpgByPttName.UserText = Array("", 0)
        fcmbDueIpgByPttName.Show
        If FormAddEditMode = cFORM_ADDMODE And Mfgrd2.Rows = 2 And fcmbDueIpgByPttName.ListSelected = True And Val(fcmbDueIpgByPttName.BoundText) > 0 Then
            mOldIpgCode = Val(fcmbDueIpgByPttName.LFieldValue("IpgCode"))
            tRecset.open "Select * from IndrReg where IpgCode=" & CStr(mOldIpgCode) & "", dbHmsDatabase, adOpenKeyset, adLockOptimistic
            If tRecset.RecordCount > 0 Then
                mOldIpgPttCode = tRecset.fields("IpgPttCode")
            End If
            ...
            End If
        Else
            If fcmbDueIpgByPttName.ListSelected = True And Val(fcmbDueIpgByPttName.BoundText) > 0 Then
                If FormAddEditMode = cFORM_EDITMODE Then
                    AlertBox "Prohibited in Edit Mode !!!"
                ElseIf Mfgrd2.Rows > 2 Then
                    AlertBox "Prohibited After Depositing Amount !!!"
        ...
        End If
    End If
    fcmbDueIpgByPttName.CallFromText_Change = False
End If
CloseTable tRecset, mCheckOpen:=True
...
Else
    ...
    If ChkIsExistVTypeNo(dbHmsDatabase, mTableName:="IndrBlPymtHdr", mChkFieldName:="IbphVchNo", mChkFieldValue:=CStr(mIbpyVchNo), mVtmFieldName:="IbphVtmCode", mVtmFieldValue:=Val(fcmbIbpyVtmName.BoundText), mFinYrFieldName:="IbphCmpCode", mFinYrFieldValue:=sFinYrCmpCode) = False Then
