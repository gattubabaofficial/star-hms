...
Public Const cHMS_VTYPE_OUTDOOR_RGREFD = 109
...
Public Const cHMS_VTYPE_LAB = 119
Public Const cHMS_VTYPE_GENERAL = 120
...
Dim clsSRV As New clsHmsMasterEntry, clsSGP As New clsHmsMasterEntry
Dim tRecset As New ADODB.Recordset
...
Dim clsBDM As New clsHmsMasterEntry, clsSRV As New clsHmsMasterEntry, clsSGP As New clsHmsMasterEntry
Dim tRecset As New ADODB.Recordset
