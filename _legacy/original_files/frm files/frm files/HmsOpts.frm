...
Begin VB.Form frmHmsOptions 
   ...
   Begin VB.Frame frFormDtl 
      ...
      Begin VB.Frame frServRateSystem 
         Appearance      =   0  'Flat
         Caption         =   "Service Charges/Share System (8)"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Frame frOutdRefd 
         Appearance      =   0  'Flat
         BackColor       =   &H00FFC0C0&
         Caption         =   "Outdoor Refund Receipt (7):"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Frame frOutdPymt 
         Appearance      =   0  'Flat
         BackColor       =   &H00FFC0C0&
         Caption         =   "Outdoor Payment Receipt (6):"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.ComboBox cmbFormEntryMode 
      ...
      Enabled         =   0   'False
      Height          =   315
      ItemData        =   "HmsOpts.frx":0000
      Left            =   0
      List            =   "HmsOpts.frx":000D
   ...
   End
End
Attribute VB_Name = "frmHmsOptions"
...
Dim clsOPT As clsHmsOptionsEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
...
Const cOPT_INDRREG = 3
Const cOPT_BEDMAST = 4
Const cOPT_OUTDRCPT = 5
Const cOPT_OUTDPYMT = 6
Const cOPT_OUTDREFD = 7
Const cOPT_SERVRATESYS = 8
...
Set clsOPT = New clsHmsOptionsEntry
...
If TimeToMin(txtBdmChkTime_str.Text) > (24 * 60) Then
    ErrorBox "Invalid Input !!!"
...
clsListStru.AddFields mExpr:="OptName", mTitle:="Option Name", mAlign:=flexAlignLeftCenter, mWidth:=4000, mShowItem:=True
