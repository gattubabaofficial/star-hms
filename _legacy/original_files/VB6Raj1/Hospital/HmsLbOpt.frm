...
Begin VB.Form frmHmsLabOptions 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ClientHeight    =   9075
   ClientLeft      =   60
   ...
   Begin VB.Frame frFormDtl 
      ...
      Begin VB.TextBox mskFormBoundField 
         ...
         Width           =   855
      End
      Begin VB.Frame frLabReg 
         Appearance      =   0  'Flat
         BackColor       =   &H00FFFFC0&
         Caption         =   "Lab Registration (2):"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
         ...
         Top             =   840
         Width           =   12255
         Begin VB.TextBox mskLpgRegValidDays 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BeginProperty DataFormat 
               Type            =   1
         ...
         Begin VB.Label Label2 
            ...
            Caption         =   "Lab Registration Validity (Days):"
            BeginProperty Font 
               Name            =   "Verdana"
               Size            =   8.25
               Charset         =   0
         ...
         End
      End
      Begin VB.Frame frLabRcpt 
         Appearance      =   0  'Flat
         BackColor       =   &H00F0FDEB&
         Caption         =   "Lab Receipt (4):"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
         ...
         End
      End
      Begin VB.Frame frLabPymt 
         Appearance      =   0  'Flat
         BackColor       =   &H00D0F4EE&
         Caption         =   "Lab Payment Receipt (5):"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
         ...
         End
      End
      Begin VB.Frame frLabRefd 
         Appearance      =   0  'Flat
         BackColor       =   &H00FAF4BE&
         Caption         =   "Lab Refund Receipt (6):"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Frame frServRateSystem 
         Appearance      =   0  'Flat
         BackColor       =   &H00F4FFF6&
         Caption         =   "Service Charges/Share System (10)"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.ComboBox cmbFormEntryMode 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "HmsLbOpt.frx":0000
      Left            =   0
      List            =   "HmsLbOpt.frx":000D
   ...
   End
End
Attribute VB_Name = "frmHmsLabOptions"
...
Dim clsOPT As clsHmsLabOptionsEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
...
Dim fcmbPcgName As clsHmsFlexSearch, fcmbCDctName As clsHmsFlexSearch, fcmbRByName As clsHmsFlexSearch, fcmbFDigName As clsHmsFlexSearch, fcmbSrvName As clsHmsFlexSearch

Const cOPT_PATMAST = 1
Const cOPT_LABREG = 2
Const cOPT_LABRCPT = 4
Const cOPT_LABPYMT = 5
Const cOPT_LABREFD = 6
Const cOPT_SERVRATESYS = 10
...
Set clsOPT = New clsHmsLabOptionsEntry
...
frLabReg.Visible = EntryMode And mOptCode = cOPT_LABREG: frLabReg.Enabled = EntryMode And mOptCode = cOPT_LABREG
frLabRcpt.Visible = EntryMode And mOptCode = cOPT_LABRCPT: frLabRcpt.Enabled = EntryMode And mOptCode = cOPT_LABRCPT
frLabPymt.Visible = EntryMode And mOptCode = cOPT_LABPYMT: frLabPymt.Enabled = EntryMode And mOptCode = cOPT_LABPYMT
frLabRefd.Visible = EntryMode And mOptCode = cOPT_LABREFD: frLabRefd.Enabled = EntryMode And mOptCode = cOPT_LABREFD
...
Private Sub mskLpgRegValidDays_GotFocus()
FlashActiveControl mskLpgRegValidDays, True
End Sub

Private Sub mskLpgRegValidDays_LostFocus()
FlashActiveControl mskLpgRegValidDays, False
End Sub

Private Sub mskLpgRegValidDays_Validate(Cancel As Boolean)
mskLpgRegValidDays.Text = Val(mskLpgRegValidDays.Text)
If Val(mskLpgRegValidDays.Text) < 0 Then
    ErrorBox "Invalid Input !!!"
    mskLpgRegValidDays.SetFocus
    Cancel = True
End If
...
Case cOPT_LABREG
    With clsOPT
    .ResetInit
    .blnLabRegOptMast = True
    .Init
    .GetLabRegOptData
    
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cHMS_VTYPE_LAB_RCPT) & " order by VtmName"
    fcmbVtmName.ReInit
    
    chkPttRegNoAutoNumber(mOptCode).Value = IIf(.mLpgPttRegNoAutoNumber_bln = True, vbChecked, vbUnchecked)
    chkPttRegNoAddModeChange(mOptCode).Value = IIf(.mLpgPttRegNoAddModeChange_bln = True, vbChecked, vbUnchecked)
    chkPttRegNoEditModeChange(mOptCode).Value = IIf(.mLpgPttRegNoEditModeChange_bln = True, vbChecked, vbUnchecked)
    chkPttRegNoNotZero(mOptCode).Value = IIf(.mLpgPttRegNoNotZero_bln = True, vbChecked, vbUnchecked)
    mskLpgRegValidDays.Text = .mLpgRegValidDays_int
    fcmbAraName.BoundText = CStr(.mLpgAraCodeDef_lng): txtAraName(mOptCode).Text = fcmbAraName.Text
    fcmbStnName.BoundText = CStr(.mLpgStnCodeDef_lng): txtStnName(mOptCode).Text = fcmbStnName.Text
    fcmbPcgName.BoundText = CStr(.mLpgPcgCodeDef_lng): txtPcgName(mOptCode).Text = fcmbPcgName.Text
    fcmbAhName.BoundText = CStr(.mLpgPttAhCodeDef_lng): txtAhName(mOptCode).Text = fcmbAhName.Text
    Rem fcmbVtmName.BoundText = CStr(.mLpgVtmCodeDef_lng): txtVtmName(mOptCode).Text = fcmbVtmName.Text
    fcmbCDctName.BoundText = CStr(.mLpgCDctCodeDef_lng): txtCDctName(mOptCode).Text = fcmbCDctName.Text
    fcmbRByName.BoundText = CStr(.mLpgRByCodeDef_lng): txtRByName(mOptCode).Text = fcmbRByName.Text
    fcmbFDigName.BoundText = CStr(.mLpgFDigCodeDef_lng): txtFDigName(mOptCode).Text = fcmbFDigName.Text
    Rem fcmbSrvName.BoundText = CStr(.mLpgSrvCodeDef_lng): txtSrvName(mOptCode).Text = fcmbSrvName.Text
    ' ---------------
    chkAraNameCFD(mOptCode).Value = IIf(.mLpgAraCodeCfd_bln = True, vbChecked, vbUnchecked)
    chkStnNameCFD(mOptCode).Value = IIf(.mLpgStnCodeCfd_bln = True, vbChecked, vbUnchecked)
    chkPcgNameCFD(mOptCode).Value = IIf(.mLpgPcgCodeCfd_bln = True, vbChecked, vbUnchecked)
    chkAhNameCFD(mOptCode).Value = IIf(.mLpgPttAhCodeCfd_bln = True, vbChecked, vbUnchecked)
    Rem chkVtmNameCFD(mOptCode).Value = IIf(.mLabVtmCodeCfd_bln = True, vbChecked, vbUnchecked)
    chkCDctNameCFD(mOptCode).Value = IIf(.mLpgCDctCodeCfd_bln = True, vbChecked, vbUnchecked)
    chkRByNameCFD(mOptCode).Value = IIf(.mLpgRByCodeCfd_bln = True, vbChecked, vbUnchecked)
    chkFDigNameCFD(mOptCode).Value = IIf(.mLpgFDigCodeCfd_bln = True, vbChecked, vbUnchecked)
    Rem chkSrvNameCFD(mOptCode).Value = IIf(.mLpgSrvCodeCfd_bln = True, vbChecked, vbUnchecked)
    End With
    
Case cOPT_LABRCPT
    With clsOPT
    .ResetInit
    .blnLabRcptOptMast = True
    .Init
    .GetLabRcptOptData
    ...
    chkPttRegNoNotZero(mOptCode).Value = IIf(.mLrcPttRegNoNotZero_bln = True, vbChecked, vbUnchecked)
    fcmbVtmName.BoundText = CStr(.mLrcVtmCodeDef_lng): txtVtmName(mOptCode).Text = fcmbVtmName.Text
    ' ---------------
    chkVtmNameCFD(mOptCode).Value = IIf(.mLrcVtmCodeCfd_bln = True, vbChecked, vbUnchecked)
    End With
    
Case cOPT_LABPYMT
    With clsOPT
    .ResetInit
    .blnLabPymtOptMast = True
    .Init
    .GetLabPymtOptData
    
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cHMS_VTYPE_LAB_PYMT) & " order by VtmName"
    fcmbVtmName.ReInit
    
    chkPttRegNoNotZero(mOptCode).Value = IIf(.mLpyPttRegNoNotZero_bln = True, vbChecked, vbUnchecked)
    fcmbVtmName.BoundText = CStr(.mLpyVtmCodeDef_lng): txtVtmName(mOptCode).Text = fcmbVtmName.Text
    ' ---------------
    chkVtmNameCFD(mOptCode).Value = IIf(.mLpyVtmCodeCfd_bln = True, vbChecked, vbUnchecked)
    End With
    
Case cOPT_LABREFD
    With clsOPT
    .ResetInit
    .blnLabRefdOptMast = True
    .Init
    .GetLabRefdOptData
    
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cHMS_VTYPE_LAB_REFD) & " order by VtmName"
    fcmbVtmName.ReInit
    
    chkPttRegNoNotZero(mOptCode).Value = IIf(.mLfdPttRegNoNotZero_bln = True, vbChecked, vbUnchecked)
    fcmbVtmName.BoundText = CStr(.mLfdVtmCodeDef_lng): txtVtmName(mOptCode).Text = fcmbVtmName.Text
    ' ---------------
    chkVtmNameCFD(mOptCode).Value = IIf(.mLfdVtmCodeCfd_bln = True, vbChecked, vbUnchecked)
    End With
...
Else
    If mOptCode = cOPT_PATMAST Then
        .GetPatMastOptData
    ElseIf mOptCode = cOPT_LABREG Then
        .GetLabRegOptData
    ElseIf mOptCode = cOPT_LABRCPT Then
        .GetLabRcptOptData
    ElseIf mOptCode = cOPT_LABPYMT Then
        .GetLabPymtOptData
    ElseIf mOptCode = cOPT_LABREFD Then
        .GetLabRefdOptData
...
ElseIf mOptCode = cOPT_LABREG Then
    .mLpgPttRegNoAutoNumber_bln = (chkPttRegNoAutoNumber(mOptCode).Value = vbChecked)
    .mLpgPttRegNoAddModeChange_bln = (chkPttRegNoAddModeChange(mOptCode).Value = vbChecked)
    .mLpgPttRegNoEditModeChange_bln = (chkPttRegNoEditModeChange(mOptCode).Value = vbChecked)
    .mLpgPttRegNoNotZero_bln = (chkPttRegNoNotZero(mOptCode).Value = vbChecked)
    .mLpgRegValidDays_int = Val(mskLpgRegValidDays.Text)
    .mLpgAraCodeDef_lng = Val(fcmbAraName.BoundText)
    .mLpgStnCodeDef_lng = Val(fcmbStnName.BoundText)
    .mLpgPcgCodeDef_lng = Val(fcmbPcgName.BoundText)
    .mLpgPttAhCodeDef_lng = Val(fcmbAhName.BoundText)
    Rem .mLabVtmCodeDef_lng = Val(fcmbVtmName.BoundText)
    .mLpgCDctCodeDef_lng = Val(fcmbCDctName.BoundText)
    .mLpgRByCodeDef_lng = Val(fcmbRByName.BoundText)
    .mLpgFDigCodeDef_lng = Val(fcmbFDigName.BoundText)
    Rem .mLpgSrvCodeDef_lng = Val(fcmbSrvName.BoundText)
    ' ---------------
    .mLpgAraCodeCfd_bln = (chkAraNameCFD(mOptCode).Value = vbChecked)
    .mLpgStnCodeCfd_bln = (chkStnNameCFD(mOptCode).Value = vbChecked)
    .mLpgPcgCodeCfd_bln = (chkPcgNameCFD(mOptCode).Value = vbChecked)
    .mLpgPttAhCodeCfd_bln = (chkAhNameCFD(mOptCode).Value = vbChecked)
    Rem .mLabVtmCodeCfd_bln = (chkVtmNameCFD(mOptCode).Value = vbChecked)
    .mLpgCDctCodeCfd_bln = (chkCDctNameCFD(mOptCode).Value = vbChecked)
    .mLpgRByCodeCfd_bln = (chkRByNameCFD(mOptCode).Value = vbChecked)
    .mLpgFDigCodeCfd_bln = (chkFDigNameCFD(mOptCode).Value = vbChecked)
    Rem .mLpgSrvCodeCfd_bln = (chkSrvNameCFD(mOptCode).Value = vbChecked)

    .UpdateLabRegOpt
    mEntrySaved = True
   
ElseIf mOptCode = cOPT_LABRCPT Then
    .mLrcPttRegNoNotZero_bln = (chkPttRegNoNotZero(mOptCode).Value = vbChecked)
    .mLrcVtmCodeDef_lng = Val(fcmbVtmName.BoundText)
    ' ---------------
    .mLrcVtmCodeCfd_bln = (chkVtmNameCFD(mOptCode).Value = vbChecked)

    .UpdateLabRcptOpt
    mEntrySaved = True
    
ElseIf mOptCode = cOPT_LABPYMT Then
    .mLpyPttRegNoNotZero_bln = (chkPttRegNoNotZero(mOptCode).Value = vbChecked)
    .mLpyVtmCodeDef_lng = Val(fcmbVtmName.BoundText)
    ' ---------------
    .mLpyVtmCodeCfd_bln = (chkVtmNameCFD(mOptCode).Value = vbChecked)
    
    .UpdateLabPymtOpt
    mEntrySaved = True

ElseIf mOptCode = cOPT_LABREFD Then
    .mLfdPttRegNoNotZero_bln = (chkPttRegNoNotZero(mOptCode).Value = vbChecked)
    .mLfdVtmCodeDef_lng = Val(fcmbVtmName.BoundText)
    ' ---------------
    .mLfdVtmCodeCfd_bln = (chkVtmNameCFD(mOptCode).Value = vbChecked)
...
'    Do While .EOF = False
        ...
        End If
        Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OptCode")) = cOPT_LABREG
        Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OptName")) = "Lab Registration"
        ' --------------------------------
        srow = srow + 1
        If Mfgrd1.Rows < srow + 1 Then
            Mfgrd1.Rows = Mfgrd1.Rows + 1
        End If
        Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OptCode")) = cOPT_LABRCPT
        Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OptName")) = "Lab Receipt"
        ' --------------------------------
        srow = srow + 1
        If Mfgrd1.Rows < srow + 1 Then
            Mfgrd1.Rows = Mfgrd1.Rows + 1
        End If
        Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OptCode")) = cOPT_LABPYMT
        Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OptName")) = "Lab Payment"
        ' --------------------------------
        srow = srow + 1
        If Mfgrd1.Rows < srow + 1 Then
            Mfgrd1.Rows = Mfgrd1.Rows + 1
        End If
        Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OptCode")) = cOPT_LABREFD
        Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OptName")) = "Lab Refund"
        ' --------------------------------
        srow = srow + 1
        If Mfgrd1.Rows < srow + 1 Then
            Mfgrd1.Rows = Mfgrd1.Rows + 1
