...
Dim clsAH As clsAccountHead, clsRTO As clsHmsMasterEntry, clsRFG As clsHmsMasterEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
Dim fcmbAhName As clsComFlexSearch, fcmbRfgName As clsHmsFlexSearch
...
Set clsRTO = New clsHmsMasterEntry
Set clsRTO.dbHmsDatabase = dbHmsDatabase
...
Set fcmbRfgName = New clsHmsFlexSearch
Set fcmbRfgName.dbHmsDatabase = dbHmsDatabase
...
If txtRToName.Text <> mRToName_old Then
    If ChkIsDuplicate(dbHmsDatabase, "RefToMast", "RToName", txtRToName.Text, "RToCode", Val(mskFormBoundField.Text)) = True Then
...
fcmbAhName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbHmsDatabase, mTableName:="RefToMast", mColumnName:="RToAhCode", mOrderByColName:="RToCode", mRtnDefValue:=0))
txtAhName.Text = fcmbAhName.Text
