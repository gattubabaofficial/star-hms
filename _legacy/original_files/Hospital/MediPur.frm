...
Dim dbAcDatabase As New ADODB.Connection, dbStDatabase As New ADODB.Connection, dbMdsDatabase As New ADODB.Connection, dbHmsDatabase As New ADODB.Connection, dbGrpDatabase As New ADODB.Connection, dbComDatabase As New ADODB.Connection
...
Dim clsPRT As Object, clsSIM As clsHmsMasterEntry
Dim mActiveControl As Object, clsListStru As clsSelectQueryStructure
Dim fcmbVtmName As clsComFlexSearch
Dim fcmbPrtName As Object, fcmbSimName As clsHmsFlexSearch
...
Set clsPUR.dbHmsDatabase = dbHmsDatabase
...
If mFormSysVchType = cCOM_VTYPE_RETNINW Then
    ...
    fcmbPrtName.Init
    ' -----------------------
    Set clsPRT = New clsHmsMasterEntry
    Set clsPRT.dbAcDatabase = dbAcDatabase
    Set clsPRT.dbHmsDatabase = dbHmsDatabase
...
CloseDataSource dbHmsDatabase, mCheckOpen:=True
