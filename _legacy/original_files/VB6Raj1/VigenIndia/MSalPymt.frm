...
Begin VB.Form frmMediSalesPayment 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ClientHeight    =   10860
   ClientLeft      =   60
   ...
   Begin VB.ComboBox cmbFormEntryMode 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "MSalPymt.frx":0000
      Left            =   0
      List            =   "MSalPymt.frx":000D
   ...
   Begin VB.Frame frFormDtl 
      ...
      Top             =   720
      Width           =   13215
      Begin VB.TextBox mskSalRefuAmt 
      ...
      Begin VB.TextBox mskSalBalAmt 
         ...
         Width           =   1215
      End
      Begin VB.TextBox mskSalDepoAmtExcl 
         Alignment       =   1  'Right Justify
         Appearance      =   0  'Flat
         BeginProperty DataFormat 
            Type            =   1
         ...
         Width           =   1215
      End
      Begin VB.TextBox mskSalRecdAmt 
         Alignment       =   1  'Right Justify
         Appearance      =   0  'Flat
         BeginProperty DataFormat 
            Type            =   1
      ...
      Begin VB.TextBox dtpSalDate 
         ...
         Width           =   1455
      End
      Begin VB.TextBox txtSalVtmName 
         Appearance      =   0  'Flat
         BeginProperty DataFormat 
            Type            =   0
            Format          =   "0"
      ...
      Begin VB.Frame frFooter 
         ...
         Top             =   6600
         Width           =   12855
         Begin VB.Label lblSalRefuAmtTot 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
            Caption         =   "0.00"
            ...
            Width           =   1215
         End
         Begin VB.Label lblSalAdvAmtTot 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
            Caption         =   "0.00"
            ...
            Width           =   1215
         End
         Begin VB.Label lblSalBalAmtTot 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
            Caption         =   "0.00"
            ...
            Width           =   1215
         End
         Begin VB.Label lblSpyDepoAmtTot 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
            Caption         =   "0.00"
            ...
            Width           =   1215
         End
         Begin VB.Label lblSalDepoAmtExclTot 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
            Caption         =   "0.00"
            ...
            Width           =   1215
         End
         Begin VB.Label lblSalRecdAmtTot 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
            Caption         =   "0.00"
         ...
         Begin VB.Label Label2 
            ...
            Width           =   1695
         End
         Begin VB.Label lblOldSpyCodeDesc 
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
            BeginProperty Font 
               Name            =   "Verdana"
         ...
         Begin VB.Label Label2 
            ...
            Width           =   3495
         End
         Begin VB.Label lblSalAmtAftDiscTot 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
            Caption         =   "0.00"
      ...
      Begin VB.Frame frHeader 
         ...
         Begin VB.TextBox txtPttSex 
            ...
            Width           =   1215
         End
         Begin VB.TextBox txtSpyTime_str 
            Appearance      =   0  'Flat
            BeginProperty DataFormat 
               Type            =   0
               Format          =   "0"
         ...
         Begin VB.TextBox mskSpyVchNo 
            ...
            Width           =   1335
         End
         Begin VB.TextBox txtSpyVtmName 
            Appearance      =   0  'Flat
            BeginProperty DataFormat 
               Type            =   0
               Format          =   "0"
         ...
         Begin VB.TextBox dtpPttAgeAsOnDt 
            ...
            Width           =   1455
         End
         Begin VB.TextBox mskSpyPttCode 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BeginProperty DataFormat 
               Type            =   1
      ...
      Begin VB.TextBox mskSalVchNo 
         ...
         Width           =   1095
      End
      Begin VB.TextBox mskSpyDepoAmt 
         Alignment       =   1  'Right Justify
         Appearance      =   0  'Flat
         BeginProperty DataFormat 
            Type            =   1
   ...
   Begin VB.Label lblFormHeading 
      ...
      BackColor       =   &H00E0E0E0&
      BorderStyle     =   1  'Fixed Single
      Caption         =   "Store Sale Bill Payment"
      BeginProperty Font 
         Name            =   "Verdana"
         Size            =   9.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmMediSalesPayment"
...
Dim mSpyCode As Long, mSpyPttCode As Long, mQryPttCode As Long, mSpyOldSpyCode As Long, dtlAddEditMode As Boolean, dtlAddMode As Boolean, dtlEditCanceled As Boolean
...
Dim mSpyCode_old As Long, mSpyDate_old As Date, mSpyVtmCode_old As Long, mSpyVchNo_old As Long
Dim mSalCode_old As Long, mSpyDepoAmt_old As Double
Dim clsJRN As clsJournal, clsAH As clsAccountHead, clsOPG As clsVgnSnglTranEntry, clsSAL As clsVgnMultiTranEntry, clsSPY As clsVgnMultiTranEntry, clsARA As clsComMastEntry, clsSTN As clsComMastEntry, clsVTM As clsComMastEntry       ''' , clsVGNOPT As clsVgnOpdOptionsEntry
Dim clsPAT As clsVgnMasterEntry, clsPCG As clsVgnMasterEntry
Dim mActiveControl As Object, clsListStru As clsSelectQueryStructure
Dim fcmbSpyVtmName As clsComFlexSearch
Dim fcmbOldOpgByPttRegNo As clsVgnFlexSearch, fcmbOldOpgByPttName As clsVgnFlexSearch, fcmbPttName As clsVgnFlexSearch, fcmbPttRegNo As clsVgnFlexSearch, fcmbSalVchNo As clsVgnFlexSearch
...
Const X2SPYICODE_COL = 0
Const X2SPYSNO_COL = 1
Const X2SALVCHNO_COL = 2
Const X2SALVTMNAME_COL = 3
Const X2SALDATE_COL = 4
Const X2SALAMOUNT_COL = 5
Const X2SALADVAMT_COL = 6
Const X2SALRECDAMT_COL = 7
Const X2SALDEPOAMTEXCL_COL = 8
Const X2SPYDEPOAMT_COL = 9
Const X2SALREFUAMT_COL = 10
Const X2SALBALAMT_COL = 11
Const X2SALCODE_COL = 12
Const X2SPYRECSTATE_COL = 13
        ...
        If .EOF = False And .BOF = False Then
            ...
            Else
                ...
                If optMonthwise.Value = True Then
                    dtpFromDate.Text = Dtoc(MonthStartDate(DateSerial(Val(Left(.fields("SpyYrMonth"), 4)), Val(Right(.fields("SpyYrMonth"), 2)), 1)))
                    dtpToDate.Text = Dtoc(MonthEndDate(DateSerial(Val(Left(.fields("SpyYrMonth"), 4)), Val(Right(.fields("SpyYrMonth"), 2)), 1)))
                    optMonthwise.Value = False
                    optDatewise.Value = True
                ElseIf optDatewise.Value = True Then
                    dtpFromDate.Text = Dtoc(.fields("SphDate"))
                    dtpToDate.Text = Dtoc(.fields("SphDate"))
                    optDatewise.Value = False
                    optDetailed.Value = True
                ElseIf optPatientwise.Value = True Then
                    mQryPttCode = .fields("SphPttCode")
                    fcmbPttRegNo.BoundText = CStr(mQryPttCode)
                    fcmbPttName.BoundText = CStr(mQryPttCode)
...
Dim tRecset As New ADODB.Recordset, srow As Integer, mSpySno As Integer, mSpyICode As Long

srow = Mfgrd2.Row
mSpySno = Val(Mfgrd2.TextMatrix(srow, X2SPYSNO_COL))
mSpyICode = Val(Mfgrd2.TextMatrix(srow, X2SPYICODE_COL))
...
If cmdOK.Caption = "&OK" And dtlEditCanceled = False Then
    ...
    If dtlAddMode = True Then
        .ClearDtl
    Else
        .GetDtlData mSpyCode, mSpyICode
    End If
    .mTrnCode_lng = mSpyCode
    .mTrnDtlSno_int = Val(UnMyNumFmt(mskSpySno.Text))
    .mTrnDate_dt = Ctod(dtpSpyDate.Text)
    .mTrnCmpCode_int = sFinYrCmpCode
    
    .mSpyPttCode_lng = mSpyPttCode
    .mSpySahCode_lng = Val(fcmbSalVchNo.BoundText)
    .mSpyDepoAmt_dbl = Val(UnMyNumFmt(mskSpyDepoAmt.Text))
    .mSpyRemark_str = ""
    
    If dtlAddMode = True Then
        .AddNewDtl mSpyCode
        mSpyICode = .mTrnDtlICode_lng
    Else
        .UpdateDtl mSpyCode, mSpyICode
    End If
    End With
    
    RefreshDatabase dbVgnDatabase
    With tRecset
    .open "Select * from MedSalePymtDtl where SpyCode = " & CStr(mSpyCode) & " and SpyICode = " & CStr(mSpyICode) & "", dbVgnDatabase, adOpenKeyset, adLockOptimistic
    
    clsSAL.GetHdrData .fields("SpySahCode")
    clsVTM.GetData clsSAL.mTrnVtmCode_lng
    
    Mfgrd2.TextMatrix(srow, X2SPYICODE_COL) = .fields("SpyICode")
    Mfgrd2.TextMatrix(srow, X2SPYSNO_COL) = ToMyNumFmt(.fields("SpySno"), mDecimals:=0)
    Mfgrd2.TextMatrix(srow, X2SALVCHNO_COL) = clsSAL.mTrnVchNo_lng
    Mfgrd2.TextMatrix(srow, X2SALVTMNAME_COL) = clsVTM.mName_str
    Mfgrd2.TextMatrix(srow, X2SALDATE_COL) = clsSAL.mTrnDate_dt
    Mfgrd2.TextMatrix(srow, X2SALAMOUNT_COL) = ToMyNumFmt(clsSAL.mSahAmount_dbl)
    Mfgrd2.TextMatrix(srow, X2SALADVAMT_COL) = ToMyNumFmt(clsSAL.mSahAdvAmt_dbl)
    Mfgrd2.TextMatrix(srow, X2SALRECDAMT_COL) = ToMyNumFmt(clsSAL.mSahRecdAmt_dbl)
    Mfgrd2.TextMatrix(srow, X2SALDEPOAMTEXCL_COL) = ToMyNumFmt(clsSAL.mSahDepoAmt_dbl - .fields("SpyDepoAmt"))
    Mfgrd2.TextMatrix(srow, X2SPYDEPOAMT_COL) = ToMyNumFmt(.fields("SpyDepoAmt"))
    Mfgrd2.TextMatrix(srow, X2SALREFUAMT_COL) = ToMyNumFmt(clsSAL.mSahRefuAmt_dbl)
    Mfgrd2.TextMatrix(srow, X2SALBALAMT_COL) = ToMyNumFmt(clsSAL.mSahBalAmt_dbl)
    Mfgrd2.TextMatrix(srow, X2SALCODE_COL) = .fields("SpySahCode")
    Mfgrd2.TextMatrix(srow, X2SPYRECSTATE_COL) = .fields("SpyRecState")
...
If optDetailed.Value = True Then
    txtSearch1Text_InterActiveChange Format(Ctod(dtpSpyDate.Text), "yyyymmdd") + Format(mSpyCode, "0000000")
ElseIf optMonthwise.Value = True Then
    txtSearch1Text_InterActiveChange Format(Ctod(dtpSpyDate.Text), "yyyy") & "/" & Format(Ctod(dtpSpyDate.Text), "mm")
ElseIf optDatewise.Value = True Then
    txtSearch1Text_InterActiveChange Format(Ctod(dtpSpyDate.Text), "yyyymmdd")
ElseIf optPatientwise.Value = True Then
...
Private Sub dtpSpyDate_GotFocus()
FlashActiveControl dtpSpyDate, True
End Sub

Private Sub dtpSpyDate_LostFocus()
FlashActiveControl dtpSpyDate, False
End Sub

Private Sub dtpSpyDate_Validate(Cancel As Boolean)
dtpSpyDate.Text = ToMyDate(dtpSpyDate.Text)
If IsFinYrDate(Ctod(dtpSpyDate.Text)) = False Then
...
mFormUIdFileName = "MSalPyRc.Uid"
mFormAcsPermFileName = "MSalPyRc.Acp"
...
ChkCustomForm Me, CfsFileFullPath("VSalPymt.Cfs")
...
'clsVGNOPT.blnOutdPymtOptMast = True
'clsVGNOPT.Init
'clsVGNOPT.GetOutdPymtOptData
...
Set clsSPY = New clsVgnMultiTranEntry
Set clsSPY.dbAcDatabase = dbAcDatabase
Set clsSPY.dbVgnDatabase = dbVgnDatabase
Set clsSPY.dbComDatabase = dbComDatabase
clsSPY.blnMedSalePymtTran = True
clsSPY.Init
...
Set fcmbSpyVtmName = New clsComFlexSearch
Set fcmbSpyVtmName.dbAcDatabase = dbAcDatabase
fcmbSpyVtmName.blnVTypeMastList = True
fcmbSpyVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cVGN_VTYPE_MEDSALE_PYMT) & " order by VtmName"
fcmbSpyVtmName.Init

Set fcmbSalVchNo = New clsVgnFlexSearch
Set fcmbSalVchNo.dbVgnDatabase = dbVgnDatabase
Set fcmbSalVchNo.dbComDatabase = dbComDatabase
fcmbSalVchNo.blnOldSalListBySalNo = True
fcmbSalVchNo.Init
...
If mRemoteAccess = True Then
    datRecset.open "Select * from MedSalePymtHdr inner join PatMast on MedSalePymtHdr.SphPttCode = PatMast.PttCode where SphCode = " & CStr(mSpyCode) & " order by SphDate,SphTime", dbComDatabase, adOpenKeyset, adLockOptimistic
    dtpFromDate.Text = Dtoc(datRecset.fields("SphDate"))
    dtpToDate.Text = Dtoc(datRecset.fields("SphDate"))
    AddSmryParaLayer mClear:=True
Else
    datRecset.open "Select * from MedSalePymtHdr inner join PatMast on MedSalePymtHdr.SphPttCode=PatMast.PttCode order by SphDate,SphTime", dbComDatabase, adOpenKeyset, adLockOptimistic
End If
Mfgrd1.FixedCols = 0
Call SmryList
...
colcnt = X2SPYICODE_COL: Mfgrd2.ColWidth(colcnt) = 0: Mfgrd2.TextMatrix(0, colcnt) = "X2SPYICODE_COL": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2SPYSNO_COL: Mfgrd2.ColWidth(colcnt) = mskSpySno.Width: Mfgrd2.TextMatrix(0, colcnt) = "Sno": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2SALVCHNO_COL: Mfgrd2.ColWidth(colcnt) = mskSalVchNo.Width: Mfgrd2.TextMatrix(0, colcnt) = "Vch.No": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2SALVTMNAME_COL: Mfgrd2.ColWidth(colcnt) = txtSalVtmName.Width: Mfgrd2.TextMatrix(0, colcnt) = "Vch.Type": Mfgrd2.ColAlignment(colcnt) = 1
colcnt = X2SALDATE_COL: Mfgrd2.ColWidth(colcnt) = dtpSalDate.Width: Mfgrd2.TextMatrix(0, colcnt) = "Vch.Date": Mfgrd2.ColAlignment(colcnt) = 1
...
colcnt = X2SALADVAMT_COL: Mfgrd2.ColWidth(colcnt) = mskSalAdvAmt.Width: Mfgrd2.TextMatrix(0, colcnt) = "Adv.Amt": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2SALRECDAMT_COL: Mfgrd2.ColWidth(colcnt) = mskSalRecdAmt.Width: Mfgrd2.TextMatrix(0, colcnt) = "Recd.Amt": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2SALDEPOAMTEXCL_COL: Mfgrd2.ColWidth(colcnt) = mskSalDepoAmtExcl.Width: Mfgrd2.TextMatrix(0, colcnt) = "PreDepo.Amt": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2SPYDEPOAMT_COL: Mfgrd2.ColWidth(colcnt) = mskSpyDepoAmt.Width: Mfgrd2.TextMatrix(0, colcnt) = "Depo.Amt": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2SALREFUAMT_COL: Mfgrd2.ColWidth(colcnt) = mskSalRefuAmt.Width: Mfgrd2.TextMatrix(0, colcnt) = "Refund.Amt": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2SALBALAMT_COL: Mfgrd2.ColWidth(colcnt) = mskSalBalAmt.Width: Mfgrd2.TextMatrix(0, colcnt) = "Bal.Amt": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2SALCODE_COL: Mfgrd2.ColWidth(colcnt) = 0: Mfgrd2.TextMatrix(0, colcnt) = "X2SALCODE_COL": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2SPYRECSTATE_COL: Mfgrd2.ColWidth(colcnt) = 0: Mfgrd2.TextMatrix(0, colcnt) = "X2SPYRECSTATE_COL": Mfgrd2.ColAlignment(colcnt) = 7

colcnt = X2SPYSNO_COL: mskSpySno.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
colcnt = X2SALVCHNO_COL: mskSalVchNo.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
colcnt = X2SALVTMNAME_COL: txtSalVtmName.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
colcnt = X2SALDATE_COL: dtpSalDate.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
colcnt = X2SALAMOUNT_COL: mskSalAmount.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
colcnt = X2SALADVAMT_COL: mskSalAdvAmt.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
colcnt = X2SALRECDAMT_COL: mskSalRecdAmt.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
colcnt = X2SALDEPOAMTEXCL_COL: mskSalDepoAmtExcl.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
colcnt = X2SPYDEPOAMT_COL: mskSpyDepoAmt.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
colcnt = X2SALREFUAMT_COL: mskSalRefuAmt.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
colcnt = X2SALBALAMT_COL: mskSalBalAmt.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
cmdOK.Left = mskSalBalAmt.Left + mskSalBalAmt.Width

lblSalAmtAftDiscTot.Left = mskSalAmount.Left - frFooter.Left: lblSalAmtAftDiscTot.Width = mskSalAmount.Width
lblSalAdvAmtTot.Left = mskSalAdvAmt.Left - frFooter.Left: lblSalAdvAmtTot.Width = mskSalAdvAmt.Width
lblSalRecdAmtTot.Left = mskSalRecdAmt.Left - frFooter.Left: lblSalRecdAmtTot.Width = mskSalRecdAmt.Width
lblSalDepoAmtExclTot.Left = mskSalDepoAmtExcl.Left - frFooter.Left: lblSalDepoAmtExclTot.Width = mskSalDepoAmtExcl.Width
lblSpyDepoAmtTot.Left = mskSpyDepoAmt.Left - frFooter.Left: lblSpyDepoAmtTot.Width = mskSpyDepoAmt.Width
lblSalRefuAmtTot.Left = mskSalRefuAmt.Left - frFooter.Left: lblSalRefuAmtTot.Width = mskSalRefuAmt.Width
lblSalBalAmtTot.Left = mskSalBalAmt.Left - frFooter.Left: lblSalBalAmtTot.Width = mskSalBalAmt.Width
...
Set fcmbSpyVtmName = Nothing
Set fcmbSalVchNo = Nothing
...
Dim mPttRegNo As Long, mSpyPttCode As Long, mOpgVchNo As Long, mSpyVchNo As Long
Dim mSalAmountTot As Double, mSalAdvAmtTot As Double, mSalRecdAmtTot As Double, mSalDepoAmtExclTot As Double, mSpyDepoAmtTot As Double, mSalRefuAmtTot As Double
...
mSpyPttCode = Val(mskSpyPttCode.Text)
If mSpyPttCode < 1 Then
    ErrorBox "Invalid Key Value !!!"
    txtPttName.SetFocus
    GoTo EndSub
End If
...
If mPttRegNo < 0 Then
    ...
    GoTo EndSub
'Else
'    If mPttRegNo = 0 And clsVGNOPT.mSpyPttRegNoNotZero_bln = True Then
...
'If Val(mskSpyOpgCode.Text) < 1 Then
'    ErrorBox "Invalid Key Value !!!"
'    txtPttName.SetFocus
'    GoTo EndSub
'End If
...
'    GoTo EndSub
'End If
Rem outdoor payment receipt validations
mSpyVchNo = Val(UnMyNumFmt(mskSpyVchNo(0).Text))
If mSpyVchNo > 0 Then
    If mSpyVchNo <> mSpyVchNo_old Or Val(fcmbSpyVtmName.BoundText) <> mSpyVtmCode_old Or Ctod(dtpSpyDate.Text) <> mSpyDate_old Or FormAddEditMode = cFORM_ADDMODE Then
        If ChkIsDuplVTypeNo(dbVgnDatabase, dbAcDatabase, mTableName:="MedSalePymtHdr", mChkFieldName:="SphVchNo", mChkFieldValue:=mSpyVchNo, mKeyFieldName:="SphCode", mKeyFieldValue:=mSpyCode, mVtmFieldName:="SphVtmCode", mVtmFieldValue:=Val(fcmbSpyVtmName.BoundText), mFinYrFieldName:="SphCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="SphDate", mDateFieldValue:=Ctod(dtpSpyDate.Text)) = True Then
            ErrorBox "Duplicate Voucher No. !!!"
            mskSpyVchNo(0).SetFocus
            ' ---------------
            If FormAddEditMode = True Then
                mSpyVchNo = GetNextVTypeNo(dbVgnDatabase, dbAcDatabase, dbComDatabase, mTableName:="MedSalePymtHdr", mFieldName:="SphVchNo", mVtmFieldName:="SphVtmCode", mVtmFieldValue:=Val(fcmbSpyVtmName.BoundText), mFinYrFieldName:="SphCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="SphDate", mDateFieldValue:=Ctod(dtpSpyDate.Text), mModuleCode:=mFormUIdCode, mModuleName:=Me.Name, mAcsPermFileName:=mFormAcsPermFileName)
            Else
                mSpyVchNo = mSpyVchNo_old
            End If
            mskSpyVchNo(0).Text = ToMyNumFmt(mSpyVchNo, mDecimals:=0)
            GoTo EndSub
        End If
    End If
Else
    ...
    GoTo EndSub
End If
If IsDate(dtpSpyDate.Text) = False Then
    ErrorBox "Invalid Input !!!"
    dtpSpyDate.SetFocus
    GoTo EndSub
Else
    ...
    End If
End If
If TimeToMin(txtSpyTime_str.Text) > cDAYMINUTES Then
    ErrorBox "Invalid Input !!!"
    txtSpyTime_str.SetFocus
    GoTo EndSub
End If
mSpyDepoAmtTot = Val(UnMyNumFmt(lblSpyDepoAmtTot.Caption))
If mSpyDepoAmtTot < 0 Then
    ErrorBox "Invalid Input !!!"
    Mfgrd2.SetFocus
    GoTo EndSub
End If
mSalAmountTot = Val(UnMyNumFmt(lblSalAmtAftDiscTot.Caption))
mSalAdvAmtTot = Val(UnMyNumFmt(lblSalAdvAmtTot.Caption))
mSalRecdAmtTot = Val(UnMyNumFmt(lblSalRecdAmtTot.Caption))
mSalDepoAmtExclTot = Val(UnMyNumFmt(lblSalDepoAmtExclTot.Caption))
mSalRefuAmtTot = Val(UnMyNumFmt(lblSalRefuAmtTot.Caption))
If (mSalAdvAmtTot + mSalRecdAmtTot + mSalDepoAmtExclTot + mSpyDepoAmtTot) > mSalAmountTot Then
...
Dim srow As Integer, mSpyICode As Long, mDeleteit As Boolean
srow = Mfgrd2.Row
mSpyICode = Val(Mfgrd2.TextMatrix(srow, X2SPYICODE_COL))

If MyDeleteKey(Shift, KeyCode, mCheckCtrlMask:=False) = True And mSpyICode > 0 Then
    mDeleteit = True
    If mDeleteit = True Then
        mDeleteit = CanDelete()
    End If
    If mDeleteit = True Then
        clsSPY.DeleteDtl mSpyCode, mSpyICode
        
        ShowDtlData mSpyCode
        Mfgrd2.Row = srow
        Mfgrd2.SetFocus
...
If KeyAscii = vbKeyReturn Then
    ...
    If dtlAddMode = True Then
        mskSpySno.Text = ToMyNumFmt(FlexNextSeqno(Mfgrd2, X2SPYSNO_COL), mDecimals:=0)
        mskSalVchNo.Text = "": fcmbSalVchNo.BoundText = ""
    Else
        With Mfgrd2
        mskSpySno.Text = .TextMatrix(srow, X2SPYSNO_COL)
        fcmbSalVchNo.BoundText = .TextMatrix(srow, X2SALCODE_COL): mskSalVchNo.Text = ToMyNumFmt(Val(fcmbSalVchNo.Text), mDecimals:=0)
        txtSalVtmName.Text = .TextMatrix(srow, X2SALVTMNAME_COL)
        dtpSalDate.Text = .TextMatrix(srow, X2SALDATE_COL)
        mskSalAmount.Text = .TextMatrix(srow, X2SALAMOUNT_COL)
        mskSalAdvAmt.Text = .TextMatrix(srow, X2SALADVAMT_COL)
        mskSalRecdAmt.Text = .TextMatrix(srow, X2SALRECDAMT_COL)
        mskSalDepoAmtExcl.Text = .TextMatrix(srow, X2SALDEPOAMTEXCL_COL)
        mskSpyDepoAmt.Text = .TextMatrix(srow, X2SPYDEPOAMT_COL)
        mskSalRefuAmt.Text = .TextMatrix(srow, X2SALREFUAMT_COL)
        mskSalBalAmt.Text = .TextMatrix(srow, X2SALBALAMT_COL)
        End With
    End If
    mskSalVchNo.SetFocus
    Call ValidDtl
    
    mSalCode_old = Val(fcmbSalVchNo.BoundText)
    mSpyDepoAmt_old = Val(UnMyNumFmt(mskSpyDepoAmt.Text))
End If
...
Private Sub mskSpyDepoAmt_GotFocus()
FlashActiveControl mskSpyDepoAmt, True
End Sub

Private Sub mskSpyDepoAmt_LostFocus()
FlashActiveControl mskSpyDepoAmt, False
End Sub

Private Sub mskSpyDepoAmt_Validate(Cancel As Boolean)
If chkSpyDepoAmt() = False Then
    mskSpyDepoAmt.SetFocus
    Cancel = True
Else
    Call ValidDtl
End If
...
Private Function chkSpyDepoAmt() As Boolean
Dim mRtnval As Boolean
Dim mSalAmount As Double, mSalAdvAmt As Double, mSalRecdAmt As Double, mSalDepoAmtExcl As Double, mSpyDepoAmt As Double, mSalRefuAmt As Double, mSalBalAmt As Double

mRtnval = True
mSalAmount = Val(UnMyNumFmt(mskSalAmount.Text))
mSalAdvAmt = Val(UnMyNumFmt(mskSalAdvAmt.Text))
mSalRecdAmt = Val(UnMyNumFmt(mskSalRecdAmt.Text))
mSalDepoAmtExcl = Val(UnMyNumFmt(mskSalDepoAmtExcl.Text))
mSpyDepoAmt = Val(UnMyNumFmt(mskSpyDepoAmt.Text))
mSalRefuAmt = Val(UnMyNumFmt(mskSalRefuAmt.Text))

mskSpyDepoAmt.Text = ToMyNumFmt(mSpyDepoAmt)
If mSpyDepoAmt < 1 Then
    If InterActiveChange(mskSpyDepoAmt) = True Then
        ErrorBox "Invalid Input !!!"
    End If
    mRtnval = False
Else
    If (mSalAdvAmt + mSalRecdAmt + mSalDepoAmtExcl + mSpyDepoAmt) > mSalAmount Then
        If InterActiveChange(mskSpyDepoAmt) = True Then
            ErrorBox "Excess Amount Deposited !!!"
            mskSpyDepoAmt.Text = ToMyNumFmt(mSalAmount - (mSalAdvAmt + mSalRecdAmt + mSalDepoAmtExcl))
            mSpyDepoAmt = Val(UnMyNumFmt(mskSpyDepoAmt.Text))
        End If
        mRtnval = False
    ElseIf mSalRefuAmt > (mSalAdvAmt + mSalRecdAmt + mSalDepoAmtExcl + mSpyDepoAmt) Then
        If InterActiveChange(mskSpyDepoAmt) = True Then
    ...
    End If
End If
mskSalBalAmt.Text = ToMyNumFmt(mSalAmount - (mSalAdvAmt + mSalRecdAmt + mSalDepoAmtExcl + mSpyDepoAmt))

chkSpyDepoAmt = mRtnval
...
''Dim mSalRecdAmtTot As Double, mSalDepoAmtTot As Double, mSalAmountTot As Double
''
...
''    Cancel = True
''Else
''    If (mSalRecdAmtTot + mSalDepoAmtTot) > mSalAmountTot Then
''        ErrorBox "Excess Received Amount !!!"
''        mSalRecdAmtTot = mSalAmountTot - mSalDepoAmtTot
''        mskSalRecdAmtTot.Text = ToMyNumFmt(mSalRecdAmtTot)
''        mskSalRecdAmtTot.SetFocus
''        Cancel = True
''    Else
''        If FormAddEditMode = cFORM_ADDMODE Or mSalRecdAmtTot <> mSalRecdAmtTot_old Then
''            DisperseRecdAmt mSpyCode
''            ShowDtlData mSpyCode
''        End If
''
''    End If
...
Private Sub mskSpyVchNo_GotFocus(Index As Integer)
FlashActiveControl mskSpyVchNo(Index), True
End Sub

Private Sub mskSpyVchNo_LostFocus(Index As Integer)
FlashActiveControl mskSpyVchNo(Index), False
End Sub

Private Sub mskSpyVchNo_Validate(Index As Integer, Cancel As Boolean)
Dim mSpyVchNo As Long

mSpyVchNo = Val(UnMyNumFmt(mskSpyVchNo(Index).Text))
If mSpyVchNo < 0 And Index = 0 Then
    mSpyVchNo = GetNextVTypeNo(dbVgnDatabase, dbAcDatabase, dbComDatabase, mTableName:="MedSalePymtHdr", mFieldName:="SphVchNo", mVtmFieldName:="SphVtmCode", mVtmFieldValue:=Val(fcmbSpyVtmName.BoundText), mFinYrFieldName:="SphCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="SphDate", mDateFieldValue:=Ctod(dtpSpyDate.Text), mModuleCode:=mFormUIdCode, mModuleName:=Me.Name, mAcsPermFileName:=mFormAcsPermFileName)
    mskSpyVchNo(Index).Text = ToMyNumFmt(mSpyVchNo, mDecimals:=0)
ElseIf mSpyVchNo > 0 And Index = 0 Then
    If mSpyVchNo <> mSpyVchNo_old Or Val(fcmbSpyVtmName.BoundText) <> mSpyVtmCode_old Or Ctod(dtpSpyDate.Text) <> mSpyDate_old Or FormAddEditMode = cFORM_ADDMODE Then
        If ChkIsDuplVTypeNo(dbVgnDatabase, dbAcDatabase, mTableName:="MedSalePymtHdr", mChkFieldName:="SphVchNo", mChkFieldValue:=mSpyVchNo, mKeyFieldName:="SphCode", mKeyFieldValue:=mSpyCode, mVtmFieldName:="SphVtmCode", mVtmFieldValue:=Val(fcmbSpyVtmName.BoundText), mFinYrFieldName:="SphCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="SphDate", mDateFieldValue:=Ctod(dtpSpyDate.Text)) = True Then
            ErrorBox "Duplicate Voucher No. !!!"
            Cancel = True
            mskSpyVchNo(Index).SetFocus
            ' ----------
...
Private Sub mskSalVchNo_KeyDown(KeyCode As Integer, Shift As Integer)
If MyDropDownKey(Shift, KeyCode) = True Then
    Call mskSalVchNo_Change
End If
...
Private Sub txtSphRemark_GotFocus()
FlashActiveControl txtSphRemark, True
End Sub

Private Sub txtSphRemark_LostFocus()
FlashActiveControl txtSphRemark, False
End Sub

Private Sub txtSphRemark_Validate(Cancel As Boolean)
txtSphRemark.Text = ToMyWord(txtSphRemark.Text)
End Sub
...
Private Sub txtSpyTime_str_GotFocus()
FlashActiveControl txtSpyTime_str, True
End Sub

Private Sub txtSpyTime_str_LostFocus()
FlashActiveControl txtSpyTime_str, False
End Sub

Private Sub txtSpyTime_str_Validate(Cancel As Boolean)
txtSpyTime_str.Text = MinToTime(TimeToMin(txtSpyTime_str.Text))
If TimeToMin(txtSpyTime_str.Text) > cDAYMINUTES Then
    ErrorBox "Invalid Input !!!"
    txtSpyTime_str.SetFocus
    Cancel = True
...
Private Sub txtSpyVtmName_Change(Index As Integer)
If fcmbSpyVtmName.CallFromText_Change = False Then
    fcmbSpyVtmName.CallFromText_Change = True
    If InterActiveChange(txtSpyVtmName(Index)) = True Then
        fcmbSpyVtmName.UserText = Array(txtSpyVtmName(Index).Text, txtSpyVtmName(Index).SelStart)
        fcmbSpyVtmName.Show
        txtSpyVtmName(Index).Text = fcmbSpyVtmName.Text
        If fcmbSpyVtmName.ListSelected = True Then
            SendKeys "{tab}"
        End If
    End If
    fcmbSpyVtmName.CallFromText_Change = False
End If

End Sub

Private Sub txtSpyVtmName_GotFocus(Index As Integer)
FlashActiveControl txtSpyVtmName(Index), True
End Sub

Private Sub txtSpyVtmName_KeyDown(Index As Integer, KeyCode As Integer, Shift As Integer)
If MyDropDownKey(Shift, KeyCode) = True Then
    Call txtSpyVtmName_Change(Index)
ElseIf MyAddNewKey(Shift, KeyCode) = True Then
...
Private Sub txtSpyVtmName_LostFocus(Index As Integer)
FlashActiveControl txtSpyVtmName(Index), False
End Sub

Private Sub txtSpyVtmName_Validate(Index As Integer, Cancel As Boolean)
Dim mSpyVchNo As Long

If Val(fcmbSpyVtmName.BoundText) < 1 Then
    ErrorBox "Invalid Selection !!!"
    txtSpyVtmName(Index).SetFocus
    Cancel = True
ElseIf Index = 0 Then
    If Val(fcmbSpyVtmName.BoundText) <> mSpyVtmCode_old Or Ctod(dtpSpyDate.Text) <> mSpyDate_old Or FormAddEditMode = cFORM_ADDMODE Then
        mSpyVchNo = GetNextVTypeNo(dbVgnDatabase, dbAcDatabase, dbComDatabase, mTableName:="MedSalePymtHdr", mFieldName:="SphVchNo", mVtmFieldName:="SphVtmCode", mVtmFieldValue:=Val(fcmbSpyVtmName.BoundText), mFinYrFieldName:="SphCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="SphDate", mDateFieldValue:=Ctod(dtpSpyDate.Text), mModuleCode:=mFormUIdCode, mModuleName:=Me.Name, mAcsPermFileName:=mFormAcsPermFileName)
        mskSpyVchNo(Index).Text = ToMyNumFmt(mSpyVchNo, mDecimals:=0)
    End If
End If
...
If CanUserAddOpt(mUsrCode:=MyCompany.mUserCode, mMenuOptName:=Me.SecuMenuName) = False Then
    ...
    Exit Sub
End If
If clsSPY.BeginTran(0) = False Then
    Exit Sub
End If
mEntrySaved = False: mEntryAborted = False
FormAddEditMode = cFORM_ADDMODE

clsSPY.ClearHdr: clsSPY.ClearDtl
clsOPG.Clear
clsPAT.Clear

mSpyCode = clsSPY.ActiveTrnCode
Rem mSpyOpgCode = 0
mSpyPttCode = 0

ShowSpyData mSpyCode
Rem ShowOpgData mSpyOpgCode
ShowPatData mSpyPttCode

Rem restoring user editing features
Call ShowSpyDefData
Call ShowPatDefData
Rem Call ShowOpgDefData

Rem old values
Call StoreSpyOldData
...
If CanUserEditOpt(mUsrCode:=MyCompany.mUserCode, mMenuOptName:=Me.SecuMenuName) = False Then
    ...
    Exit Sub
End If
If clsSPY.BeginTran(datRecset.fields("SphCode")) = False Then
    Exit Sub
End If
mEntrySaved = False: mEntryAborted = False
...
With datRecset
mSpyCode = .fields("SphCode")
Rem mSpyOpgCode = .fields("SphOpgCode")
mSpyPttCode = .fields("SphPttCode")

clsSPY.GetHdrData mSpyCode
Rem clsOPG.GetData mSpyOpgCode
clsPAT.GetData mSpyPttCode
End With
...
Private Sub ShowSpyData(ByVal mSpyCode As Long)

With clsSPY
.GetHdrData mSpyCode

mskFormBoundField.Text = mSpyCode
fcmbSpyVtmName.BoundText = CStr(.mTrnVtmCode_lng): txtSpyVtmName(0).Text = fcmbSpyVtmName.Text
txtSpyPrefix.Text = .mTrnPrefix_str
mskSpyVchNo(0).Text = ToMyNumFmt(.mTrnVchNo_lng, mDecimals:=0)
dtpSpyDate.Text = Dtoc(.mTrnDate_dt)
txtSpyTime_str.Text = MinToTime(.mSphTime_lng)
txtSphRemark.Text = .mSphRemark_str
Rem old outdoor receipt
'mSpyOldSpyCode = .mSphOldSphCode_lng
'ShowOldSpyCodeDesc mSpyOldSpyCode
End With
...
Private Sub ShowSpyDefData()
Dim mSpyVchNo As Long

dtpSpyDate.Text = Dtoc(DefaultEntryDate)
txtSpyTime_str.Text = MinToTime(TimeToMin(DateTime.Time$))

'fcmbSpyVtmName.BoundText = CStr(clsVGNOPT.GetOutdPymtOptBoundCode("SpyVtmCode")): txtSpyVtmName(0).Text = fcmbSpyVtmName.Text
fcmbSpyVtmName.BoundText = GetLastValueFromTableCol(cnn:=dbVgnDatabase, mTableName:="MedSalePymtHdr", mColumnName:="SphVtmCode", mOrderByColName:="SphCode", mRtnDefValue:=0)
txtSpyVtmName(0).Text = fcmbSpyVtmName.Text
...
Private Sub StoreSpyOldData()
mSpyCode_old = mSpyCode
mSpyDate_old = Ctod(dtpSpyDate.Text)
mSpyVtmCode_old = Val(fcmbSpyVtmName.BoundText)
mSpyVchNo_old = Val(UnMyNumFmt(mskSpyVchNo(0).Text))

End Sub

Private Sub ShowDtlData(ByVal mSpyCode As Long)
...
With tRecset
.open "Select * from MedSalePymtDtl where SpyCode = " & CStr(mSpyCode) & " order by SpySno", dbVgnDatabase, adOpenKeyset, adLockOptimistic
If .RecordCount > 0 Then
    Do While .EOF = False
        If InList(.fields("SpyRecState"), Array(cREC_ADDED, cREC_EDITED, cREC_UNCHANGED)) = True Then
            clsSAL.GetHdrData .fields("SpySahCode")
            clsVTM.GetData clsSAL.mTrnVtmCode_lng
            ...
            srow = srow + 1
        Else
            If InList(.fields("SpyRecState"), Array(cREC_CANCELED, cREC_DELETED)) = False Then
...
End If
.mTrnDate_dt = Ctod(dtpSpyDate.Text)
.mTrnVtmCode_lng = Val(fcmbSpyVtmName.BoundText)
.mTrnPrefix_str = txtSpyPrefix.Text
.mTrnVchNo_lng = Val(UnMyNumFmt(mskSpyVchNo(0).Text))
.mTrnPostfix_str = ""
.mTrnCmpCode_int = sFinYrCmpCode

.mSphTime_lng = TimeToMin(txtSpyTime_str.Text)
Rem .mSphOpgCode_lng = mSpyOpgCode
.mSphPttCode_lng = mSpyPttCode
'.mSphOldSphCode_lng = mSpyOldSpyCode
.mSphDepoAmt_dbl = Val(UnMyNumFmt(lblSpyDepoAmtTot.Caption))
.mSphRemark_str = txtSphRemark.Text
...
If .mTrnCode_lng > 0 Then   ' updated successfully
    mSpyCode = .mTrnCode_lng
    
    .UpdateTran .mTrnCode_lng
    .EndTran .mTrnCode_lng
        
    Rem updating user editing carry forward features
'    clsVGNOPT.mSpyVtmCodeOld_lng = .mTrnVtmCode_lng
'    clsVGNOPT.UpdateOutdPymtOld
...
If clsSPY.mTrnCode_lng > 0 Then   ' updated successfully
...
mSpyCode = datRecset.fields("SphCode")
mSpyPttCode = datRecset.fields("SphPttCode")
mRecAbsPos = datRecset.AbsolutePosition

If clsSPY.CanDeleteTran(mSpyCode) = True Then
    txtVoid.SetFocus
    If clsSPY.BeginTran(mSpyCode) = True Then
        clsSPY.DeleteTran mSpyCode
        clsSPY.UpdateTran mSpyCode
        clsSPY.EndTran mSpyCode
...
If optMonthwise.Value = True Or optDatewise.Value = True Or optPatientwise.Value = True Then
    If optMonthwise.Value = True Then
        clsListStru.AddFields mExpr:="SpyYrMonth", mAttrib:=cFAT_SYSTEM
        clsListStru.AddFields mExpr:="SpyMnYear", mTitle:="Month", mShowItem:=True, mAlign:=1, mWidth:=2000
        clsListStru.AddFields mExpr:="SpyCount", mTitle:="Count", mShowItem:=True, mAlign:=7, mWidth:=1500
        clsListStru.AddFields mExpr:="SpyDepoAmt_sum", mTitle:="Recd.Amt", mShowItem:=True, mAlign:=7, mWidth:=1500
        
        datRecset.open "Select format(SphDate,'yyyy/MM') as SpyYrMonth" _
         & ",Count(SphCode) as SpyCount" _
         & ",Sum(SphDepoAmt) as SpyDepoAmt_sum" _
         & " from MedSalePymtHdr" _
         & " where SphDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
         & " and SphCode > 0" _
         & IIf(mQryPttCode > 0, " and SphPttCode = " & CStr(mQryPttCode), "") _
         & " group by format(SphDate,'yyyy/MM')" _
         & " order by format(SphDate,'yyyy/MM')" _
         , dbVgnDatabase, adOpenKeyset, adLockReadOnly

    ElseIf optDatewise.Value = True Then
        clsListStru.AddFields mExpr:="SpyDateYMD", mAttrib:=cFAT_SYSTEM
        clsListStru.AddFields mExpr:="SpyDate", mTitle:="Date", mShowItem:=True, mAlign:=1, mWidth:=2000
        clsListStru.AddFields mExpr:="SpyCount", mTitle:="Count", mShowItem:=True, mAlign:=7, mWidth:=1500
        clsListStru.AddFields mExpr:="SpyDepoAmt_sum", mTitle:="Recd.Amt", mShowItem:=True, mAlign:=7, mWidth:=1500
        
        datRecset.open "Select SphDate" _
         & ",Count(SphCode) as SpyCount" _
         & ",Sum(SphDepoAmt) as SpyDepoAmt_sum" _
         & " from MedSalePymtHdr" _
         & " where SphDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
    ...
    ElseIf optPatientwise.Value = True Then
        ...
        datRecset.open "Select PatMast.PttName,PatMast.PttRegNo,MedSalePymtHdr.SphPttCode" _
         & ",Count(SphCode) as SpyCount" _
         & ",Sum(SphDepoAmt) as SpyDepoAmt_sum" _
         & " from MedSalePymtHdr inner join PatMast on MedSalePymtHdr.SphPttCode = PatMast.PttCode" _
         & " where SphDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
         & " and SphCode > 0" _
         & IIf(mQryPttCode > 0, " and SphPttCode = " & CStr(mQryPttCode), "") _
         & " group by PatMast.PttName,PatMast.PttRegNo,MedSalePymtHdr.SphPttCode" _
         & " order by PatMast.PttName,PatMast.PttRegNo,MedSalePymtHdr.SphPttCode" _
         , dbComDatabase, adOpenKeyset, adLockReadOnly
    End If
    
ElseIf optDetailed.Value = True Then
    clsListStru.AddFields mExpr:="tSpySmryId", mAttrib:=cFAT_SYSTEM
    clsListStru.AddFields mExpr:="SpyCode", mAttrib:=cFAT_SYSTEM
    clsListStru.AddFields mExpr:="VtmName", mTitle:="Voucher", mAlign:=1, mWidth:=1500, mShowItem:=True
    clsListStru.AddFields mExpr:="SalVchNo", mTitle:="Vchr.No", mAlign:=7, mWidth:=1250, mShowItem:=True
    clsListStru.AddFields mExpr:="SpyDate", mTitle:="Date", mAlign:=1, mWidth:=1300, mShowItem:=True
    ' --------------------------------------
    ...
    ' --------------------------------------
    clsListStru.AddFields mExpr:="SpyDepoAmt", mTitle:="Depo.Amt", mAlign:=7, mWidth:=1250, mShowItem:=True
    ' --------------------------------------
    ...
    datRecset.open "Select MedSalePymtHdr.*,PatMast.*" _
     & ",format(SphDate,'yyyymmdd')+format(SphCode,'0000000') as tSpySmryId" _
     & " from MedSalePymtHdr inner join PatMast on MedSalePymtHdr.SphPttCode = PatMast.PttCode" _
     & " where SphDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
     & IIf(mRemoteAccess = True, " and SphCode = " & CStr(mSpyCode) & "", "") _
     & " and SphCode > 0" _
     & IIf(mQryPttCode > 0, " and SphPttCode = " & CStr(mQryPttCode), "") _
     & " order by SphDate,SphCode" _
     , dbComDatabase, adOpenKeyset, adLockReadOnly
...
If .RecordCount > 0 Then
    Do While .EOF = False
        If optMonthwise.Value = True Or optDatewise.Value = True Or optPatientwise.Value = True Then
            If optMonthwise.Value = True Then
                Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("SpyYrMonth")) = .fields("SpyYrMonth")
                Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("SpyMnYear")) = MonthName(Val(Right(.fields("SpyYrMonth"), 2))) & "-" & Left(.fields("SpyYrMonth"), 4)
                Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("SpyCount")) = ToMyNumFmt(.fields("SpyCount"), mDecimals:=0)
                Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("SpyDepoAmt_sum")) = ToMyNumFmt(.fields("SpyDepoAmt_sum"))
                
            ElseIf optDatewise.Value = True Then
                Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("SpyDateYMD")) = Format(.fields("SphDate"), "yyyymmdd")
                Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("SpyDate")) = Dtoc(.fields("SphDate"))
                Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("SpyCount")) = ToMyNumFmt(.fields("SpyCount"), mDecimals:=0)
                Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("SpyDepoAmt_sum")) = ToMyNumFmt(.fields("SpyDepoAmt_sum"))
                
            ElseIf optPatientwise.Value = True Then
                clsPAT.GetData .fields("SphPttCode")
        ...
        ElseIf optDetailed.Value = True Then
            ...
            clsVTM.GetData .fields("SphVtmCode")
            
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("tSpySmryId")) = Format(.fields("SphDate"), "yyyymmdd") & Format(.fields("SphCode"), "0000000")
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("SpyCode")) = .fields("SphCode")
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("VtmName")) = clsVTM.mName_str
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("SalVchNo")) = .fields("SphVchNo")
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("SpyDate")) = Dtoc(.fields("SphDate"))
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("SpyDepoAmt")) = ToMyNumFmt(.fields("SphDepoAmt"))
            ' ------------------------------------
...
Else    ' system field search has been requested by programmer
    If optDetailed.Value = True Then
        SearchFlex Mfgrd1, clsListStru.GetItemIndex("tSpySmryId"), mText
    ElseIf optMonthwise.Value = True Then
        SearchFlex Mfgrd1, clsListStru.GetItemIndex("SpyYrMonth"), mText
    ElseIf optDatewise.Value = True Then
        SearchFlex Mfgrd1, clsListStru.GetItemIndex("SpyDateYMD"), mText
    ElseIf optPatientwise.Value = True Then
...
Private Sub mskSalVchNo_Change()
If fcmbSalVchNo.CallFromText_Change = False Then
    fcmbSalVchNo.CallFromText_Change = True
    If InterActiveChange(mskSalVchNo) = True Then
        fcmbSalVchNo.mFiltCond = "SahPttCode = " & CStr(mSpyPttCode)
        fcmbSalVchNo.ReInit
        
        fcmbSalVchNo.UserText = Array(mskSalVchNo.Text, mskSalVchNo.SelStart)
        fcmbSalVchNo.Show
        mskSalVchNo.Text = fcmbSalVchNo.Text
        If fcmbSalVchNo.ListSelected = True Then
            SendKeys "{tab}"
        End If
    End If
    fcmbSalVchNo.CallFromText_Change = False
End If
...
If Val(fcmbSalVchNo.BoundText) <= 0 Then
    ErrorBox "Invalid Selection !!!"
    mskSalVchNo.SetFocus
    Cancel = True
Else
    If Val(fcmbSalVchNo.BoundText) <> mSalCode_old Or FormAddEditMode = cFORM_ADDMODE Then
        clsSAL.GetHdrData Val(fcmbSalVchNo.BoundText)
        clsVTM.GetData clsSAL.mTrnVtmCode_lng
        
        txtSalVtmName.Text = clsVTM.mName_str
        dtpSalDate.Text = Dtoc(clsSAL.mTrnDate_dt)
        mskSalAmount.Text = ToMyNumFmt(clsSAL.mSahAmount_dbl)
        mskSalAdvAmt.Text = ToMyNumFmt(clsSAL.mSahAdvAmt_dbl)
        mskSalRecdAmt.Text = ToMyNumFmt(clsSAL.mSahRecdAmt_dbl)
        mskSalDepoAmtExcl.Text = ToMyNumFmt(clsSAL.mSahDepoAmt_dbl - mSpyDepoAmt_old)   '''  Val(UnMyNumFmt(mskSpyDepoAmt.Text))
        If Val(UnMyNumFmt(mskSpyDepoAmt.Text)) = 0 Then
            mskSpyDepoAmt.Text = ToMyNumFmt(clsSAL.mSahBalAmt_dbl)
        End If
        mskSalRefuAmt.Text = ToMyNumFmt(clsSAL.mSahRefuAmt_dbl)
        mskSalBalAmt.Text = ToMyNumFmt(clsSAL.mSahBalAmt_dbl)
    End If
    Call ValidDtl
End If
...
'Private Sub ShowOldSpyCodeDesc(ByVal mOldOrcCode As Long)
'Dim tRecset As New ADODB.Recordset
'
'With tRecset
'.open "Select * from MedSalePymtHdr where SphCode=" & CStr(mOldOrcCode) & "", dbVgnDatabase, adOpenKeyset, adLockOptimistic
'If .RecordCount > 0 Then
'    clsVTM.GetData .fields("SphVtmCode")
'    lblOldSpyCodeDesc.Caption = RTrim(clsVTM.mName_str) & " No.:" & CStr(.fields("SphVchNo")) & " Dated:" & Dtoc(.fields("SphDate"))
'Else
'    lblOldSpyCodeDesc.Caption = "#" & CStr(mOldOrcCode) & "#"
'End If
'End With
'CloseTable tRecset
'
...
'Private Function GetOldSpyCodeFromPttCode(ByVal mPttCode As Long) As Long
'Dim tRecset As New ADODB.Recordset
'
'With tRecset
'.open "Select top 1 * from MedSalePymtHdr where SphPttCode=" & CStr(mPttCode) & " order by SphDate desc,SphVchNo desc,SphCode desc", dbVgnDatabase, adOpenKeyset, adLockOptimistic
'If .RecordCount > 0 Then
'    GetOldSpyCodeFromPttCode = .fields("SphCode")
'Else
'    GetOldSpyCodeFromPttCode = 0
'End If
'End With
'CloseTable tRecset
'
...
'                mSpyPttCode = mOldOpgPttCode
'                ShowPatData mSpyPttCode
'                Call StorePatOldData
'                'ShowPttDiscPer mSpyPttCode
'
'                Rem mSpyOpgCode = mOldOpgCode
'                Rem ShowOpgData mSpyOpgCode
'                Rem Call StoreOpgOldData
'
'                'mSpyOldSpyCode = GetOldSpyCodeFromPttCode(mSpyPttCode)
'                'ShowOldSpyCodeDesc mSpyOldSpyCode
'            End If
'        Else
...
If IsMissing(mRowPos) = False Then
    mskSpySno.Top = mRowPos
    mskSalVchNo.Top = mRowPos
    txtSalVtmName.Top = mRowPos
    dtpSalDate.Top = mRowPos
    mskSalAmount.Top = mRowPos
    mskSalAdvAmt.Top = mRowPos
    mskSalRecdAmt.Top = mRowPos
    mskSalDepoAmtExcl.Top = mRowPos
    mskSpyDepoAmt.Top = mRowPos
    mskSalRefuAmt.Top = mRowPos
    mskSalBalAmt.Top = mRowPos
    cmdOK.Top = mRowPos
End If

mskSpySno.Text = 0
mskSalVchNo.Text = 0: fcmbSalVchNo.BoundText = ""
txtSalVtmName.Text = ""
dtpSalDate.Text = ""
mskSalAmount.Text = ToMyNumFmt(0)
mskSalAdvAmt.Text = ToMyNumFmt(0)
mskSalRecdAmt.Text = ToMyNumFmt(0)
mskSalDepoAmtExcl.Text = ToMyNumFmt(0)
mskSpyDepoAmt.Text = ToMyNumFmt(0)
mskSalRefuAmt.Text = ToMyNumFmt(0)
mskSalBalAmt.Text = ToMyNumFmt(0)

Call ValidDtl

mskSpySno.Visible = mShowItem
mskSalVchNo.Visible = mShowItem
txtSalVtmName.Visible = mShowItem
dtpSalDate.Visible = mShowItem
mskSalAmount.Visible = mShowItem
mskSalAdvAmt.Visible = mShowItem
mskSalRecdAmt.Visible = mShowItem
mskSalDepoAmtExcl.Visible = mShowItem
mskSpyDepoAmt.Visible = mShowItem
mskSalRefuAmt.Visible = mShowItem
mskSalBalAmt.Visible = mShowItem
...
mDataOk = (mSpyPttCode > 0 And Val(UnMyNumFmt(mskSpySno.Text)) > 0 And Val(fcmbSalVchNo.BoundText) > 0 And Val(UnMyNumFmt(mskSpyDepoAmt.Text)) > 0 And chkSpyDepoAmt() = True)
cmdOK.Caption = IIf(mDataOk = True, "&OK", "&Cancel")
cmdOK.BackColor = IIf(mDataOk = True, &H80FF80, &H8080FF)
End Sub

Private Sub CalcFtrTotal()
Dim mSalAmountTot As Double, mSalAdvAmtTot As Double, mSalRecdAmtTot As Double, mSalDepoAmtExclTot As Double, mSpyDepoAmtTot As Double, mSalRefuAmtTot As Double, mSalBalAmtTot As Double

mSalAmountTot = FlexColSum(Mfgrd2, X2SALAMOUNT_COL)
mSalAdvAmtTot = FlexColSum(Mfgrd2, X2SALADVAMT_COL)
mSalRecdAmtTot = FlexColSum(Mfgrd2, X2SALRECDAMT_COL)
mSalDepoAmtExclTot = FlexColSum(Mfgrd2, X2SALDEPOAMTEXCL_COL)
mSpyDepoAmtTot = FlexColSum(Mfgrd2, X2SPYDEPOAMT_COL)
mSalRefuAmtTot = FlexColSum(Mfgrd2, X2SALREFUAMT_COL)
mSalBalAmtTot = FlexColSum(Mfgrd2, X2SALBALAMT_COL)

lblSalAmtAftDiscTot.Caption = ToMyNumFmt(mSalAmountTot)
lblSalAdvAmtTot.Caption = ToMyNumFmt(mSalAdvAmtTot)
lblSalRecdAmtTot.Caption = ToMyNumFmt(mSalRecdAmtTot)
lblSalDepoAmtExclTot.Caption = ToMyNumFmt(mSalDepoAmtExclTot)
lblSpyDepoAmtTot.Caption = ToMyNumFmt(mSpyDepoAmtTot)
lblSalRefuAmtTot.Caption = ToMyNumFmt(mSalRefuAmtTot)
lblSalBalAmtTot.Caption = ToMyNumFmt(mSalBalAmtTot)
...
If Val(fcmbSpyVtmName.BoundText) < 1 Then
    ...
    txtSpyVtmName(1).SetFocus
    Exit Sub
End If
If Val(UnMyNumFmt(mskSpyVchNo(1).Text)) < 1 Then
    ErrorBox "Invalid Voucher No. !!!"
    mskSpyVchNo(1).SetFocus
    Exit Sub
Else
    mSpyVchNo = Val(UnMyNumFmt(mskSpyVchNo(1).Text))
    If ChkIsExistVTypeNo(dbVgnDatabase, mTableName:="MedSalePymtHdr", mChkFieldName:="SphVchNo", mChkFieldValue:=CStr(mSpyVchNo), mVtmFieldName:="SphVtmCode", mVtmFieldValue:=Val(fcmbSpyVtmName.BoundText), mFinYrFieldName:="SphCmpCode", mFinYrFieldValue:=sFinYrCmpCode) = False Then
        ErrorBox "Voucher No. does not Exist !!!"
        mskSpyVchNo(1).SetFocus
        Exit Sub
    End If
End If
If Val(UnMyNumFmt(mskSpyVchNo(2).Text)) < 1 Then
    ErrorBox "Invalid Voucher No. !!!"
    mskSpyVchNo(2).SetFocus
    Exit Sub
Else
    mSpyVchNo = Val(UnMyNumFmt(mskSpyVchNo(2).Text))
    If ChkIsExistVTypeNo(dbVgnDatabase, mTableName:="MedSalePymtHdr", mChkFieldName:="SphVchNo", mChkFieldValue:=CStr(mSpyVchNo), mVtmFieldName:="SphVtmCode", mVtmFieldValue:=Val(fcmbSpyVtmName.BoundText), mFinYrFieldName:="SphCmpCode", mFinYrFieldValue:=sFinYrCmpCode) = False Then
        ErrorBox "Voucher No. does not Exist !!!"
        mskSpyVchNo(2).SetFocus
        Exit Sub
...
Dim mFromSpyVchNo As Long, mToSpyVchNo As Long, mSpyVtmCode As Long
Dim fCRView As Form

mFromSpyVchNo = Val(UnMyNumFmt(mskSpyVchNo(1).Text))
mToSpyVchNo = Val(UnMyNumFmt(mskSpyVchNo(2).Text))
mSpyVtmCode = Val(fcmbSpyVtmName.BoundText)
...
frmMain.Cryst.SelectionFormula = "{vewMedSalePymt.SphVchNo}>=" & CStr(mFromSpyVchNo) & " and {vewMedSalePymt.SphVchNo}<=" & CStr(mToSpyVchNo) & " and {vewMedSalePymt.SphVtmCode}=" & CStr(mSpyVtmCode) & " and {vewMedSalePymt.SphCmpCode}=" & CStr(sFinYrCmpCode)
...
If mCallSource = "Keydown" Then
    If Mfgrd1.Row < Mfgrd1.Rows - 1 And optDetailed.Value = True And datRecset.BOF = False And datRecset.EOF = False Then
        fcmbSpyVtmName.BoundText = CStr(datRecset.fields("SphVtmCode"))
        txtSpyVtmName(1).Text = fcmbSpyVtmName.Text
        mskSpyVchNo(1).Text = datRecset.fields("SphVchNo")
        mskSpyVchNo(2).Text = datRecset.fields("SphVchNo")
        ' ----------------
...
ElseIf mCallSource = "SaveEvent" Then
    txtSpyVtmName(1).Text = fcmbSpyVtmName.Text
    mskSpyVchNo(1).Text = CStr(Val(UnMyNumFmt(mskSpyVchNo(0).Text)))
    mskSpyVchNo(2).Text = CStr(Val(UnMyNumFmt(mskSpyVchNo(0).Text)))
    ' ----------------
    Call AssignPrintPara
    frPrintCRList.ZOrder
    frPrintCRList.Visible = True
...
If Dir(VgnSalePymtCRLFileFullPath) = "" Then
    fhand = FreeFile
    Open VgnSalePymtCRLFileFullPath For Output As #fhand
    Write #fhand, "Store Sale Payment", "VSalPymt.Rpt", True
    Close #fhand
End If

cmbCRList.Clear
fhand = FreeFile
Open VgnSalePymtCRLFileFullPath For Input As #fhand
Do While EOF(fhand) = False
    Input #fhand, mCRLTitle, mCRLFileName, mCRLDefault
    If Dir(VgnSalePymtCRLFileFullPath(mFileName:=mCRLFileName)) <> "" Then
        cmbCRList.AddItem mCRLTitle & Space(100) & VgnSalePymtCRLFileFullPath(mFileName:=mCRLFileName)
