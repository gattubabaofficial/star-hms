...
Begin VB.Form frmSubItemMast 
   ...
   Begin VB.Frame frFormDtl 
      ...
      Begin VB.TextBox txtSimDesc 
         ...
         Width           =   5295
      End
      Begin VB.TextBox mskSimItmCode123 
         BackColor       =   &H80000003&
         BeginProperty DataFormat 
            Type            =   1
            Format          =   "0"
...
Dim dbGtdDatabase As New ADODB.Connection, dbStDatabase As New ADODB.Connection, dbGrpDatabase As New ADODB.Connection, dbComDatabase As New ADODB.Connection, datRecset As New ADODB.Recordset
Dim mSimName_old As String, mSimMRPRate_old As Double
Dim clsSIM As clsGtdMasterEntry, clsSIG As clsGtdMasterEntry, clsIT As clsProduct, mActiveControl As Object, clsListStru As clsSelectQueryStructure
Dim fcmbSigName As clsGtdFlexSearch, fcmbItmName As clsComFlexSearch
...
Set fcmbSigName = New clsGtdFlexSearch
Set fcmbSigName.dbGtdDatabase = dbGtdDatabase
...
If txtSimName.Text <> mSimName_old Then
    If ChkIsDuplicate(dbGtdDatabase, "SubItmMast", "SimName", txtSimName.Text, "SimCode", Val(mskFormBoundField.Text)) = True Then
