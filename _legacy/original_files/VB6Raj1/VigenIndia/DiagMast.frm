...
Dim mDigCode As Long
Dim mRemoteAccess As Boolean, mEntrySaved As Boolean, mEntryAborted As Boolean
Dim dbVgnDatabase As New ADODB.Connection
Dim datRecset As New ADODB.Recordset
Dim mDigName_old As String
Dim clsDIG As clsVgnMasterEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
...
If mRemoteAccess = True Then
    datRecset.open "Select * from DiagMast where DigCode=" & CStr(mDigCode) & " order by DigName", dbVgnDatabase, adOpenKeyset, adLockOptimistic
Else
    datRecset.open "Select * from DiagMast order by DigName", dbVgnDatabase, adOpenKeyset, adLockOptimistic
End If
Call SmryList
...
If txtDigName.Text <> mDigName_old Then
    If ChkIsDuplicate(dbVgnDatabase, "DiagMast", "DigName", txtDigName.Text, "DigCode", Val(mskFormBoundField.Text)) = True Then
