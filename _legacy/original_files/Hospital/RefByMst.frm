...
Dim clsAH As clsAccountHead, clsRBY As clsHmsMasterEntry, clsRFG As clsHmsMasterEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
...
If txtRByName.Text <> mRByName_old Then
    If ChkIsDuplicate(dbHmsDatabase, "RefByMast", "RByName", txtRByName.Text, "RByCode", Val(mskFormBoundField.Text)) = True Then
...
fcmbAhName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbHmsDatabase, mTableName:="RefByMast", mColumnName:="RByAhCode", mOrderByColName:="RByCode", mRtnDefValue:=0))
txtAhName.Text = fcmbAhName.Text
