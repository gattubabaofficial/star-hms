...
Dim dbMdsDatabase As New ADODB.Connection, dbHmsDatabase As New ADODB.Connection, datRecset As New ADODB.Recordset
Dim mPgmName_old As String
Dim clsPGM As clsHmsMasterEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
...
Set clsPGM = New clsHmsMasterEntry
Set clsPGM.dbHmsDatabase = dbHmsDatabase
...
If txtPgmName.Text <> mPgmName_old Then
    If ChkIsDuplicate(dbHmsDatabase, "PartyGrpMst", "PgmName", txtPgmName.Text, "PgmCode", Val(mskFormBoundField.Text)) = True Then
