...
Begin VB.Form frmPartyMast 
   ...
   Begin VB.ComboBox cmbFormEntryMode 
      ...
      Enabled         =   0   'False
      Height          =   315
      ItemData        =   "PartyMst.frx":0000
      Left            =   0
      List            =   "PartyMst.frx":000D
...
Dim dbAcDatabase As New ADODB.Connection, dbMdsDatabase As New ADODB.Connection, dbMdsDatabase As New ADODB.Connection, dbGrpDatabase As New ADODB.Connection, dbComDatabase As New ADODB.Connection
Dim datRecset As New ADODB.Recordset
Dim mMptCode_old As Long, mMptName_old As String, mMptAhCode_old As Long, mMptAraCode_old As Long
Dim clsAH As clsAccountHead, clsMPT As clsMdsMasterEntry, clsARA As clsComMastEntry, clsSTN As clsComMastEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
Dim fcmbAhName As clsComFlexSearch, fcmbAraName As clsComFlexSearch, fcmbStnName As clsComFlexSearch
Dim fcmbMpgName As clsMdsFlexSearch
...
Set clsMPT = New clsMdsMasterEntry
Set clsMPT.dbAcDatabase = dbAcDatabase
Set clsMPT.dbMdsDatabase = dbMdsDatabase
...
Set fcmbMpgName = New clsMdsFlexSearch
Set fcmbMpgName.dbMdsDatabase = dbMdsDatabase
...
fcmbAhName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbMdsDatabase, mTableName:="MedPrtMast", mColumnName:="MptAhCode", mOrderByColName:="MptCode", mRtnDefValue:=0))
txtAhName.Text = fcmbAhName.Text
fcmbMpgName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbMdsDatabase, mTableName:="MedPrtMast", mColumnName:="MptMpgCode", mOrderByColName:="MptCode", mRtnDefValue:=0))
txtMpgName.Text = fcmbMpgName.Text
