...
Dim clsAH As clsAccountHead, clsPRT As clsNcbMasterEntry, clsARA As clsComMastEntry, clsSTN As clsComMastEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
Dim fcmbAhName As clsComFlexSearch, fcmbAraName As clsComFlexSearch, fcmbStnName As clsComFlexSearch
Dim fcmbPgmName As clsNcbFlexSearch
...
fcmbAhName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbNcbDatabase, mTableName:="PartyMast", mColumnName:="PrtAhCode", mRtnDefValue:=0))
txtAhName.Text = fcmbAhName.Text
fcmbPgmName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbNcbDatabase, mTableName:="PartyMast", mColumnName:="PrtPgmCode", mRtnDefValue:=0))
txtPgmName.Text = fcmbPgmName.Text
