...
If FormAddEditMode = cFORM_ADDMODE Then
    ...
    CreateNcbCmpDatabase mAddMode:=True, FormProgStatus:=MyProgStatForm
    CreateNcbMastDatabase mAddMode:=True, FormProgStatus:=MyProgStatForm
    CreateNcbTranDatabase mAddMode:=False, FormProgStatus:=MyProgStatForm    ' already created just above
