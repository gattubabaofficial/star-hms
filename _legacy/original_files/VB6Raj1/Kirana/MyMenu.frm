...
Dim cmdComMaster As Object, cmdPyrMaster As Object, cmdPartyMast As Object, cmdSubItemMast As Object, cmdSubItemGrpMast As Object, cmdPackMast As Object, cmdOpnStock As Object
...
Dim cmdWslSaleEntry As Object, cmdSwlSaleEntry As Object, cmdRtlSaleEntry As Object, cmdPurchEntry As Object, cmdSaleRetEntry As Object, cmdPurchRetEntry As Object, cmdJournalEntry As Object, cmdStockJrnEntry As Object
...
Case cmdCheckDataStru
    ...
    CreateKgtCmpDatabase mAddMode:=False, FormProgStatus:=MyProgStatForm
    CreateKgtMastDatabase mAddMode:=False, FormProgStatus:=MyProgStatForm
    CreateKgtTranDatabase mAddMode:=False, FormProgStatus:=MyProgStatForm
    CreateKgtComDatabase FormProgStatus:=MyProgStatForm
...
Select Case Screen.ActiveControl
Case cmdWslSaleEntry
    Set MyForm = New frmSalesInv
    Load MyForm
    MyForm.FormSysVchType = cKGT_VTYPE_WSLSALES
    Call MyForm.Form_Load
    MyForm.Show 1
    
Case cmdSwlSaleEntry
    Set MyForm = New frmSalesInv
    Load MyForm
    MyForm.FormSysVchType = cKGT_VTYPE_SWLSALES
    Call MyForm.Form_Load
    MyForm.Show 1
    
Case cmdRtlSaleEntry
    Set MyForm = New frmSalesInv
    Load MyForm
    MyForm.FormSysVchType = cKGT_VTYPE_RTLSALES
    Call MyForm.Form_Load
    MyForm.Show 1
...
Set cmdPackMast = cmdMasterMenu(3): cmdPackMast.Caption = "&Packing Master"
Set cmdOpnStock = cmdMasterMenu(4): cmdOpnStock.Caption = "&Opening Stock"
...
Set cmdWslSaleEntry = cmdTransactionMenu(0): cmdWslSaleEntry.Caption = "&Whole Sale Entry"
Set cmdSwlSaleEntry = cmdTransactionMenu(1): cmdSwlSaleEntry.Caption = "&Semi-Whole Sale Entry"
Set cmdRtlSaleEntry = cmdTransactionMenu(2): cmdRtlSaleEntry.Caption = "&Retail Sale Entry"
Set cmdPurchEntry = cmdTransactionMenu(3): cmdPurchEntry.Caption = "&Purchase Entry"
Set cmdSaleRetEntry = cmdTransactionMenu(4): cmdSaleRetEntry.Caption = "Sales &Return"
Set cmdPurchRetEntry = cmdTransactionMenu(5): cmdPurchRetEntry.Caption = "Purchase Ret&urn"
Set cmdJournalEntry = cmdTransactionMenu(6): cmdJournalEntry.Caption = "&Journal Entry"
Set cmdStockJrnEntry = cmdTransactionMenu(7): cmdStockJrnEntry.Caption = "&Stock Journal"
...
Set cmdComMaster = Nothing: Set cmdPyrMaster = Nothing: Set cmdPartyMast = Nothing: Set cmdSubItemMast = Nothing: Set cmdSubItemGrpMast = Nothing: Set cmdPackMast = Nothing: Set cmdOpnStock = Nothing
...
Set cmdWslSaleEntry = Nothing: Set cmdSwlSaleEntry = Nothing: Set cmdRtlSaleEntry = Nothing: Set cmdPurchEntry = Nothing: Set cmdSaleRetEntry = Nothing: Set cmdPurchRetEntry = Nothing: Set cmdJournalEntry = Nothing: Set cmdStockJrnEntry = Nothing
