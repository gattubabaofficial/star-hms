Attribute VB_Name = "BdkLibrary"

Option Explicit

Public sBdkDatabaseName As String
...
Public Const cBDK_VTYPE_BLOODDONATE = 101
Public Const cBDK_VTYPE_BLOODISSUED = 102
Public Const cBDK_VTYPE_BLOODFILTER = 103
Public Const cBDK_VTYPE_BLOODCONS = 104
Public Const cBDK_VTYPE_BLDISU_RCPT = 105
Public Const cBDK_VTYPE_BLDISU_PYMT = 106
Public Const cBDK_VTYPE_BLDISU_REFD = 107
''Public Const cBDK_VTYPE_OUTDOOR_BILL = 105
''Public Const cBDK_VTYPE_OUTDOOR_BLPYMT = 106
''Public Const cBDK_VTYPE_OUTDOOR_BLREFD = 107
''Public Const cBDK_VTYPE_OUTDOOR_RGPYMT = 108
''Public Const cBDK_VTYPE_OUTDOOR_RGREFD = 109
''Public Const cBDK_VTYPE_INDOOR_REG = 110
''Public Const cBDK_VTYPE_INDOOR_RCPT = 111
''Public Const cBDK_VTYPE_INDOOR_PYMT = 112
''Public Const cBDK_VTYPE_INDOOR_REFD = 113
''Public Const cBDK_VTYPE_INDOOR_BILL = 114
''Public Const cBDK_VTYPE_INDOOR_BLPYMT = 115
''Public Const cBDK_VTYPE_INDOOR_BLREFD = 116
''Public Const cBDK_VTYPE_INDOOR_RGPYMT = 117
''Public Const cBDK_VTYPE_INDOOR_RGREFD = 118
''Public Const cBDK_VTYPE_LAB = 119
''Public Const cBDK_VTYPE_GENERAL = 120

Rem Crystal Report List file names
Rem outdoor files
Public Const cBLOODINNOTE_CRLFILENAME = "BldInNt.Crl"
Public Const cBLOODOUTNOTE_CRLFILENAME = "BldOutNt.Crl"
Public Const cBLOODISURCPT_CRLFILENAME = "BldIsuRc.Crl"
Public Const cBLOODBLDISUPYMTIN_CRLFILENAME = "BldPyIn.Crl"
Public Const cBLOODBLDISUPYMTOUT_CRLFILENAME = "BldPyOut.Crl"
Rem indoor files
...
Public Sub InitBdkVar()
'Dim clsHOPT As New clsBdkOpdOptionsEntry
' --------------------------------------
sBdkDatabaseName = "BloodBnk.Mdb"
...
' ------------------------
clsVType.AddType cBDK_VTYPE_BLOODDONATE, "Blood Donate (In)"
clsVType.AddType cBDK_VTYPE_BLOODISSUED, "Blood Issued (Out)"
clsVType.AddType cBDK_VTYPE_BLOODFILTER, "Blood Filter (In)"
clsVType.AddType cBDK_VTYPE_BLOODCONS, "Blood Consumption (Out)"
clsVType.AddType cBDK_VTYPE_BLDISU_RCPT, "Blood Issue Receipt"
clsVType.AddType cBDK_VTYPE_BLDISU_PYMT, "Blood Issue Payment Receipt"
clsVType.AddType cBDK_VTYPE_BLDISU_REFD, "Blood Issue Refund Receipt"
''clsVType.AddType cBDK_VTYPE_OUTDOOR_BILL, "Outdoor Bill"
''clsVType.AddType cBDK_VTYPE_OUTDOOR_BLPYMT, "Outdoor Bill Payment"
''clsVType.AddType cBDK_VTYPE_OUTDOOR_BLREFD, "Outdoor Bill Refund"
Rem clsVType.AddType cBDK_VTYPE_OUTDOOR_RGPYMT, "Outdoor Reg. Payment"
Rem clsVType.AddType cBDK_VTYPE_OUTDOOR_RGREFD, "Outdoor Reg. Refund"
' ------------------------------------------
''clsVType.AddType cBDK_VTYPE_INDOOR_REG, "Indoor Registration"
''clsVType.AddType cBDK_VTYPE_INDOOR_RCPT, "Indoor Receipt"
''clsVType.AddType cBDK_VTYPE_INDOOR_PYMT, "Indoor Payment"
''clsVType.AddType cBDK_VTYPE_INDOOR_REFD, "Indoor Refund"
''clsVType.AddType cBDK_VTYPE_INDOOR_BILL, "Indoor Bill"
''clsVType.AddType cBDK_VTYPE_INDOOR_BLPYMT, "Indoor Bill Payment"
''clsVType.AddType cBDK_VTYPE_INDOOR_BLREFD, "Indoor Bill Refund"
''clsVType.AddType cBDK_VTYPE_INDOOR_RGPYMT, "Indoor On A/c.Payment"
''clsVType.AddType cBDK_VTYPE_INDOOR_RGREFD, "Indoor On A/c.Refund"
''' --------------------------------------------
''clsVType.AddType cBDK_VTYPE_LAB, "Lab"
''clsVType.AddType cBDK_VTYPE_GENERAL, "General"
...
Public Sub RemoveBdkNullValue(Optional ByRef FormProgStatus As frmProgressStatus)
Dim dbBdkDatabase As New ADODB.Connection, dbBdkCatalog As New ADOX.Catalog
...
If Not FormProgStatus Is Nothing Then
    If FormProgStatus.Visible = True Then
        FormProgStatus.pbar1.Min = 0: FormProgStatus.pbar1.Max = dbBdkCatalog.Tables.count
    End If
End If

dbBdkDatabase.BeginTrans
For Each mTable In dbBdkCatalog.Tables
    If mTable.Type = "TABLE" Then
        If Not FormProgStatus Is Nothing Then
            If FormProgStatus.Visible = True Then
                FormProgStatus.ShowNextStatus dbBdkCatalog.ActiveConnection.Properties("Data Source Name") & vbCrLf & "Table: " & mTable.Name
            End If
        End If
        
        mTableName = mTable.Name
        With tRecset
        .open "Select * from " & mTableName & "", dbBdkDatabase, adOpenKeyset, adLockOptimistic
...
Public Property Get BldOutRcptCRLFileFullPath(Optional ByVal mFilePath, Optional ByVal mFileName) As String
mFilePath = IIf(IsMissing(mFilePath) = False, mFilePath, sCmpDataPath)  ''' sAppPath
mFileName = IIf(IsMissing(mFileName) = False, mFileName, cBLOODISURCPT_CRLFILENAME)
BldOutRcptCRLFileFullPath = AddBS(mFilePath) & mFileName

End Property

Public Property Get BldInNoteCRLFileFullPath(Optional ByVal mFilePath, Optional ByVal mFileName) As String
mFilePath = IIf(IsMissing(mFilePath) = False, mFilePath, sCmpDataPath)  ''' sAppPath
mFileName = IIf(IsMissing(mFileName) = False, mFileName, cBLOODINNOTE_CRLFILENAME)
BldInNoteCRLFileFullPath = AddBS(mFilePath) & mFileName

End Property

Public Property Get BldOutNoteCRLFileFullPath(Optional ByVal mFilePath, Optional ByVal mFileName) As String
mFilePath = IIf(IsMissing(mFilePath) = False, mFilePath, sCmpDataPath)  ''' sAppPath
mFileName = IIf(IsMissing(mFileName) = False, mFileName, cBLOODOUTNOTE_CRLFILENAME)
BldOutNoteCRLFileFullPath = AddBS(mFilePath) & mFileName
...
Public Property Get dbBdkDatabaseFullPath(Optional ByVal mDbPath) As String
mDbPath = IIf(IsMissing(mDbPath) = False, mDbPath, sCmpDataPath)
dbBdkDatabaseFullPath = AddBS(mDbPath) & sBdkDatabaseName

End Property

Public Function OpenBdkDataSource(ByRef db As ADODB.Connection, Optional ByVal mDbPath, Optional ByVal mUserId As String, Optional ByVal mPwd As String, Optional ByVal mExclusiveMode As Boolean) As Variant
mDbPath = AddBS(IIf(IsMissing(mDbPath) = False, mDbPath, sCmpDataPath))
db.ConnectionString = "Provider=" & DbProvider & ";Data Source=" & dbBdkDatabaseFullPath(mDbPath)
...
Set clsSRV.dbBdkDatabase = cnn
clsSRV.Init

clsSGP.blnServGrpMast = True
Set clsSGP.dbBdkDatabase = cnn
clsSGP.Init
...
Else
    If clsSGP.mSgpExtRateSys_bln = False Then
        ...
        mPcgwseRateSys = clsSGP.mSgpEtgwseRateSys_bln
    ...
    Else
        ...
        mPcgwseRateSys = clsSRV.mSrvEtgwseRateSys_bln
...
Else
    If clsSGP.mSgpExtDiscSys_bln = False Then
        ...
        mPcgwseDiscSys = clsSGP.mSgpEtgwseDiscSys_bln
    ...
    Else
        ...
        mPcgwseDiscSys = clsSRV.mSrvEtgwseDiscSys_bln
...
Else
    If clsSGP.mSgpExtBargSys_bln = False Then
        ...
        mPcgwseBargSys = clsSGP.mSgpEtgwseBargSys_bln
    ...
    Else
        ...
        mPcgwseBargSys = clsSRV.mSrvEtgwseBargSys_bln
...
Else
    If clsSGP.mSgpExtShareSys_bln = False Then
        ...
        mPcgwseShareSys = clsSGP.mSgpEtgwseShareSys_bln
    ...
    Else
        ...
        mPcgwseShareSys = clsSRV.mSrvEtgwseShareSys_bln
...
'Dim clsBDM As New clsBdkMasterEntry, clsSRV As New clsBdkMasterEntry, clsSGP As New clsBdkMasterEntry
'Dim tRecset As New ADODB.Recordset
'
'Dim mDctwseRateSys As Boolean, mPcgwseRateSys As Boolean, mRBywseRateSys As Boolean, mRTowseRateSys As Boolean, mTimewseRateSys As Boolean
'Dim mDctwseDiscSys As Boolean, mPcgwseDiscSys As Boolean, mRBywseDiscSys As Boolean, mRTowseDiscSys As Boolean, mTimewseDiscSys As Boolean
