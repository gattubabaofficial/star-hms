...
Begin VB.Form frmVgnIpdOptions 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ClientHeight    =   9075
   ClientLeft      =   60
   ...
   End
End
Attribute VB_Name = "frmVgnIpdOptions"
...
Dim clsOPT As clsVgnIpdOptionsEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
...
Dim fcmbPcgName As clsVgnFlexSearch, fcmbCDctName As clsVgnFlexSearch, fcmbRByName As clsVgnFlexSearch, fcmbFDigName As clsVgnFlexSearch, fcmbSrvName As clsVgnFlexSearch, fcmbBdmName As clsVgnFlexSearch
Dim fcmbFlrName As clsVgnFlexSearch, fcmbWrdName As clsVgnFlexSearch
...
Set clsOPT = New clsVgnIpdOptionsEntry
...
Case cOPT_INDRRCPT
    ...
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cVGN_VTYPE_INDOOR_RCPT) & " order by VtmName"
    fcmbVtmName.ReInit
...
Case cOPT_INDRPYMT
    ...
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cVGN_VTYPE_INDOOR_PYMT) & " order by VtmName"
    fcmbVtmName.ReInit
...
Case cOPT_INDRREFD
    ...
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cVGN_VTYPE_INDOOR_REFD) & " order by VtmName"
    fcmbVtmName.ReInit
...
Case cOPT_INDRBILL
    ...
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cVGN_VTYPE_INDOOR_BILL) & " order by VtmName"
    fcmbVtmName.ReInit
...
Case cOPT_INDRBLPYMT
    ...
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cVGN_VTYPE_INDOOR_BLPYMT) & " order by VtmName"
    fcmbVtmName.ReInit
...
Case cOPT_INDRBLREFD
    ...
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cVGN_VTYPE_INDOOR_BLREFD) & " order by VtmName"
    fcmbVtmName.ReInit
...
Case cOPT_INDRRGPYMT
    ...
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cVGN_VTYPE_INDOOR_RGPYMT) & " order by VtmName"
    fcmbVtmName.ReInit
...
Case cOPT_INDRRGREFD
    ...
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cVGN_VTYPE_INDOOR_RGREFD) & " order by VtmName"
    fcmbVtmName.ReInit
