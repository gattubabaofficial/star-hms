...
Begin VB.Form frmOutdoorPymtRcpt 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ClientHeight    =   10860
   ClientLeft      =   60
   ...
   Begin VB.ComboBox cmbFormEntryMode 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "OpdPyRc.frx":0000
      Left            =   0
      List            =   "OpdPyRc.frx":000D
   ...
   Begin VB.Frame frFormDtl 
      ...
      Top             =   720
      Width           =   13215
      Begin VB.TextBox mskOrcRefuAmt 
      ...
      Begin VB.TextBox mskOrcBalAmt 
         ...
         Width           =   1215
      End
      Begin VB.TextBox mskOrcDepoAmtExcl 
         Alignment       =   1  'Right Justify
         Appearance      =   0  'Flat
         BeginProperty DataFormat 
            Type            =   1
      ...
      Begin VB.Frame frFooter 
         ...
         Top             =   7680
         Width           =   12855
         Begin VB.Label lblOrcRefuAmtTot 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
            Caption         =   "0.00"
         ...
         Begin VB.Label lblOrcBalAmtTot 
            ...
            Width           =   1215
         End
         Begin VB.Label lblOpyDepoAmtTot 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
            Caption         =   "0.00"
            ...
            Width           =   1215
         End
         Begin VB.Label lblOrcDepoAmtExclTot 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
            Caption         =   "0.00"
         ...
         Begin VB.Label Label2 
            ...
            Width           =   1695
         End
         Begin VB.Label lblOldOpyCodeDesc 
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
            BeginProperty Font 
               Name            =   "Verdana"
      ...
      Begin VB.Frame frHeader 
         ...
         Begin VB.TextBox txtPttSex 
            ...
            Width           =   1215
         End
         Begin VB.TextBox mskOpyOpgCode 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BeginProperty DataFormat 
               Type            =   1
            ...
            Width           =   1455
         End
         Begin VB.TextBox txtOpyTime_str 
            Appearance      =   0  'Flat
            BeginProperty DataFormat 
               Type            =   0
               Format          =   "0"
         ...
         Begin VB.TextBox mskOpyVchNo 
            ...
            Width           =   1335
         End
         Begin VB.TextBox txtOpyVtmName 
            Appearance      =   0  'Flat
            BeginProperty DataFormat 
               Type            =   0
               Format          =   "0"
         ...
         Begin VB.TextBox txtFDigName 
            ...
            Width           =   3975
         End
         Begin VB.TextBox mskOpyPttCode 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BeginProperty DataFormat 
               Type            =   1
      ...
      Begin VB.TextBox mskOrcVchNo 
         ...
         Width           =   1095
      End
      Begin VB.TextBox mskOpyDepoAmt 
         Alignment       =   1  'Right Justify
         Appearance      =   0  'Flat
         BeginProperty DataFormat 
            Type            =   1
   ...
   Begin VB.Label lblFormHeading 
      ...
      BackColor       =   &H00E0E0E0&
      BorderStyle     =   1  'Fixed Single
      Caption         =   "Outdoor Due Payment Receipt"
      BeginProperty Font 
         Name            =   "Verdana"
         Size            =   9.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmOutdoorPymtRcpt"
...
Dim mOpyCode As Long, mOpyOpgCode As Long, mOpyPttCode As Long, mQryPttCode As Long, mOpyOldOpyCode As Long, dtlAddEditMode As Boolean, dtlAddMode As Boolean, dtlEditCanceled As Boolean
...
Dim mOpyCode_old As Long, mOpyDate_old As Date, mOpyVtmCode_old As Long, mOpyVchNo_old As Long
Dim mOrcCode_old As Long, mOpyDepoAmt_old As Double
Dim clsJRN As clsJournal, clsAH As clsAccountHead, clsOPG As clsHmsSnglTranEntry, clsORC As clsHmsOpdMultiTranEntry, clsOPY As clsHmsOpdMultiTranEntry, clsARA As clsComMastEntry, clsSTN As clsComMastEntry, clsVTM As clsComMastEntry, clsHOPT As clsHmsOpdOptionsEntry
...
Dim fcmbOpyVtmName As clsComFlexSearch
Dim fcmbOldOpgByOpgNo As clsHmsFlexSearch, fcmbOldOpgByPttRegNo As clsHmsFlexSearch, fcmbOldOpgByPttName As clsHmsFlexSearch, fcmbPttName As clsHmsFlexSearch, fcmbPttRegNo As clsHmsFlexSearch, fcmbOrcVchNo As clsHmsFlexSearch
...
Const X2OPYICODE_COL = 0
Const X2OPYSNO_COL = 1
...
Const X2ORCDEPOAMTEXCL_COL = 8
Const X2OPYDEPOAMT_COL = 9
Const X2ORCREFUAMT_COL = 10
Const X2ORCBALAMT_COL = 11
Const X2ORCCODE_COL = 12
Const X2OPYRECSTATE_COL = 13
...
EntryDate = Ctod(dtpOpyDate.Text)
End Property
...
EntryVtmCode = Val(fcmbOpyVtmName.BoundText)
End Property
        ...
        If .EOF = False And .BOF = False Then
            ...
            Else
                ...
                If optMonthwise.Value = True Then
                    dtpFromDate.Text = Dtoc(MonthStartDate(DateSerial(Val(Left(.fields("OpyYrMonth"), 4)), Val(Right(.fields("OpyYrMonth"), 2)), 1)))
                    dtpToDate.Text = Dtoc(MonthEndDate(DateSerial(Val(Left(.fields("OpyYrMonth"), 4)), Val(Right(.fields("OpyYrMonth"), 2)), 1)))
                    optMonthwise.Value = False
                    optDatewise.Value = True
                ElseIf optDatewise.Value = True Then
                    dtpFromDate.Text = Dtoc(.fields("OphDate"))
                    dtpToDate.Text = Dtoc(.fields("OphDate"))
                    optDatewise.Value = False
                    optDetailed.Value = True
...
Dim tRecset As New ADODB.Recordset, srow As Integer, mOpySno As Integer, mOpyICode As Long

srow = Mfgrd2.Row
mOpySno = Val(Mfgrd2.TextMatrix(srow, X2OPYSNO_COL))
mOpyICode = Val(Mfgrd2.TextMatrix(srow, X2OPYICODE_COL))
...
If cmdOK.Caption = "&OK" And dtlEditCanceled = False Then
    ...
    If dtlAddMode = True Then
        .ClearDtl
    Else
        .GetDtlData mOpyCode, mOpyICode
    End If
    .mTrnCode_lng = mOpyCode
    .mTrnDtlSno_int = Val(UnMyNumFmt(mskOpySno.Text))
    .mTrnDate_dt = Ctod(dtpOpyDate.Text)
    .mTrnCmpCode_int = sFinYrCmpCode
    
    .mOpyPttCode_lng = mOpyPttCode
    .mOpyOhrCode_lng = Val(fcmbOrcVchNo.BoundText)
    .mOpyDepoAmt_dbl = Val(UnMyNumFmt(mskOpyDepoAmt.Text))
    .mOpyRemark_str = ""
    
    If dtlAddMode = True Then
        .AddNewDtl mOpyCode
        mOpyICode = .mTrnDtlICode_lng
    Else
        .UpdateDtl mOpyCode, mOpyICode
    End If
    End With
    
    RefreshDatabase dbHmsDatabase
    With tRecset
    .open "Select * from OutdPymtDtl where OpyCode=" & CStr(mOpyCode) & " and OpyICode=" & CStr(mOpyICode) & "", dbHmsDatabase, adOpenKeyset, adLockOptimistic
    
    clsORC.GetHdrData .fields("OpyOhrCode")
    clsVTM.GetData clsORC.mTrnVtmCode_lng
    
    Mfgrd2.TextMatrix(srow, X2OPYICODE_COL) = .fields("OpyICode")
    Mfgrd2.TextMatrix(srow, X2OPYSNO_COL) = ToMyNumFmt(.fields("OpySno"), mDecimals:=0)
    ...
    Mfgrd2.TextMatrix(srow, X2ORCDEPOAMTEXCL_COL) = ToMyNumFmt(clsORC.mOhrDepoAmt_dbl - .fields("OpyDepoAmt"))
    Mfgrd2.TextMatrix(srow, X2OPYDEPOAMT_COL) = ToMyNumFmt(.fields("OpyDepoAmt"))
    Mfgrd2.TextMatrix(srow, X2ORCREFUAMT_COL) = ToMyNumFmt(clsORC.mOhrRefuAmt_dbl)
    Mfgrd2.TextMatrix(srow, X2ORCBALAMT_COL) = ToMyNumFmt(clsORC.mOhrBalAmt_dbl)
    Mfgrd2.TextMatrix(srow, X2ORCCODE_COL) = .fields("OpyOhrCode")
    Mfgrd2.TextMatrix(srow, X2OPYRECSTATE_COL) = .fields("OpyRecState")
...
If optDetailed.Value = True Then
    txtSearch1Text_InterActiveChange Format(Ctod(dtpOpyDate.Text), "yyyymmdd") + Format(mOpyCode, "0000000")
ElseIf optMonthwise.Value = True Then
    txtSearch1Text_InterActiveChange Format(Ctod(dtpOpyDate.Text), "yyyy") & "/" & Format(Ctod(dtpOpyDate.Text), "mm")
ElseIf optDatewise.Value = True Then
    txtSearch1Text_InterActiveChange Format(Ctod(dtpOpyDate.Text), "yyyymmdd")
ElseIf optPatientwise.Value = True Then
...
Private Sub dtpOpyDate_GotFocus()
FlashActiveControl dtpOpyDate, True
End Sub

Private Sub dtpOpyDate_LostFocus()
FlashActiveControl dtpOpyDate, False
End Sub

Private Sub dtpOpyDate_Validate(Cancel As Boolean)
dtpOpyDate.Text = ToMyDate(dtpOpyDate.Text)
If IsFinYrDate(Ctod(dtpOpyDate.Text)) = False Then
    ErrorBox "Invalid Input !!!"
    dtpOpyDate.SetFocus
    Cancel = True
End If
...
mFormUIdFileName = "OutdPyRc.Uid"
mFormAcsPermFileName = "OutdPyRc.Acp"
...
ChkCustomForm Me, CfsFileFullPath("OutdPymt.Cfs")
...
clsHOPT.blnOutdPymtOptMast = True
clsHOPT.Init
clsHOPT.GetOutdPymtOptData
...
Set clsOPY = New clsHmsOpdMultiTranEntry
Set clsOPY.dbAcDatabase = dbAcDatabase
Set clsOPY.dbHmsDatabase = dbHmsDatabase
Set clsOPY.dbComDatabase = dbComDatabase
clsOPY.blnOutdPymtTran = True
clsOPY.Init

Set clsORC = New clsHmsOpdMultiTranEntry
Set clsORC.dbAcDatabase = dbAcDatabase
Set clsORC.dbHmsDatabase = dbHmsDatabase
...
Set fcmbOpyVtmName = New clsComFlexSearch
Set fcmbOpyVtmName.dbAcDatabase = dbAcDatabase
fcmbOpyVtmName.blnVTypeMastList = True
fcmbOpyVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cHMS_VTYPE_OUTDOOR_PYMT) & " order by VtmName"
fcmbOpyVtmName.Init

Set fcmbOrcVchNo = New clsHmsFlexSearch
Set fcmbOrcVchNo.dbHmsDatabase = dbHmsDatabase
...
If mRemoteAccess = True Then
    datRecset.open "Select * from OutdPymtHdr inner join PatMast on OutdPymtHdr.OphPttCode = PatMast.PttCode where OphCode=" & CStr(mOpyCode) & " order by OphDate,OphTime", dbHmsDatabase, adOpenKeyset, adLockOptimistic
    dtpFromDate.Text = Dtoc(datRecset.fields("OphDate"))
    dtpToDate.Text = Dtoc(datRecset.fields("OphDate"))
    AddSmryParaLayer mClear:=True
    
Else
    datRecset.open "Select * from OutdPymtHdr inner join PatMast on OutdPymtHdr.OphPttCode=PatMast.PttCode order by OphDate,OphTime", dbHmsDatabase, adOpenKeyset, adLockOptimistic
End If
Mfgrd1.FixedCols = 0
Call SmryList
...
colcnt = X2OPYICODE_COL: Mfgrd2.ColWidth(colcnt) = 0: Mfgrd2.TextMatrix(0, colcnt) = "X2OPYICODE_COL": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2OPYSNO_COL: Mfgrd2.ColWidth(colcnt) = mskOpySno.Width: Mfgrd2.TextMatrix(0, colcnt) = "Sno": Mfgrd2.ColAlignment(colcnt) = 7
...
colcnt = X2ORCDEPOAMTEXCL_COL: Mfgrd2.ColWidth(colcnt) = mskOrcDepoAmtExcl.Width: Mfgrd2.TextMatrix(0, colcnt) = "PreDepo.Amt": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2OPYDEPOAMT_COL: Mfgrd2.ColWidth(colcnt) = mskOpyDepoAmt.Width: Mfgrd2.TextMatrix(0, colcnt) = "Depo.Amt": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2ORCREFUAMT_COL: Mfgrd2.ColWidth(colcnt) = mskOrcRefuAmt.Width: Mfgrd2.TextMatrix(0, colcnt) = "Refund.Amt": Mfgrd2.ColAlignment(colcnt) = 7
...
colcnt = X2OPYRECSTATE_COL: Mfgrd2.ColWidth(colcnt) = 0: Mfgrd2.TextMatrix(0, colcnt) = "X2OPYRECSTATE_COL": Mfgrd2.ColAlignment(colcnt) = 7

colcnt = X2OPYSNO_COL: mskOpySno.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
...
colcnt = X2ORCDEPOAMTEXCL_COL: mskOrcDepoAmtExcl.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
colcnt = X2OPYDEPOAMT_COL: mskOpyDepoAmt.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
colcnt = X2ORCREFUAMT_COL: mskOrcRefuAmt.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
...
lblOrcDepoAmtExclTot.Left = mskOrcDepoAmtExcl.Left - frFooter.Left: lblOrcDepoAmtExclTot.Width = mskOrcDepoAmtExcl.Width
lblOpyDepoAmtTot.Left = mskOpyDepoAmt.Left - frFooter.Left: lblOpyDepoAmtTot.Width = mskOpyDepoAmt.Width
lblOrcRefuAmtTot.Left = mskOrcRefuAmt.Left - frFooter.Left: lblOrcRefuAmtTot.Width = mskOrcRefuAmt.Width
...
Dim mPttRegNo As Long, mOpyPttCode As Long, mOpgVchNo As Long, mOpyVchNo As Long
Dim mOrcAmtAftDiscAmtTot As Double, mOrcAdvAmtTot As Double, mOrcRecdAmtTot As Double, mOrcDepoAmtExclTot As Double, mOpyDepoAmtTot As Double, mOrcRefuAmtTot As Double
...
mOpyPttCode = Val(mskOpyPttCode.Text)
If mOpyPttCode < 1 Then
    ErrorBox "Invalid Key Value !!!"
    txtPttName.SetFocus
    GoTo EndSub
End If
...
If mPttRegNo < 0 Then
    ...
    GoTo EndSub
Else
    If mPttRegNo = 0 And clsHOPT.mOpyPttRegNoNotZero_bln = True Then
...
If Val(mskOpyOpgCode.Text) < 1 Then
    ErrorBox "Invalid Key Value !!!"
    txtPttName.SetFocus
    GoTo EndSub
End If
...
mOpyVchNo = Val(UnMyNumFmt(mskOpyVchNo(0).Text))
If mOpyVchNo > 0 Then
    If mOpyVchNo <> mOpyVchNo_old Or Val(fcmbOpyVtmName.BoundText) <> mOpyVtmCode_old Or Ctod(dtpOpyDate.Text) <> mOpyDate_old Or FormAddEditMode = cFORM_ADDMODE Then
        If ChkIsDuplVTypeNo(dbHmsDatabase, dbAcDatabase, mTableName:="OutdPymtHdr", mChkFieldName:="OphVchNo", mChkFieldValue:=mOpyVchNo, mKeyFieldName:="OphCode", mKeyFieldValue:=mOpyCode, mVtmFieldName:="OphVtmCode", mVtmFieldValue:=Val(fcmbOpyVtmName.BoundText), mFinYrFieldName:="OphCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="OphDate", mDateFieldValue:=Ctod(dtpOpyDate.Text)) = True Then
            ErrorBox "Duplicate Voucher No. !!!"
            mskOpyVchNo(0).SetFocus
            ' ---------------
            If FormAddEditMode = True Then
                mOpyVchNo = GetNextVTypeNo(dbHmsDatabase, dbAcDatabase, dbComDatabase, mTableName:="OutdPymtHdr", mFieldName:="OphVchNo", mVtmFieldName:="OphVtmCode", mVtmFieldValue:=Val(fcmbOpyVtmName.BoundText), mFinYrFieldName:="OphCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="OphDate", mDateFieldValue:=Ctod(dtpOpyDate.Text), mModuleCode:=mFormUIdCode, mModuleName:=Me.Name, mAcsPermFileName:=mFormAcsPermFileName)
            Else
                mOpyVchNo = mOpyVchNo_old
            End If
            mskOpyVchNo(0).Text = ToMyNumFmt(mOpyVchNo, mDecimals:=0)
            GoTo EndSub
        End If
    End If
Else
    ...
    GoTo EndSub
End If
If IsDate(dtpOpyDate.Text) = False Then
    ErrorBox "Invalid Input !!!"
    dtpOpyDate.SetFocus
    GoTo EndSub
Else
    ...
    End If
End If
If TimeToMin(txtOpyTime_str.Text) > cDAYMINUTES Then
    ErrorBox "Invalid Input !!!"
    txtOpyTime_str.SetFocus
    GoTo EndSub
End If
mOpyDepoAmtTot = Val(UnMyNumFmt(lblOpyDepoAmtTot.Caption))
If mOpyDepoAmtTot < 0 Then
    ErrorBox "Invalid Input !!!"
    Mfgrd2.SetFocus
    GoTo EndSub
End If
...
mOrcDepoAmtExclTot = Val(UnMyNumFmt(lblOrcDepoAmtExclTot.Caption))
mOrcRefuAmtTot = Val(UnMyNumFmt(lblOrcRefuAmtTot.Caption))
If (mOrcAdvAmtTot + mOrcRecdAmtTot + mOrcDepoAmtExclTot + mOpyDepoAmtTot) > mOrcAmtAftDiscAmtTot Then
...
Dim srow As Integer, mOpyICode As Long, mDeleteit As Boolean
srow = Mfgrd2.Row
mOpyICode = Val(Mfgrd2.TextMatrix(srow, X2OPYICODE_COL))

If MyDeleteKey(Shift, KeyCode, mCheckCtrlMask:=False) = True And mOpyICode > 0 Then
    mDeleteit = True
    If mDeleteit = True Then
        mDeleteit = CanDelete()
    End If
    If mDeleteit = True Then
        clsOPY.DeleteDtl mOpyCode, mOpyICode
        
        ShowDtlData mOpyCode
        Mfgrd2.Row = srow
        Mfgrd2.SetFocus
...
If KeyAscii = vbKeyReturn Then
    ...
    If dtlAddMode = True Then
        mskOpySno.Text = ToMyNumFmt(FlexNextSeqno(Mfgrd2, X2OPYSNO_COL), mDecimals:=0)
        mskOrcVchNo.Text = "": fcmbOrcVchNo.BoundText = ""
    Else
        With Mfgrd2
        mskOpySno.Text = .TextMatrix(srow, X2OPYSNO_COL)
        ...
        mskOrcDepoAmtExcl.Text = .TextMatrix(srow, X2ORCDEPOAMTEXCL_COL)
        mskOpyDepoAmt.Text = .TextMatrix(srow, X2OPYDEPOAMT_COL)
        mskOrcRefuAmt.Text = .TextMatrix(srow, X2ORCREFUAMT_COL)
    ...
    mOpyDepoAmt_old = Val(UnMyNumFmt(mskOpyDepoAmt.Text))
End If
...
Private Sub mskOpyDepoAmt_GotFocus()
FlashActiveControl mskOpyDepoAmt, True
End Sub

Private Sub mskOpyDepoAmt_LostFocus()
FlashActiveControl mskOpyDepoAmt, False
End Sub

Private Sub mskOpyDepoAmt_Validate(Cancel As Boolean)
If chkOpyDepoAmt() = False Then
    mskOpyDepoAmt.SetFocus
    Cancel = True
Else
    Call ValidDtl
End If
...
Private Function chkOpyDepoAmt() As Boolean
Dim mRtnval As Boolean
Dim mOrcAmtAftDisc As Double, mOrcAdvAmt As Double, mOrcRecdAmt As Double, mOrcDepoAmtExcl As Double, mOpyDepoAmt As Double, mOrcRefuAmt As Double, mOrcBalAmt As Double
...
mOrcDepoAmtExcl = Val(UnMyNumFmt(mskOrcDepoAmtExcl.Text))
mOpyDepoAmt = Val(UnMyNumFmt(mskOpyDepoAmt.Text))
mOrcRefuAmt = Val(UnMyNumFmt(mskOrcRefuAmt.Text))

mskOpyDepoAmt.Text = ToMyNumFmt(mOpyDepoAmt)
If mOpyDepoAmt < 1 Then
    If InterActiveChange(mskOpyDepoAmt) = True Then
        ErrorBox "Invalid Input !!!"
    End If
    mRtnval = False
Else
    If (mOrcAdvAmt + mOrcRecdAmt + mOrcDepoAmtExcl + mOpyDepoAmt) > mOrcAmtAftDisc Then
        If InterActiveChange(mskOpyDepoAmt) = True Then
            ErrorBox "Excess Amount Deposited !!!"
            mskOpyDepoAmt.Text = ToMyNumFmt(mOrcAmtAftDisc - (mOrcAdvAmt + mOrcRecdAmt + mOrcDepoAmtExcl))
            mOpyDepoAmt = Val(UnMyNumFmt(mskOpyDepoAmt.Text))
        End If
        mRtnval = False
    ElseIf mOrcRefuAmt > (mOrcAdvAmt + mOrcRecdAmt + mOrcDepoAmtExcl + mOpyDepoAmt) Then
        If InterActiveChange(mskOpyDepoAmt) = True Then
    ...
    End If
End If
mskOrcBalAmt.Text = ToMyNumFmt(mOrcAmtAftDisc - (mOrcAdvAmt + mOrcRecdAmt + mOrcDepoAmtExcl + mOpyDepoAmt))

chkOpyDepoAmt = mRtnval
...
Private Sub mskOpyVchNo_GotFocus(Index As Integer)
FlashActiveControl mskOpyVchNo(Index), True
End Sub

Private Sub mskOpyVchNo_LostFocus(Index As Integer)
FlashActiveControl mskOpyVchNo(Index), False
End Sub

Private Sub mskOpyVchNo_Validate(Index As Integer, Cancel As Boolean)
Dim mOpyVchNo As Long

mOpyVchNo = Val(UnMyNumFmt(mskOpyVchNo(Index).Text))
If mOpyVchNo < 0 And Index = 0 Then
    mOpyVchNo = GetNextVTypeNo(dbHmsDatabase, dbAcDatabase, dbComDatabase, mTableName:="OutdPymtHdr", mFieldName:="OphVchNo", mVtmFieldName:="OphVtmCode", mVtmFieldValue:=Val(fcmbOpyVtmName.BoundText), mFinYrFieldName:="OphCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="OphDate", mDateFieldValue:=Ctod(dtpOpyDate.Text), mModuleCode:=mFormUIdCode, mModuleName:=Me.Name, mAcsPermFileName:=mFormAcsPermFileName)
    mskOpyVchNo(Index).Text = ToMyNumFmt(mOpyVchNo, mDecimals:=0)
ElseIf mOpyVchNo > 0 And Index = 0 Then
    If mOpyVchNo <> mOpyVchNo_old Or Val(fcmbOpyVtmName.BoundText) <> mOpyVtmCode_old Or Ctod(dtpOpyDate.Text) <> mOpyDate_old Or FormAddEditMode = cFORM_ADDMODE Then
        If ChkIsDuplVTypeNo(dbHmsDatabase, dbAcDatabase, mTableName:="OutdPymtHdr", mChkFieldName:="OphVchNo", mChkFieldValue:=mOpyVchNo, mKeyFieldName:="OphCode", mKeyFieldValue:=mOpyCode, mVtmFieldName:="OphVtmCode", mVtmFieldValue:=Val(fcmbOpyVtmName.BoundText), mFinYrFieldName:="OphCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="OphDate", mDateFieldValue:=Ctod(dtpOpyDate.Text)) = True Then
            ErrorBox "Duplicate Voucher No. !!!"
            Cancel = True
            mskOpyVchNo(Index).SetFocus
            ' ----------
...
Private Sub txtOphRemark_GotFocus()
FlashActiveControl txtOphRemark, True
End Sub

Private Sub txtOphRemark_LostFocus()
FlashActiveControl txtOphRemark, False
End Sub

Private Sub txtOphRemark_Validate(Cancel As Boolean)
txtOphRemark.Text = ToMyWord(txtOphRemark.Text)
End Sub
...
Private Sub txtOpyTime_str_GotFocus()
FlashActiveControl txtOpyTime_str, True
End Sub

Private Sub txtOpyTime_str_LostFocus()
FlashActiveControl txtOpyTime_str, False
End Sub

Private Sub txtOpyTime_str_Validate(Cancel As Boolean)
txtOpyTime_str.Text = MinToTime(TimeToMin(txtOpyTime_str.Text))
If TimeToMin(txtOpyTime_str.Text) > cDAYMINUTES Then
    ErrorBox "Invalid Input !!!"
    txtOpyTime_str.SetFocus
    Cancel = True
...
Private Sub txtOpyVtmName_Change(Index As Integer)
If fcmbOpyVtmName.CallFromText_Change = False Then
    fcmbOpyVtmName.CallFromText_Change = True
    If InterActiveChange(txtOpyVtmName(Index)) = True Then
        fcmbOpyVtmName.UserText = Array(txtOpyVtmName(Index).Text, txtOpyVtmName(Index).SelStart)
        fcmbOpyVtmName.Show
        txtOpyVtmName(Index).Text = fcmbOpyVtmName.Text
        If fcmbOpyVtmName.ListSelected = True Then
            SendKeys "{tab}"
        End If
    End If
    fcmbOpyVtmName.CallFromText_Change = False
End If

End Sub

Private Sub txtOpyVtmName_GotFocus(Index As Integer)
FlashActiveControl txtOpyVtmName(Index), True
End Sub

Private Sub txtOpyVtmName_KeyDown(Index As Integer, KeyCode As Integer, Shift As Integer)
If MyDropDownKey(Shift, KeyCode) = True Then
    Call txtOpyVtmName_Change(Index)
ElseIf MyAddNewKey(Shift, KeyCode) = True Then
...
Private Sub txtOpyVtmName_LostFocus(Index As Integer)
FlashActiveControl txtOpyVtmName(Index), False
End Sub

Private Sub txtOpyVtmName_Validate(Index As Integer, Cancel As Boolean)
Dim mOpyVchNo As Long

If Val(fcmbOpyVtmName.BoundText) < 1 Then
    ErrorBox "Invalid Selection !!!"
    txtOpyVtmName(Index).SetFocus
    Cancel = True
ElseIf Index = 0 Then
    If Val(fcmbOpyVtmName.BoundText) <> mOpyVtmCode_old Or Ctod(dtpOpyDate.Text) <> mOpyDate_old Or FormAddEditMode = cFORM_ADDMODE Then
        mOpyVchNo = GetNextVTypeNo(dbHmsDatabase, dbAcDatabase, dbComDatabase, mTableName:="OutdPymtHdr", mFieldName:="OphVchNo", mVtmFieldName:="OphVtmCode", mVtmFieldValue:=Val(fcmbOpyVtmName.BoundText), mFinYrFieldName:="OphCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="OphDate", mDateFieldValue:=Ctod(dtpOpyDate.Text), mModuleCode:=mFormUIdCode, mModuleName:=Me.Name, mAcsPermFileName:=mFormAcsPermFileName)
        mskOpyVchNo(Index).Text = ToMyNumFmt(mOpyVchNo, mDecimals:=0)
    End If
End If
...
If CanUserAddOpt(mUsrCode:=MyCompany.mUserCode, mMenuOptName:=Me.SecuMenuName) = False Then
    ...
    Exit Sub
End If
If clsOPY.BeginTran(0) = False Then
    Exit Sub
End If
mEntrySaved = False: mEntryAborted = False
FormAddEditMode = cFORM_ADDMODE

clsOPY.ClearHdr: clsOPY.ClearDtl
clsOPG.Clear
clsPAT.Clear

mOpyCode = clsOPY.ActiveTrnCode
mOpyOpgCode = 0
mOpyPttCode = 0

ShowOpyData mOpyCode
ShowOpgData mOpyOpgCode
ShowPatData mOpyPttCode
...
If CanUserEditOpt(mUsrCode:=MyCompany.mUserCode, mMenuOptName:=Me.SecuMenuName) = False Then
    ...
    Exit Sub
End If
If clsOPY.BeginTran(datRecset.fields("OphCode")) = False Then
    Exit Sub
End If
mEntrySaved = False: mEntryAborted = False
...
With datRecset
mOpyCode = .fields("OphCode")
mOpyOpgCode = .fields("OphOpgCode")
mOpyPttCode = .fields("OphPttCode")

clsOPY.GetHdrData mOpyCode
clsOPG.GetData mOpyOpgCode
clsPAT.GetData mOpyPttCode
End With
...
Private Sub ShowOpyData(ByVal mOpyCode As Long)

With clsOPY
.GetHdrData mOpyCode

mskFormBoundField.Text = mOpyCode
fcmbOpyVtmName.BoundText = CStr(.mTrnVtmCode_lng): txtOpyVtmName(0).Text = fcmbOpyVtmName.Text
txtOpyPrefix.Text = .mTrnPrefix_str
mskOpyVchNo(0).Text = ToMyNumFmt(.mTrnVchNo_lng, mDecimals:=0)
dtpOpyDate.Text = Dtoc(.mTrnDate_dt)
txtOpyTime_str.Text = MinToTime(.mOphTime_lng)
txtOphRemark.Text = .mOphRemark_str
Rem old outdoor receipt
mOpyOldOpyCode = .mOphOldOphCode_lng
ShowOldOpyCodeDesc mOpyOldOpyCode
End With
...
Private Sub ShowOpyDefData()
Dim mOpyVchNo As Long

dtpOpyDate.Text = Dtoc(DefaultEntryDate)
txtOpyTime_str.Text = MinToTime(TimeToMin(DateTime.Time$))

fcmbOpyVtmName.BoundText = CStr(clsHOPT.GetOutdPymtOptBoundCode("OpyVtmCode")): txtOpyVtmName(0).Text = fcmbOpyVtmName.Text
...
Private Sub StoreOpyOldData()
mOpyCode_old = mOpyCode
mOpyDate_old = Ctod(dtpOpyDate.Text)
mOpyVtmCode_old = Val(fcmbOpyVtmName.BoundText)
mOpyVchNo_old = Val(UnMyNumFmt(mskOpyVchNo(0).Text))

End Sub

Private Sub ShowDtlData(ByVal mOpyCode As Long)
...
With tRecset
.open "Select * from OutdPymtDtl where OpyCode=" & CStr(mOpyCode) & " order by OpySno", dbHmsDatabase, adOpenKeyset, adLockOptimistic
If .RecordCount > 0 Then
    Do While .EOF = False
        If InList(.fields("OpyRecState"), Array(cREC_ADDED, cREC_EDITED, cREC_UNCHANGED)) = True Then
            clsORC.GetHdrData .fields("OpyOhrCode")
            clsVTM.GetData clsORC.mTrnVtmCode_lng
            ...
            srow = srow + 1
        Else
            If InList(.fields("OpyRecState"), Array(cREC_CANCELED, cREC_DELETED)) = False Then
...
End If
.mTrnDate_dt = Ctod(dtpOpyDate.Text)
.mTrnVtmCode_lng = Val(fcmbOpyVtmName.BoundText)
.mTrnPrefix_str = txtOpyPrefix.Text
.mTrnVchNo_lng = Val(UnMyNumFmt(mskOpyVchNo(0).Text))
.mTrnPostfix_str = ""
.mTrnCmpCode_int = sFinYrCmpCode

.mOphTime_lng = TimeToMin(txtOpyTime_str.Text)
.mOphOpgCode_lng = mOpyOpgCode
.mOphPttCode_lng = mOpyPttCode
.mOphOldOphCode_lng = mOpyOldOpyCode
.mOphDepoAmt_dbl = Val(UnMyNumFmt(lblOpyDepoAmtTot.Caption))
.mOphRemark_str = txtOphRemark.Text
...
If clsOPY.mTrnCode_lng > 0 Then   ' updated successfully
...
mOpyCode = datRecset.fields("OphCode")
mOpyPttCode = datRecset.fields("OphPttCode")
mRecAbsPos = datRecset.AbsolutePosition

If clsOPY.CanDeleteTran(mOpyCode) = True Then
    txtVoid.SetFocus
    If clsOPY.BeginTran(mOpyCode) = True Then
        clsOPY.DeleteTran mOpyCode
        clsOPY.UpdateTran mOpyCode
        clsOPY.EndTran mOpyCode
...
If optMonthwise.Value = True Or optDatewise.Value = True Or optPatientwise.Value = True Then
    If optMonthwise.Value = True Then
        clsListStru.AddFields mExpr:="OpyYrMonth", mAttrib:=cFAT_SYSTEM
        clsListStru.AddFields mExpr:="OpyMnYear", mTitle:="Month", mShowItem:=True, mAlign:=1, mWidth:=2000
        clsListStru.AddFields mExpr:="OpyCount", mTitle:="Count", mShowItem:=True, mAlign:=7, mWidth:=1500
        clsListStru.AddFields mExpr:="OpyDepoAmt_sum", mTitle:="Recd.Amt", mShowItem:=True, mAlign:=7, mWidth:=1500
        
        datRecset.open "Select format(OphDate,'yyyy/MM') as OpyYrMonth" _
         & ",Count(OphCode) as OpyCount" _
         & ",Sum(OphDepoAmt) as OpyDepoAmt_sum" _
         & " from OutdPymtHdr" _
         ...
         & " group by format(OphDate,'yyyy/MM')" _
         & " order by format(OphDate,'yyyy/MM')" _
         , dbHmsDatabase, adOpenKeyset, adLockReadOnly

    ElseIf optDatewise.Value = True Then
        clsListStru.AddFields mExpr:="OpyDateYMD", mAttrib:=cFAT_SYSTEM
        clsListStru.AddFields mExpr:="OpyDate", mTitle:="Date", mShowItem:=True, mAlign:=1, mWidth:=2000
        clsListStru.AddFields mExpr:="OpyCount", mTitle:="Count", mShowItem:=True, mAlign:=7, mWidth:=1500
        clsListStru.AddFields mExpr:="OpyDepoAmt_sum", mTitle:="Recd.Amt", mShowItem:=True, mAlign:=7, mWidth:=1500
        
        datRecset.open "Select OphDate" _
         & ",Count(OphCode) as OpyCount" _
         & ",Sum(OphDepoAmt) as OpyDepoAmt_sum" _
         & " from OutdPymtHdr" _
         & " where OphDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
    ...
    ElseIf optPatientwise.Value = True Then
        ...
        datRecset.open "Select PatMast.PttName,PatMast.PttRegNo,OutdPymtHdr.OphPttCode" _
         & ",Count(OphCode) as OpyCount" _
         & ",Sum(OphDepoAmt) as OpyDepoAmt_sum" _
         & " from OutdPymtHdr inner join PatMast on OutdPymtHdr.OphPttCode=PatMast.PttCode" _
         & " where OphDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
         & " and OphCode>0" _
         & IIf(mQryPttCode > 0, " and OphPttCode=" & CStr(mQryPttCode), "") _
         & " group by PatMast.PttName,PatMast.PttRegNo,OutdPymtHdr.OphPttCode" _
         & " order by PatMast.PttName,PatMast.PttRegNo,OutdPymtHdr.OphPttCode" _
         , dbHmsDatabase, adOpenKeyset, adLockReadOnly
    End If
    
ElseIf optDetailed.Value = True Then
    clsListStru.AddFields mExpr:="tOpySmryId", mAttrib:=cFAT_SYSTEM
    clsListStru.AddFields mExpr:="OpyCode", mAttrib:=cFAT_SYSTEM
    ...
    clsListStru.AddFields mExpr:="OpyDate", mTitle:="Date", mAlign:=1, mWidth:=1300, mShowItem:=True
    ' --------------------------------------
    ...
    ' --------------------------------------
    clsListStru.AddFields mExpr:="OpyDepoAmt", mTitle:="Depo.Amt", mAlign:=7, mWidth:=1250, mShowItem:=True
    ' --------------------------------------
    ...
    datRecset.open "Select OutdPymtHdr.*,PatMast.*" _
     & ",format(OphDate,'yyyymmdd')+format(OphCode,'0000000') as tOpySmryId" _
     & " from OutdPymtHdr inner join PatMast on OutdPymtHdr.OphPttCode=PatMast.PttCode" _
     & " where OphDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
     & IIf(mRemoteAccess = True, " and OphCode=" & CStr(mOpyCode) & "", "") _
     & " and OphCode>0" _
     & IIf(mQryPttCode > 0, " and OphPttCode=" & CStr(mQryPttCode), "") _
     & " order by OphDate,OphCode" _
     , dbHmsDatabase, adOpenKeyset, adLockReadOnly
...
If .RecordCount > 0 Then
    Do While .EOF = False
        If optMonthwise.Value = True Or optDatewise.Value = True Or optPatientwise.Value = True Then
            If optMonthwise.Value = True Then
                Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OpyYrMonth")) = .fields("OpyYrMonth")
                Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OpyMnYear")) = MonthName(Val(Right(.fields("OpyYrMonth"), 2))) & "-" & Left(.fields("OpyYrMonth"), 4)
                Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OpyCount")) = ToMyNumFmt(.fields("OpyCount"), mDecimals:=0)
                Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OpyDepoAmt_sum")) = ToMyNumFmt(.fields("OpyDepoAmt_sum"))
                
            ElseIf optDatewise.Value = True Then
                Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OpyDateYMD")) = Format(.fields("OphDate"), "yyyymmdd")
                Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OpyDate")) = Dtoc(.fields("OphDate"))
                Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OpyCount")) = ToMyNumFmt(.fields("OpyCount"), mDecimals:=0)
                Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OpyDepoAmt_sum")) = ToMyNumFmt(.fields("OpyDepoAmt_sum"))
        ...
        ElseIf optDetailed.Value = True Then
            ...
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("tOpySmryId")) = Format(.fields("OphDate"), "yyyymmdd") & Format(.fields("OphCode"), "0000000")
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OpyCode")) = .fields("OphCode")
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("VtmName")) = clsVTM.mName_str
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OrcVchNo")) = .fields("OphVchNo")
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OpyDate")) = Dtoc(.fields("OphDate"))
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OpyDepoAmt")) = ToMyNumFmt(.fields("OphDepoAmt"))
            ' ------------------------------------
...
Else    ' system field search has been requested by programmer
    If optDetailed.Value = True Then
        SearchFlex Mfgrd1, clsListStru.GetItemIndex("tOpySmryId"), mText
    ElseIf optMonthwise.Value = True Then
        SearchFlex Mfgrd1, clsListStru.GetItemIndex("OpyYrMonth"), mText
    ElseIf optDatewise.Value = True Then
        SearchFlex Mfgrd1, clsListStru.GetItemIndex("OpyDateYMD"), mText
    ElseIf optPatientwise.Value = True Then
...
If fcmbOrcVchNo.CallFromText_Change = False Then
    ...
    If InterActiveChange(mskOrcVchNo) = True Then
        fcmbOrcVchNo.mFiltCond = "OhrOpgCode=" & CStr(mOpyOpgCode)
        fcmbOrcVchNo.ReInit
...
Else
    If Val(fcmbOrcVchNo.BoundText) <> mOrcCode_old Or FormAddEditMode = cFORM_ADDMODE Then
        ...
        mskOrcDepoAmtExcl.Text = ToMyNumFmt(clsORC.mOhrDepoAmt_dbl - mOpyDepoAmt_old)   '''  Val(UnMyNumFmt(mskOpyDepoAmt.Text))
        If Val(UnMyNumFmt(mskOpyDepoAmt.Text)) = 0 Then
            mskOpyDepoAmt.Text = ToMyNumFmt(clsORC.mOhrBalAmt_dbl)
        End If
        mskOrcRefuAmt.Text = ToMyNumFmt(clsORC.mOhrRefuAmt_dbl)
...
Private Sub ShowOldOpyCodeDesc(ByVal mOldOrcCode As Long)
Dim tRecset As New ADODB.Recordset

With tRecset
.open "Select * from OutdPymtHdr where OphCode=" & CStr(mOldOrcCode) & "", dbHmsDatabase, adOpenKeyset, adLockOptimistic
If .RecordCount > 0 Then
    clsVTM.GetData .fields("OphVtmCode")
    lblOldOpyCodeDesc.Caption = RTrim(clsVTM.mName_str) & " No.:" & CStr(.fields("OphVchNo")) & " Dated:" & Dtoc(.fields("OphDate"))
Else
    lblOldOpyCodeDesc.Caption = "#" & CStr(mOldOrcCode) & "#"
End If
End With
CloseTable tRecset
...
Private Function GetOldOpyCodeFromPttCode(ByVal mPttCode As Long) As Long
Dim tRecset As New ADODB.Recordset

With tRecset
.open "Select top 1 * from OutdPymtHdr where OphPttCode=" & CStr(mPttCode) & " order by OphDate desc,OphVchNo desc,OphCode desc", dbHmsDatabase, adOpenKeyset, adLockOptimistic
If .RecordCount > 0 Then
    GetOldOpyCodeFromPttCode = .fields("OphCode")
Else
    GetOldOpyCodeFromPttCode = 0
End If
End With
CloseTable tRecset
    ...
    If InterActiveChange(txtOpgVtmName) = True Then
        ...
        If FormAddEditMode = cFORM_ADDMODE And Mfgrd2.Rows = 2 And fcmbOldOpgByOpgNo.ListSelected = True And Val(fcmbOldOpgByOpgNo.BoundText) > 0 Then
            ...
            If mOldOpgCode > 0 And mOldOpgPttCode > 0 Then
                mOpyPttCode = mOldOpgPttCode
                ShowPatData mOpyPttCode
                Call StorePatOldData
                'ShowPttDiscPer mOpyPttCode
                
                mOpyOpgCode = mOldOpgCode
                ShowOpgData mOpyOpgCode
                Call StoreOpgOldData
                
                mOpyOldOpyCode = GetOldOpyCodeFromPttCode(mOpyPttCode)
                ShowOldOpyCodeDesc mOpyOldOpyCode
            End If
        Else
...
If IsMissing(mRowPos) = False Then
    ...
    mskOrcDepoAmtExcl.Top = mRowPos
    mskOpyDepoAmt.Top = mRowPos
    mskOrcRefuAmt.Top = mRowPos
...
mskOrcDepoAmtExcl.Text = ToMyNumFmt(0)
mskOpyDepoAmt.Text = ToMyNumFmt(0)
mskOrcRefuAmt.Text = ToMyNumFmt(0)
mskOrcBalAmt.Text = ToMyNumFmt(0)

Call ValidDtl

mskOpySno.Visible = mShowItem
...
mskOrcDepoAmtExcl.Visible = mShowItem
mskOpyDepoAmt.Visible = mShowItem
mskOrcRefuAmt.Visible = mShowItem
...
mDataOk = (mOpyPttCode > 0 And mOpyOpgCode > 0 And Val(UnMyNumFmt(mskOpySno.Text)) > 0 And Val(fcmbOrcVchNo.BoundText) > 0 And Val(UnMyNumFmt(mskOpyDepoAmt.Text)) > 0 And chkOpyDepoAmt() = True)
cmdOK.Caption = IIf(mDataOk = True, "&OK", "&Cancel")
cmdOK.BackColor = IIf(mDataOk = True, &H80FF80, &H8080FF)
End Sub

Private Sub CalcFtrTotal()
Dim mOrcAmtAftDiscTot As Double, mOrcAdvAmtTot As Double, mOrcRecdAmtTot As Double, mOrcDepoAmtExclTot As Double, mOpyDepoAmtTot As Double, mOrcRefuAmtTot As Double, mOrcBalAmtTot As Double
...
mOrcDepoAmtExclTot = FlexColSum(Mfgrd2, X2ORCDEPOAMTEXCL_COL)
mOpyDepoAmtTot = FlexColSum(Mfgrd2, X2OPYDEPOAMT_COL)
mOrcRefuAmtTot = FlexColSum(Mfgrd2, X2ORCREFUAMT_COL)
...
lblOrcDepoAmtExclTot.Caption = ToMyNumFmt(mOrcDepoAmtExclTot)
lblOpyDepoAmtTot.Caption = ToMyNumFmt(mOpyDepoAmtTot)
lblOrcRefuAmtTot.Caption = ToMyNumFmt(mOrcRefuAmtTot)
...
If Val(fcmbOpyVtmName.BoundText) < 1 Then
    ...
    txtOpyVtmName(1).SetFocus
    Exit Sub
End If
If Val(UnMyNumFmt(mskOpyVchNo(1).Text)) < 1 Then
    ErrorBox "Invalid Voucher No. !!!"
    mskOpyVchNo(1).SetFocus
    Exit Sub
Else
    mOpyVchNo = Val(UnMyNumFmt(mskOpyVchNo(1).Text))
    If ChkIsExistVTypeNo(dbHmsDatabase, mTableName:="OutdPymtHdr", mChkFieldName:="OphVchNo", mChkFieldValue:=CStr(mOpyVchNo), mVtmFieldName:="OphVtmCode", mVtmFieldValue:=Val(fcmbOpyVtmName.BoundText), mFinYrFieldName:="OphCmpCode", mFinYrFieldValue:=sFinYrCmpCode) = False Then
        ErrorBox "Voucher No. does not Exist !!!"
        mskOpyVchNo(1).SetFocus
        Exit Sub
    End If
End If
If Val(UnMyNumFmt(mskOpyVchNo(2).Text)) < 1 Then
    ErrorBox "Invalid Voucher No. !!!"
    mskOpyVchNo(2).SetFocus
    Exit Sub
Else
    mOpyVchNo = Val(UnMyNumFmt(mskOpyVchNo(2).Text))
    If ChkIsExistVTypeNo(dbHmsDatabase, mTableName:="OutdPymtHdr", mChkFieldName:="OphVchNo", mChkFieldValue:=CStr(mOpyVchNo), mVtmFieldName:="OphVtmCode", mVtmFieldValue:=Val(fcmbOpyVtmName.BoundText), mFinYrFieldName:="OphCmpCode", mFinYrFieldValue:=sFinYrCmpCode) = False Then
        ErrorBox "Voucher No. does not Exist !!!"
        mskOpyVchNo(2).SetFocus
        Exit Sub
...
Dim mFromOpyVchNo As Long, mToOpyVchNo As Long, mOpyVtmCode As Long
Dim fCRView As Form

mFromOpyVchNo = Val(UnMyNumFmt(mskOpyVchNo(1).Text))
mToOpyVchNo = Val(UnMyNumFmt(mskOpyVchNo(2).Text))
mOpyVtmCode = Val(fcmbOpyVtmName.BoundText)
...
frmMain.Cryst.SelectionFormula = "{vewOutdPymt.OphVchNo}>=" & CStr(mFromOpyVchNo) & " and {vewOutdPymt.OphVchNo}<=" & CStr(mToOpyVchNo) & " and {vewOutdPymt.OphVtmCode}=" & CStr(mOpyVtmCode) & " and {vewOutdPymt.OphCmpCode}=" & CStr(sFinYrCmpCode)
...
If mCallSource = "Keydown" Then
    If Mfgrd1.Row < Mfgrd1.Rows - 1 And optDetailed.Value = True And datRecset.BOF = False And datRecset.EOF = False Then
        fcmbOpyVtmName.BoundText = CStr(datRecset.fields("OphVtmCode"))
        txtOpyVtmName(1).Text = fcmbOpyVtmName.Text
        mskOpyVchNo(1).Text = datRecset.fields("OphVchNo")
        mskOpyVchNo(2).Text = datRecset.fields("OphVchNo")
        ' ----------------
...
ElseIf mCallSource = "SaveEvent" Then
    txtOpyVtmName(1).Text = fcmbOpyVtmName.Text
    mskOpyVchNo(1).Text = CStr(Val(UnMyNumFmt(mskOpyVchNo(0).Text)))
    mskOpyVchNo(2).Text = CStr(Val(UnMyNumFmt(mskOpyVchNo(0).Text)))
    ' ----------------
    Call AssignPrintPara
    frPrintCRList.ZOrder
    frPrintCRList.Visible = True
...
If Dir(OutdPymtCRLFileFullPath) = "" Then
    fhand = FreeFile
    Open OutdPymtCRLFileFullPath For Output As #fhand
    Write #fhand, "Outdoor (Receipt) Payment", "OutdPymt.Rpt", True
    Close #fhand
End If

cmbCRList.Clear
fhand = FreeFile
Open OutdPymtCRLFileFullPath For Input As #fhand
Do While EOF(fhand) = False
    Input #fhand, mCRLTitle, mCRLFileName, mCRLDefault
    If Dir(OutdPymtCRLFileFullPath(mFileName:=mCRLFileName)) <> "" Then
        cmbCRList.AddItem mCRLTitle & Space(100) & OutdPymtCRLFileFullPath(mFileName:=mCRLFileName)
