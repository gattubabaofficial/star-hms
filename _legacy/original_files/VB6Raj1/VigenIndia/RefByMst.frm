...
Dim clsAH As clsAccountHead, clsRBY As clsVgnMasterEntry, clsRFG As clsVgnMasterEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
...
If txtRByName.Text <> mRByName_old Then
    If ChkIsDuplicate(dbVgnDatabase, "RefByMast", "RByName", txtRByName.Text, "RByCode", Val(mskFormBoundField.Text)) = True Then
...
fcmbAhName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbVgnDatabase, mTableName:="RefByMast", mColumnName:="RByAhCode", mOrderByColName:="RByCode", mRtnDefValue:=0))
txtAhName.Text = fcmbAhName.Text
