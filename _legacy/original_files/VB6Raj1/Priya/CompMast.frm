...
Dim dbCmpDatabase As New ADODB.Connection, tRecset As New ADODB.Recordset, mCanLogin As Boolean
...
If FormAddEditMode = cFORM_SMRYMODE Then
    If Screen.ActiveControl.Name = Mfgrd3.Name Then
        Call SmryList1
...
Mfgrd2.Rows = 2: Mfgrd2.FixedRows = 1: Mfgrd2.FixedCols = 0: Mfgrd2.Cols = X2MFGRD2_COLS
colcnt = X2CMPCODE_COL: Mfgrd2.ColWidth(colcnt) = mskCmpCode.Width: Mfgrd2.TextMatrix(0, colcnt) = "Code": Mfgrd2.ColAlignment(colcnt) = 8
colcnt = X2CMPFYSTARTDT_COL: Mfgrd2.ColWidth(colcnt) = dtpCmpFYStartDt.Width: Mfgrd2.TextMatrix(0, colcnt) = "Start Date": Mfgrd2.ColAlignment(colcnt) = 2
colcnt = X2CMPFYENDDT_COL: Mfgrd2.ColWidth(colcnt) = dtpCmpFYEndDt.Width: Mfgrd2.TextMatrix(0, colcnt) = "End Date": Mfgrd2.ColAlignment(colcnt) = 2
colcnt = X2CMPSECPWDSTR_COL: Mfgrd2.ColWidth(colcnt) = txtCmpSecPwd.Width: Mfgrd2.TextMatrix(0, colcnt) = "[Password]": Mfgrd2.ColAlignment(colcnt) = 2
colcnt = X2CMPSECPWD_COL: Mfgrd2.ColWidth(colcnt) = 0: Mfgrd2.TextMatrix(0, colcnt) = "X2CMPSECPWD_COL": Mfgrd2.ColAlignment(colcnt) = 2
colcnt = X2CMPRECSTATE_COL: Mfgrd2.ColWidth(colcnt) = 0: Mfgrd2.TextMatrix(0, colcnt) = "X2CMPRECSTATE_COL": Mfgrd2.ColAlignment(colcnt) = 8
...
If FormAddEditMode = cFORM_ADDMODE Then
    ...
    CreatePmtCmpDatabase mAddMode:=True
    CreatePmtMastDatabase mAddMode:=True
...
clsListStru.AddFields mExpr:="CmpName", mTitle:="Company Name", mAlign:=flexAlignLeftCenter, mWidth:=4000, mShowItem:=True
clsListStru.AddFields mExpr:="CmpBookStartDt", mTitle:="Start Date", mAlign:=flexAlignLeftCenter, mWidth:=1500, mShowItem:=True
clsListStru.AddFields mExpr:="CmpBookEndDt", mTitle:="End Date", mAlign:=flexAlignLeftCenter, mWidth:=1500, mShowItem:=True
clsListStru.AddFields mExpr:="DirName", mTitle:="Directory", mAlign:=flexAlignLeftCenter, mWidth:=2000, mShowItem:=True
...
clsListStru.AddFields mExpr:="CmpName", mTitle:="Company Name", mAlign:=flexAlignLeftCenter, mWidth:=4000, mShowItem:=True
clsListStru.AddFields mExpr:="CmpFYStartDt", mTitle:="Start Date", mAlign:=flexAlignLeftCenter, mWidth:=1500, mShowItem:=True
clsListStru.AddFields mExpr:="CmpFYEndDt", mTitle:="End Date", mAlign:=flexAlignLeftCenter, mWidth:=1500, mShowItem:=True
clsListStru.AddFields mExpr:="DirName", mTitle:="Directory", mAlign:=flexAlignLeftCenter, mWidth:=2000, mShowItem:=True
clsListStru.AddFields mExpr:="CmpBookStartDt", mTitle:="Start Date", mAlign:=flexAlignLeftCenter, mWidth:=1500, mShowItem:=False
clsListStru.AddFields mExpr:="CmpBookEndDt", mTitle:="End Date", mAlign:=flexAlignLeftCenter, mWidth:=1500, mShowItem:=False
