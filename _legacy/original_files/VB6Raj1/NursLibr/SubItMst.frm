...
Dim dbNcbDatabase As New ADODB.Connection, dbStDatabase As New ADODB.Connection, dbGrpDatabase As New ADODB.Connection, datRecset As New ADODB.Recordset
Dim mSimName_old As String, mSimMRPRate_old As Double
Dim clsSIM As clsNcbMasterEntry, clsSIG As clsNcbMasterEntry, clsIT As clsProduct, mActiveControl As Object, clsListStru As clsSelectQueryStructure
Dim fcmbSigName As clsNcbFlexSearch
...
If txtSimName.Text <> mSimName_old Then
    If ChkIsDuplicate(dbNcbDatabase, "SubItmMast", "SimName", txtSimName.Text, "SimCode", Val(mskFormBoundField.Text)) = True Then
