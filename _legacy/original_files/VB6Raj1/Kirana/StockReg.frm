...
Dim mPurCode As Long, mPrtCode As Long, mQryPrtCode As Long, mQrySimCode As Long, mQryVtmCode As Long, mOpgOldPurCode As Long
...
Dim dbAcDatabase As New ADODB.Connection, dbKgtDatabase As New ADODB.Connection, dbGrpDatabase As New ADODB.Connection, dbComDatabase As New ADODB.Connection
...
Dim fcmbPrtName As clsKgtFlexSearch, fcmbSimName As clsKgtFlexSearch
Dim frmTrn As Form
...
If mRemoteAccess = True Then
    'datRecset.Open "Select * from PurchDtl left join PartyMast on PurchDtl.PurPrtCode=PartyMast.PrtCode where PurCode=" & CStr(mPurCode) & " order by PurDate,OpgTime", dbKgtDatabase, adOpenKeyset, adLockOptimistic
Else
    'datRecset.Open "Select * from PurchDtl left join PartyMast on PurchDtl.PurPrtCode=PartyMast.PrtCode order by PurDate,OpgTime", dbKgtDatabase, adOpenKeyset, adLockOptimistic
End If
Mfgrd1.FixedCols = 0
Call SmryList
...
Dim mOpnCount_Tot As Double, mOpnOutPckQty_Tot As Double, mOpnQty_Tot As Double, mOpnAmount_Tot As Double
Dim mPurCount_Tot As Double, mPurOutPckQty_Tot As Double, mPurQty_Tot As Double, mPurAmount_Tot As Double
Dim mSalCount_Tot As Double, mSalOutPckQty_Tot As Double, mSalQty_Tot As Double, mSalAmount_Tot As Double
Dim mBalCount_Tot As Double, mBalOutPckQty_Tot As Double, mBalQty_Tot As Double, mBalAmount_Tot As Double
...
If optMonthwise.Value = True Or optDatewise.Value = True Or optPartywise.Value = True Or optItemWise.Value = True Or optVTypewise.Value = True Then
    If optMonthwise.Value = True Then
        ...
        clsListStru.AddFields mExpr:="TrnPurOutPckQty_sum", mTitle:="In.Pack/Bag", mShowItem:=True, mAlign:=7, mWidth:=1250
        ...
        clsListStru.AddFields mExpr:="TrnSalOutPckQty_sum", mTitle:="Out.Pack", mShowItem:=True, mAlign:=7, mWidth:=1250
        ...
        clsListStru.AddFields mExpr:="TrnBalOutPckQty_sum", mTitle:="Bal.Pack", mShowItem:=True, mAlign:=7, mWidth:=1250
        ...
        mQryStr = mQryStr & "Select PurDate as TrnDate" _
         & ",'Pur' as TrnPurType,0 as TrnPurOutPckQty,0 as TrnPurQty,0 as TrnPurAmount" _
         & ",'Sal' as TrnSalType,0 as TrnSalOutPckQty,0 as TrnSalQty,0 as TrnSalAmount" _
         & ",'Bal' as TrnBalType,0 as TrnBalOutPckQty,0 as TrnBalQty,0 as TrnBalAmount" _
         & " from PurchDtl" _
        ...
        If chkFByOpnStock.Value = vbChecked Then
            ...
            mQryStr = mQryStr & " Select #" & CStr(ToSysDate(Ctod(dtpFromDate.Text) - 1)) & "# as TrnDate" _
             & ",'Pur' as TrnPurType,PurOutPckQty as TrnPurOutPckQty,PurQty as TrnPurQty,PurAmount as TrnPurAmount" _
             & ",'Sal' as TrnSalType,0 as TrnSalOutPckQty,0 as TrnSalQty,0 as TrnSalAmount" _
             & ",'Bal' as TrnBalType,PurOutPckQty as TrnBalOutPckQty,PurQty as TrnBalQty,PurAmount as TrnBalAmount" _
             & " from PurchDtl" _
             & " inner join (PurchHdr inner join VTypMast on PurchHdr.PuhVtmCode = VTypMast.VtmCode) on PurchDtl.PurCode = PurchHdr.PuhCode" _
            ...
            mQryStr = mQryStr & " Select #" & CStr(ToSysDate(Ctod(dtpFromDate.Text) - 1)) & "# as TrnDate" _
             & ",'Pur' as TrnPurType,0 as TrnPurOutPckQty,0 as TrnPurQty,0 as TrnPurAmount" _
             & ",'Sal' as TrnSalType,SalOutPckQty  as TrnSalOutPckQty,SalQty  as TrnSalQty,SalAmount  as TrnSalAmount" _
             & ",'Bal' as TrnBalType,SalOutPckQty * -1 as TrnBalOutPckQty,SalQty * -1 as TrnBalQty,SalAmount * -1 as TrnBalAmount" _
             & " from SaleDtl" _
             & " inner join (SaleHdr inner join VTypMast on SaleHdr.SahVtmCode = VTypMast.VtmCode) on SaleDtl.SalCode = SaleHdr.SahCode" _
             & " where SalCode > 0 and VtmSysCode IN (" & cKGT_VTYPE_SALELIST & "," & CStr(cCOM_VTYPE_RETNOUTW) & ")" _
        ...
        If chkFBySale.Value = vbChecked = True Then
            ...
            mQryStr = mQryStr & " Select SalDate as TrnDate" _
             ...
             & " and SalCode > 0 and VtmSysCode IN (" & cKGT_VTYPE_SALELIST & ")" _
             & IIf(mQryPrtCode > 0, " and SahPrtCode = " & CStr(mQryPrtCode), "") _
             & IIf(mQrySimCode > 0, " and SalSimCode = " & CStr(mQrySimCode), "") _
             & IIf(mQryVtmCode > 0, " and SahVtmCode = " & CStr(mQryVtmCode), "")
        End If
    ...
    ElseIf optDatewise.Value = True Then
        ...
        clsListStru.AddFields mExpr:="TrnPurCount", mTitle:="In.Count", mShowItem:=False, mAlign:=7, mWidth:=1100
        clsListStru.AddFields mExpr:="TrnPurOutPckQty_sum", mTitle:="In.Pack", mShowItem:=True, mAlign:=7, mWidth:=1250
        clsListStru.AddFields mExpr:="TrnPurQty_sum", mTitle:="In.Qty", mShowItem:=True, mAlign:=7, mWidth:=1250
        clsListStru.AddFields mExpr:="TrnPurAmount_sum", mTitle:="In.Amount", mShowItem:=False, mAlign:=7, mWidth:=1350
        clsListStru.AddFields mExpr:="TrnSalCount", mTitle:="Out.Count", mShowItem:=False, mAlign:=7, mWidth:=1100
        clsListStru.AddFields mExpr:="TrnSalOutPckQty_sum", mTitle:="Out.Pack", mShowItem:=True, mAlign:=7, mWidth:=1250
    ...
    ElseIf optPartywise.Value = True Then
        ...
        clsListStru.AddFields mExpr:="TrnOpnOutPckQty_sum", mTitle:="Opn.Pack", mShowItem:=True, mAlign:=7, mWidth:=1250
        ...
        mQryStr = "Select prt.PrtName,t1.TrnPrtCode" _
         & ",Count(TrnOpnType) as TrnOpnCount" _
         & ",Sum(TrnOpnOutPckQty) as TrnOpnOutPckQty_sum" _
        ...
        mQryStr = mQryStr & "Select PurPrtCode as TrnPrtCode" _
         & ",'Opn' as TrnOpnType,0 as TrnOpnOutPckQty,0 as TrnOpnQty,0 as TrnOpnAmount" _
         & ",'Pur' as TrnPurType,0 as TrnPurOutPckQty,0 as TrnPurQty,0 as TrnPurAmount" _
         & ",'Sal' as TrnSalType,0 as TrnSalOutPckQty,0 as TrnSalQty,0 as TrnSalAmount" _
         & ",'Bal' as TrnBalType,0 as TrnBalOutPckQty,0 as TrnBalQty,0 as TrnBalAmount" _
         & " from PurchDtl" _
        ...
        If chkFByOpnStock.Value = vbChecked Then
            ...
            mQryStr = mQryStr & " UNION ALL "
            mQryStr = mQryStr & " Select PurPrtCode as TrnPrtCode" _
             & ",'Opn' as TrnOpnType,PurOutPckQty as TrnOpnOutPckQty,PurQty as TrnOpnQty,PurAmount as TrnOpnAmount" _
             & ",'Pur' as TrnPurType,0 as TrnPurOutPckQty,0 as TrnPurQty,0 as TrnPurAmount" _
             & ",'Sal' as TrnSalType,0 as TrnSalOutPckQty,0 as TrnSalQty,0 as TrnSalAmount" _
             & ",'Bal' as TrnBalType,PurOutPckQty as TrnBalOutPckQty,PurQty as TrnBalQty,PurAmount as TrnBalAmount" _
             & " from PurchDtl" _
            ...
            mQryStr = mQryStr & " Select SalPrtCode as TrnPrtCode" _
             & ",'Opn' as TrnOpnType,SalOutPckQty * -1 as TrnOpnOutPckQty,SalQty * -1 as TrnOpnQty,SalAmount * -1 as TrnOpnAmount" _
             & ",'Pur' as TrnPurType,0 as TrnPurOutPckQty,0 as TrnPurQty,0 as TrnPurAmount" _
             & ",'Sal' as TrnSalType,0 as TrnSalOutPckQty,0 as TrnSalQty,0 as TrnSalAmount" _
             & ",'Bal' as TrnBalType,SalOutPckQty * -1 as TrnBalOutPckQty,SalQty * -1 as TrnBalQty,SalAmount * -1 as TrnBalAmount" _
             & " from SaleDtl" _
        ...
        Rem ----------------------------------
        mQryStr = mQryStr & ")"
        mQryStr = mQryStr & " as t1 inner join PartyMast prt on t1.TrnPrtCode = prt.PrtCode" _
         & " group by prt.PrtName,t1.TrnPrtCode" _
         & " order by prt.PrtName,t1.TrnPrtCode"
    ...
    ElseIf optItemWise.Value = True Then
        ...
        mQryStr = mQryStr & "Select 0 as TrnSimCode,'' as TrnSimName" _
         & ",'' as TrnOpnType,0 as TrnOpnOutPckQty,0 as TrnOpnQty,0 as TrnOpnAmount" _
         & ",'' as TrnPurType,0 as TrnPurOutPckQty,0 as TrnPurQty,0 as TrnPurAmount" _
         & ",'' as TrnSalType,0 as TrnSalOutPckQty,0 as TrnSalQty,0 as TrnSalAmount" _
         & ",'' as TrnBalType,0 as TrnBalOutPckQty,0 as TrnBalQty,0 as TrnBalAmount" _
         & " from (PurchDtl" _
         & " inner join (PurchHdr inner join VTypMast on PurchHdr.PuhVtmCode = VTypMast.VtmCode) on PurchDtl.PurCode = PurchHdr.PuhCode)" _
...
ElseIf optExpanded.Value = True Then
    ...
    ' --------------------------------------
    clsListStru.AddFields mExpr:="TrnOutPckQty", mTitle:="Pack/Bag", mAlign:=7, mWidth:=1250, mShowItem:=True
...
'''    clsListStru.AddFields mExpr:="PatStnName", mTitle:="Station", mAlign:=1, mWidth:=1500, mShowItem:=True
    ...
    mQryStr = mQryStr & "Select " _
     ...
     & ",PurOutPckQty as TrnOutPckQty" _
     & ",PurQty as TrnQty" _
    ...
    If chkFBySale.Value = vbChecked = True Then
        ...
        mQryStr = mQryStr & " Select " _
         ...
         & ",SalOutPckQty as TrnOutPckQty" _
         & ",SalQty as TrnQty" _
...
'''    clsListStru.AddFields mExpr:="PatStnName", mTitle:="Station", mAlign:=1, mWidth:=1500, mShowItem:=True
    ...
    mQryStr = mQryStr & "Select " _
     ...
     & ",PuhVchNo as TrnVchNo" _
     & ",PuhVtmCode as TrnVtmCode" _
     & ",PuhOutPckQty as TrnOutPckQty" _
     & ",PuhQty as TrnQty" _
    ...
    If chkFBySale.Value = vbChecked = True Then
        ...
        mQryStr = mQryStr & " Select " _
         ...
         & ",SahVchNo as TrnVchNo" _
         & ",SahVtmCode as TrnVtmCode" _
         & ",SahOutPckQty as TrnOutPckQty" _
         & ",SahQty as TrnQty" _
         ...
         & " and SahCode > 0 and VtmSysCode IN (" & cKGT_VTYPE_SALELIST & ")" _
         & IIf(mQryPrtCode > 0, " and SahPrtCode = " & CStr(mQryPrtCode), "") _
         & IIf(mQryVtmCode > 0, " and SahVtmCode = " & CStr(mQryVtmCode), "")
    End If
    Rem purchase return
...
mOpnCount_Tot = 0: mOpnOutPckQty_Tot = 0: mOpnQty_Tot = 0: mOpnAmount_Tot = 0
mPurCount_Tot = 0: mPurOutPckQty_Tot = 0: mPurQty_Tot = 0: mPurAmount_Tot = 0
mSalCount_Tot = 0: mSalOutPckQty_Tot = 0: mSalQty_Tot = 0: mSalAmount_Tot = 0
mBalCount_Tot = 0: mBalOutPckQty_Tot = 0: mBalQty_Tot = 0: mBalAmount_Tot = 0
...
If .RecordCount > 0 Then
    Do While .EOF = False
        If optDetailed.Value = True Or optExpanded.Value = True Then
            ...
            mOutPckQty_Tot = mOutPckQty_Tot + .fields("TrnOutPckQty")
            mQty_Tot = mQty_Tot + .fields("TrnQty")
            mAmount_Tot = mAmount_Tot + .fields("TrnAmount")
            
        Else
            If optItemWise.Value = True Or optPartywise.Value = True Then
                mOpnCount_Tot = mOpnCount_Tot + .fields("TrnOpnCount")
                mOpnOutPckQty_Tot = mOpnOutPckQty_Tot + .fields("TrnOpnOutPckQty_sum")
            ...
            mPurOutPckQty_Tot = mPurOutPckQty_Tot + .fields("TrnPurOutPckQty_sum")
            ...
            mSalOutPckQty_Tot = mSalOutPckQty_Tot + .fields("TrnSalOutPckQty_sum")
            ...
            mBalOutPckQty_Tot = mBalOutPckQty_Tot + .fields("TrnBalOutPckQty_sum")
        ...
        If optMonthwise.Value = True Then
            ...
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnPurOutPckQty_sum")) = ToMyNumFmt(.fields("TrnPurOutPckQty_sum"), mDecimals:=-1)
            ...
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnSalOutPckQty_sum")) = ToMyNumFmt(.fields("TrnSalOutPckQty_sum"), mDecimals:=-1)
            ...
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnBalOutPckQty_sum")) = ToMyNumFmt(mBalOutPckQty_Tot, mDecimals:=-1)
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnBalQty_sum")) = ToMyNumFmt(mBalQty_Tot, mDecimals:=-1)
        ...
        ElseIf optPartywise.Value = True Then
            ...
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnOpnOutPckQty_sum")) = ToMyNumFmt(.fields("TrnOpnPckQty_sum"), mDecimals:=-1)
            ...
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnBalOutPckQty_sum")) = ToMyNumFmt(.fields("TrnBalOutPckQty_sum"), mDecimals:=-1)
        ...
        ElseIf optItemWise.Value = True Then
            ...
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnOpnCount")) = ToMyNumFmt(.fields("TrnOpnCount"), mDecimals:=0)
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnOpnOutPckQty_sum")) = ToMyNumFmt(.fields("TrnOpnOutPckQty_sum"), mDecimals:=-1)
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnOpnQty_sum")) = ToMyNumFmt(.fields("TrnOpnQty_sum"), mDecimals:=-1)
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnOpnAmount_sum")) = ToMyNumFmt(.fields("TrnOpnAmount_sum"))
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnPurCount")) = ToMyNumFmt(.fields("TrnPurCount"), mDecimals:=0)
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnPurOutPckQty_sum")) = ToMyNumFmt(.fields("TrnPurOutPckQty_sum"), mDecimals:=-1)
        ...
        ElseIf optDetailed.Value = True Or optExpanded.Value = True Then
            ...
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnDate")) = Dtoc(.fields("TrnDate"))
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnOutPckQty")) = ToMyNumFmt(.fields("TrnOutPckQty"), mDecimals:=-1)
...
If optMonthwise.Value = True Then
    ...
    Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnPurOutPckQty_sum")) = ToMyNumFmt(mPurOutPckQty_Tot, mDecimals:=-1)
    ...
    Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnSalOutPckQty_sum")) = ToMyNumFmt(mSalOutPckQty_Tot, mDecimals:=-1)
    ...
    Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnBalCount")) = ""
    Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnBalOutPckQty_sum")) = ""
    Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnBalQty_sum")) = ""
    Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnBalAmount_sum")) = ""
...
ElseIf optPartywise.Value = True Then
    ...
    Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnOpnOutPckQty_sum")) = ToMyNumFmt(mOpnOutPckQty_Tot, mDecimals:=-1)
...
ElseIf optDetailed.Value = True Or optExpanded.Value = True Then
    ...
    Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnOutPckQty")) = ToMyNumFmt(mOutPckQty_Tot, mDecimals:=-1)
    ...
    If srow < Mfgrd1.Rows - 1 And (optDetailed.Value = True Or optExpanded.Value = True) Then
        ...
        If mTrnCode > 0 Then
            ...
            Case cKGT_VTYPE_WSLSALES
                ...
                Load frmTrn
                frmTrn.FormSysVchType = cKGT_VTYPE_WSLSALES
                frmTrn.RemoteAccessCode = mTrnCode
                Call frmTrn.Form_Load
                frmTrn.Show 1
                Me.ZOrder
            ...
            Case cKGT_VTYPE_SWLSALES
                Set frmTrn = New frmSalesInv
                Load frmTrn
                frmTrn.FormSysVchType = cKGT_VTYPE_SWLSALES
                frmTrn.RemoteAccessCode = mTrnCode
                Call frmTrn.Form_Load
                frmTrn.Show 1
                Me.ZOrder
            ...
            Case cKGT_VTYPE_RTLSALES
                Set frmTrn = New frmSalesInv
                Load frmTrn
                frmTrn.FormSysVchType = cKGT_VTYPE_RTLSALES
                frmTrn.RemoteAccessCode = mTrnCode
                Call frmTrn.Form_Load
                frmTrn.Show 1
                Me.ZOrder
