...
Dim dbAcDatabase As New ADODB.Connection, dbStDatabase As New ADODB.Connection, dbHmsDatabase As New ADODB.Connection, dbMdsDatabase As New ADODB.Connection, dbGrpDatabase As New ADODB.Connection, dbComDatabase As New ADODB.Connection
...
Dim clsPRT As clsHmsMasterEntry, clsSIM As clsHmsMasterEntry
Dim mActiveControl As Object, clsListStru As clsSelectQueryStructure
Dim fcmbVtmName As clsComFlexSearch
Dim fcmbPrtName As clsHmsFlexSearch, fcmbSimName As clsHmsFlexSearch, fcmbSimRefNo As clsHmsFlexSearch
...
Set clsSAL.dbHmsDatabase = dbHmsDatabase
...
Set fcmbSimRefNo = New clsHmsFlexSearch
Set fcmbSimRefNo.dbHmsDatabase = dbHmsDatabase
