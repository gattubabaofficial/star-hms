...
Begin VB.Form frmMedItemMast 
   ...
   Begin VB.ComboBox cmbFormEntryMode 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "MedItmMs.frx":0000
      Left            =   0
      List            =   "MedItmMs.frx":000D
   ...
   End
End
Attribute VB_Name = "frmMedItemMast"
...
Dim dbVgnDatabase As New ADODB.Connection, dbStDatabase As New ADODB.Connection, dbGrpDatabase As New ADODB.Connection, datRecset As New ADODB.Recordset
Dim mMdiName_old As String, mMdiMRPRate_old As Double
Dim clsMDI As clsVgnMasterEntry, clsMIG As clsVgnMasterEntry, clsIT As clsProduct, mActiveControl As Object, clsListStru As clsSelectQueryStructure
Dim fcmbMigName As clsVgnFlexSearch
...
Set fcmbMigName = New clsVgnFlexSearch
Set fcmbMigName.dbVgnDatabase = dbVgnDatabase
...
If txtMdiName.Text <> mMdiName_old Then
    If ChkIsDuplicate(dbVgnDatabase, "MedItmMast", "MdiName", txtMdiName.Text, "MdiCode", Val(mskFormBoundField.Text)) = True Then
