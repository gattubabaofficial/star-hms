...
Dim cmdComMaster As Object, cmdPyrMaster As Object, cmdPartyMast As Object, cmdSubItemMast As Object, cmdSubItemGrpMast As Object, cmdPartyGrpMast As Object, cmdCreditLimitMast As Object, cmdOpnStock As Object
...
Case cmdCheckDataStru
    ...
    Rem canteen database
    CreateCtnCmpDatabase mAddMode:=False, FormProgStatus:=MyProgStatForm
    CreateCtnMastDatabase mAddMode:=False, FormProgStatus:=MyProgStatForm
    CreateCtnTranDatabase mAddMode:=False, FormProgStatus:=MyProgStatForm
    CreateCtnComDatabase FormProgStatus:=MyProgStatForm
...
Case cmdCreditLimitMast
    Load frmCreditLimitDtl
    frmCreditLimitDtl.Show 1
Case cmdOpnStock
...
Set cmdPartyMast = cmdMasterMenu(2): cmdPartyMast.Caption = "&Party Master"
Set cmdSubItemMast = cmdMasterMenu(3): cmdSubItemMast.Caption = "&Item Master"
Set cmdPartyGrpMast = cmdMasterMenu(4): cmdPartyGrpMast.Caption = "Party G&roup Master"
Set cmdSubItemGrpMast = cmdMasterMenu(5): cmdSubItemGrpMast.Caption = "Item &Group Master"
Set cmdCreditLimitMast = cmdMasterMenu(6): cmdCreditLimitMast.Caption = "&Credit Limit"
Set cmdOpnStock = cmdMasterMenu(7): cmdOpnStock.Caption = "&Opening Stock"
...
Set cmdComMaster = Nothing: Set cmdPyrMaster = Nothing: Set cmdPartyMast = Nothing: Set cmdPartyGrpMast = Nothing: Set cmdSubItemMast = Nothing: Set cmdSubItemGrpMast = Nothing: Set cmdOpnStock = Nothing: Set cmdCreditLimitMast = Nothing
