...
Begin VB.Form frmOutdoorBlPymtRcpt 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ClientHeight    =   10860
   ClientLeft      =   60
   ...
   Begin VB.ComboBox cmbFormEntryMode 
      ...
      Enabled         =   0   'False
      Height          =   315
      ItemData        =   "OpdBlPRc.frx":0000
      Left            =   0
      List            =   "OpdBlPRc.frx":000D
   ...
   End
End
Attribute VB_Name = "frmOutdoorBlPymtRcpt"
...
Dim clsJRN As clsJournal, clsAH As clsAccountHead, clsOPG As clsHmsSnglTranEntry, clsOBL As clsHmsOpdMultiTranEntry, clsOBPY As clsHmsOpdMultiTranEntry, clsARA As clsComMastEntry, clsSTN As clsComMastEntry, clsVTM As clsComMastEntry, clsHOPT As clsHmsOpdOptionsEntry
...
Dim fcmbOldOpgByOpgNo As clsHmsFlexSearch, fcmbOldOpgByPttRegNo As clsHmsFlexSearch, fcmbOldOpgByPttName As clsHmsFlexSearch, fcmbPttName As clsHmsFlexSearch, fcmbPttRegNo As clsHmsFlexSearch, fcmbOblVchNo As clsHmsFlexSearch
...
If cmdOK.Caption = "&OK" And dtlEditCanceled = False Then
    ...
    .mTrnSno_int = Val(UnMyNumFmt(mskObpySno.Text))
    ...
    With tRecset
    .Open "Select * from OutdBlPymtDtl where ObpyCode=" & CStr(mObpyCode) & " and ObpyICode=" & CStr(mObpyICode) & "", dbHmsDatabase, adOpenKeyset, adLockOptimistic
...
clsHOPT.blnOutdBlPymtOptMast = True
clsHOPT.Init
clsHOPT.GetOutdBlPymtOptData
...
Set clsOBPY = New clsHmsOpdMultiTranEntry
Set clsOBPY.dbAcDatabase = dbAcDatabase
Set clsOBPY.dbHmsDatabase = dbHmsDatabase
...
fcmbObpyVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cHMS_VTYPE_OUTDOOR_BLPYMT) & " order by VtmName"
fcmbObpyVtmName.Init

Set fcmbOblVchNo = New clsHmsFlexSearch
Set fcmbOblVchNo.dbHmsDatabase = dbHmsDatabase
...
If mRemoteAccess = True Then
    datRecset.Open "Select * from OutdBlPymtHdr inner join PatMast on OutdBlPymtHdr.ObphPttCode=PatMast.PttCode where ObphCode=" & CStr(mObpyCode) & " order by ObphDate,ObphTime", dbHmsDatabase, adOpenKeyset, adLockOptimistic
Else
    datRecset.Open "Select * from OutdBlPymtHdr inner join PatMast on OutdBlPymtHdr.ObphPttCode=PatMast.PttCode order by ObphDate,ObphTime", dbHmsDatabase, adOpenKeyset, adLockOptimistic
End If
Mfgrd1.FixedCols = 0
Call SmryList

Mfgrd2.FixedRows = 1: Mfgrd2.FixedCols = 0: Mfgrd2.Rows = 2: Mfgrd2.Cols = MFGRD2_COLS
colcnt = X2OBPYICODE_COL: Mfgrd2.ColWidth(colcnt) = 0: Mfgrd2.TextMatrix(0, colcnt) = "X2OBPYICODE_COL": Mfgrd2.ColAlignment(colcnt) = 8
colcnt = X2OBPYSNO_COL: Mfgrd2.ColWidth(colcnt) = mskObpySno.Width: Mfgrd2.TextMatrix(0, colcnt) = "Sno": Mfgrd2.ColAlignment(colcnt) = 8
colcnt = X2OBLVCHNO_COL: Mfgrd2.ColWidth(colcnt) = mskOblVchNo.Width: Mfgrd2.TextMatrix(0, colcnt) = "Vch.No": Mfgrd2.ColAlignment(colcnt) = 8
...
colcnt = X2OBLAMTAFTDISC_COL: Mfgrd2.ColWidth(colcnt) = mskOblAmtAftDisc.Width: Mfgrd2.TextMatrix(0, colcnt) = "Amount": Mfgrd2.ColAlignment(colcnt) = 8
colcnt = X2OBLDEPOAMTEXCL_COL: Mfgrd2.ColWidth(colcnt) = mskOblDepoAmtExcl.Width: Mfgrd2.TextMatrix(0, colcnt) = "PreDepo.Amt": Mfgrd2.ColAlignment(colcnt) = 8
colcnt = X2OBPYDEPOAMT_COL: Mfgrd2.ColWidth(colcnt) = mskObpyDepoAmt.Width: Mfgrd2.TextMatrix(0, colcnt) = "Depo.Amt": Mfgrd2.ColAlignment(colcnt) = 8
colcnt = X2OBLREFUAMT_COL: Mfgrd2.ColWidth(colcnt) = mskOblRefuAmt.Width: Mfgrd2.TextMatrix(0, colcnt) = "Refund.Amt": Mfgrd2.ColAlignment(colcnt) = 8
colcnt = X2OBLBALAMT_COL: Mfgrd2.ColWidth(colcnt) = mskOblBalAmt.Width: Mfgrd2.TextMatrix(0, colcnt) = "Bal.Amt": Mfgrd2.ColAlignment(colcnt) = 8
colcnt = X2OBLCODE_COL: Mfgrd2.ColWidth(colcnt) = 0: Mfgrd2.TextMatrix(0, colcnt) = "X2OBLCODE_COL": Mfgrd2.ColAlignment(colcnt) = 8
colcnt = X2OBPYRECSTATE_COL: Mfgrd2.ColWidth(colcnt) = 0: Mfgrd2.TextMatrix(0, colcnt) = "X2OBPYRECSTATE_COL": Mfgrd2.ColAlignment(colcnt) = 8
...
If mPttRegNo < 0 Then
    ...
    GoTo EndSub
Else
    If mPttRegNo = 0 And clsHOPT.mObpyPttRegNoNotZero_bln = True Then
...
mObpyVchNo = Val(UnMyNumFmt(mskObpyVchNo.Text))
If mObpyVchNo > 0 Then
    If mObpyVchNo <> mObpyVchNo_old Or Val(fcmbObpyVtmName.BoundText) <> mObpyVtmCode_old Or Ctod(dtpObpyDate.Text) <> mObpyDate_old Or FormAddEditMode = cFORM_ADDMODE Then
        If ChkIsDuplVTypeNo(dbHmsDatabase, dbAcDatabase, mTableName:="OutdBlPymtHdr", mChkFieldName:="ObphVchNo", mChkFieldValue:=mObpyVchNo, mKeyFieldName:="ObphCode", mKeyFieldValue:=mObpyCode, mVtmFieldName:="ObphVtmCode", mVtmFieldValue:=Val(fcmbObpyVtmName.BoundText), mFinYrFieldName:="ObphCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="ObphDate", mDateFieldValue:=Ctod(dtpObpyDate.Text)) = True Then
            ...
            mskObpyVchNo.SetFocus
            ' ---------------
            If FormAddEditMode = True Then
                mObpyVchNo = GetNextVTypeNo(dbHmsDatabase, dbAcDatabase, dbComDatabase, mTableName:="OutdBlPymtHdr", mFieldName:="ObphVchNo", mVtmFieldName:="ObphVtmCode", mVtmFieldValue:=Val(fcmbObpyVtmName.BoundText), mFinYrFieldName:="ObphCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="ObphDate", mDateFieldValue:=Ctod(dtpObpyDate.Text), mModuleCode:=mFormUIdCode, mModuleName:=Me.Name, mAcsPermFileName:=mFormAcsPermFileName)
            Else
                mObpyVchNo = mObpyVchNo_old
            End If
            mskObpyVchNo.Text = ToMyNumFmt(mObpyVchNo, mDecimals:=0)
            GoTo EndSub
        End If
    End If
Else
...
Else
    ...
    End If
End If
If TimeToMin(txtObpyTime_str.Text) > (24 * 60) Then
    ErrorBox "Invalid Input !!!"
...
Private Sub mskObpyVchNo_GotFocus()
FlashActiveControl mskObpyVchNo, True
End Sub

Private Sub mskObpyVchNo_LostFocus()
FlashActiveControl mskObpyVchNo, False
End Sub

Private Sub mskObpyVchNo_Validate(Cancel As Boolean)
Dim mObpyVchNo As Long
mObpyVchNo = Val(UnMyNumFmt(mskObpyVchNo.Text))
If mObpyVchNo < 0 Then
    mObpyVchNo = GetNextVTypeNo(dbHmsDatabase, dbAcDatabase, dbComDatabase, mTableName:="OutdBlPymtHdr", mFieldName:="ObphVchNo", mVtmFieldName:="ObphVtmCode", mVtmFieldValue:=Val(fcmbObpyVtmName.BoundText), mFinYrFieldName:="ObphCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="ObphDate", mDateFieldValue:=Ctod(dtpObpyDate.Text), mModuleCode:=mFormUIdCode, mModuleName:=Me.Name, mAcsPermFileName:=mFormAcsPermFileName)
    mskObpyVchNo.Text = ToMyNumFmt(mObpyVchNo, mDecimals:=0)
ElseIf mObpyVchNo > 0 Then
    If mObpyVchNo <> mObpyVchNo_old Or Val(fcmbObpyVtmName.BoundText) <> mObpyVtmCode_old Or Ctod(dtpObpyDate.Text) <> mObpyDate_old Or FormAddEditMode = cFORM_ADDMODE Then
        If ChkIsDuplVTypeNo(dbHmsDatabase, dbAcDatabase, mTableName:="OutdBlPymtHdr", mChkFieldName:="ObphVchNo", mChkFieldValue:=CStr(mObpyVchNo), mKeyFieldName:="ObphCode", mKeyFieldValue:=mObpyCode, mVtmFieldName:="ObphVtmCode", mVtmFieldValue:=Val(fcmbObpyVtmName.BoundText), mFinYrFieldName:="ObphCmpCode", mFinYrFieldValue:=sFinYrCmpCode, mDateFieldName:="ObphDate", mDateFieldValue:=Ctod(dtpObpyDate.Text)) = True Then
            ErrorBox "Duplicate Voucher No. !!!"
            Cancel = True
            mskObpyVchNo.SetFocus
            ' ----------
...
If TimeToMin(txtOpgTime_str.Text) > (24 * 60) Then
    ErrorBox "Invalid Input !!!"
...
Private Sub txtObpyVtmName_Change()
If fcmbObpyVtmName.CallFromText_Change = False Then
    fcmbObpyVtmName.CallFromText_Change = True
    If InterActiveChange(txtObpyVtmName) = True Then
        fcmbObpyVtmName.UserText = Array(txtObpyVtmName.Text, txtObpyVtmName.SelStart)
        fcmbObpyVtmName.Show
        txtObpyVtmName.Text = fcmbObpyVtmName.Text
...
Private Sub txtObpyVtmName_GotFocus()
FlashActiveControl txtObpyVtmName, True
End Sub

Private Sub txtObpyVtmName_KeyDown(KeyCode As Integer, Shift As Integer)
If MyDropDownKey(Shift, KeyCode) = True Then
    Call txtObpyVtmName_Change
ElseIf MyAddNewKey(Shift, KeyCode) = True Then
...
Private Sub txtObpyVtmName_LostFocus()
FlashActiveControl txtObpyVtmName, False
End Sub

Private Sub txtObpyVtmName_Validate(Cancel As Boolean)
Dim mObpyVchNo As Long

If Val(fcmbObpyVtmName.BoundText) < 1 Then
    ErrorBox "Invalid Selection !!!"
    txtObpyVtmName.SetFocus
    Cancel = True
Else
...
fcmbObpyVtmName.BoundText = CStr(.mTrnVtmCode_lng): txtObpyVtmName.Text = fcmbObpyVtmName.Text
txtObpyPrefix.Text = .mTrnPrefix_str
mskObpyVchNo.Text = ToMyNumFmt(.mTrnVchNo_lng, mDecimals:=0)
...
fcmbObpyVtmName.BoundText = CStr(clsHOPT.GetOutdBlPymtOptBoundCode("ObpyVtmCode")): txtObpyVtmName.Text = fcmbObpyVtmName.Text
...
mObpyVchNo_old = Val(UnMyNumFmt(mskObpyVchNo.Text))
...
With tRecset
.Open "Select * from OutdBlPymtDtl where ObpyCode=" & CStr(mObpyCode) & " order by ObpySno", dbHmsDatabase, adOpenKeyset, adLockOptimistic
...
.mTrnVchNo_lng = Val(UnMyNumFmt(mskObpyVchNo.Text))
.mTrnPostfix_str = ""
.mTrnCmpCode_int = sFinYrCmpCode
...
If .mTrnCode_lng > 0 Then   ' updated successfully
    ...
    clsHOPT.mObpyVtmCodeOld_lng = .mTrnVtmCode_lng
    clsHOPT.UpdateOutdBlPymtOld
...
If optMonthwise.Value = True Or optDatewise.Value = True Or optPatientwise.Value = True Then
    If optMonthwise.Value = True Then
        ...
        clsListStru.AddFields mExpr:="ObpyMnYear", mTitle:="Month", mShowItem:=True, mAlign:=flexAlignLeftCenter, mWidth:=2000
        clsListStru.AddFields mExpr:="ObpyCount", mTitle:="Count", mShowItem:=True, mAlign:=flexAlignRightCenter, mWidth:=1500
        clsListStru.AddFields mExpr:="ObpyDepoAmt_sum", mTitle:="Recd.Amt", mShowItem:=True, mAlign:=flexAlignRightCenter, mWidth:=1500
    ...
    ElseIf optDatewise.Value = True Then
        ...
        clsListStru.AddFields mExpr:="ObpyDate", mTitle:="Date", mShowItem:=True, mAlign:=flexAlignLeftCenter, mWidth:=2000
        clsListStru.AddFields mExpr:="ObpyCount", mTitle:="Count", mShowItem:=True, mAlign:=flexAlignRightCenter, mWidth:=1500
        clsListStru.AddFields mExpr:="ObpyDepoAmt_sum", mTitle:="Recd.Amt", mShowItem:=True, mAlign:=flexAlignRightCenter, mWidth:=1500
    ...
    ElseIf optPatientwise.Value = True Then
        ...
        clsListStru.AddFields mExpr:="PttRegNo", mTitle:="Reg.No", mShowItem:=True, mAlign:=flexAlignRightCenter, mWidth:=1500
        clsListStru.AddFields mExpr:="PttRefName", mTitle:="Care of", mShowItem:=True, mAlign:=flexAlignLeftCenter, mWidth:=2000
        clsListStru.AddFields mExpr:="ObpyCount", mTitle:="Count", mShowItem:=True, mAlign:=flexAlignRightCenter, mWidth:=1500
        clsListStru.AddFields mExpr:="ObpyDepoAmt_sum", mTitle:="Recd.Amt", mShowItem:=True, mAlign:=flexAlignRightCenter, mWidth:=1500
...
ElseIf optDetailed.Value = True Then
    ...
    clsListStru.AddFields mExpr:="OblVchNo", mTitle:="Vchr.No", mAlign:=flexAlignRightCenter, mWidth:=1250, mShowItem:=True
    clsListStru.AddFields mExpr:="ObpyDate", mTitle:="Date", mAlign:=flexAlignLeftCenter, mWidth:=1300, mShowItem:=True
    ' --------------------------------------
    ...
    clsListStru.AddFields mExpr:="PttRegNo", mTitle:="Reg.No", mAlign:=flexAlignRightCenter, mWidth:=1250, mShowItem:=True
    ' --------------------------------------
    clsListStru.AddFields mExpr:="ObpyDepoAmt", mTitle:="Depo.Amt", mAlign:=flexAlignRightCenter, mWidth:=1250, mShowItem:=True
    ' --------------------------------------
    clsListStru.AddFields mExpr:="PttRefName", mTitle:="Care of", mAlign:=flexAlignLeftCenter, mWidth:=2000, mShowItem:=True
    ...
    clsListStru.AddFields mExpr:="PatPcgName", mTitle:="Category", mAlign:=flexAlignLeftCenter, mWidth:=2000, mShowItem:=True
...
Else
    If Val(fcmbOblVchNo.BoundText) <> mOblCode_old Or FormAddEditMode = cFORM_ADDMODE Then
        ...
        mskOblDepoAmtExcl.Text = ToMyNumFmt(clsOBL.mObhDepoAmt_dbl - Val(UnMyNumFmt(mskObpyDepoAmt.Text)))
...
With tRecset
.Open "Select * from OutdBlPymtHdr where ObphCode=" & CStr(mOldOblCode) & "", dbHmsDatabase, adOpenKeyset, adLockOptimistic
If .RecordCount > 0 Then
    clsVTM.GetData .fields("ObphVtmCode")
    lblOldOblCodeDesc.Caption = RTrim(clsVTM.mName_str) & " No.:" & CStr(.fields("ObphVchNo")) & " Dated:" & Dtoc(.fields("ObphDate"))
Else
...
With tRecset
.Open "Select top 1 * from OutdBlPymtHdr where ObphPttCode=" & CStr(mPttCode) & " order by ObphDate desc,ObphVchNo desc,ObphCode desc", dbHmsDatabase, adOpenKeyset, adLockOptimistic
If .RecordCount > 0 Then
