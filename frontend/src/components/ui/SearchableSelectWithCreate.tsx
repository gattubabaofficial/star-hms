...
export const SearchableSelectWithCreate: React.FC<SearchableSelectWithCreateProps> = ({
  ...
  return (
    <div className="relative w-full" ref={wrapperRef}>
      <div 
        className="flex items-center justify-between w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm cursor-text focus-within:ring-1 focus-within:ring-medical-mutedblue focus-within:border-medical-mutedblue"
      ...
      {isOpen && (
        <div className="absolute z-50 w-full mt-1 bg-white border border-gray-200 rounded-md shadow-lg max-h-60 overflow-auto">
          <ul className="py-1 text-sm text-gray-700">
            ...
            {/* Always show create new option if there's a search term or list is empty to allow adding */}
            <li 
