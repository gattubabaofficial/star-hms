...
Begin VB.Form frmOutdoorRegViewRep 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ClientHeight    =   10980
   ClientLeft      =   60
   ...
   Begin VB.ComboBox cmbPatEntryMode 
      ...
      Enabled         =   0   'False
      Height          =   315
      ItemData        =   "OpdRegVw.frx":0000
      Left            =   1560
      List            =   "OpdRegVw.frx":000D
   ...
   Begin VB.ComboBox cmbFormEntryMode 
      ...
      Enabled         =   0   'False
      Height          =   315
      ItemData        =   "OpdRegVw.frx":0034
      Left            =   0
      List            =   "OpdRegVw.frx":0041
      Style           =   1  'Simple Combo
      TabIndex        =   3
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmOutdoorRegViewRep"
...
If mRemoteAccess = True Then
    'datRecset.Open "Select * from OutdReg left join PatMast on OutdReg.OpgPttCode=PatMast.PttCode where OpgCode=" & CStr(mOpgCode) & " order by OpgDate,OpgTime", dbVgnDatabase, adOpenKeyset, adLockOptimistic
Else
    'datRecset.Open "Select * from OutdReg left join PatMast on OutdReg.OpgPttCode=PatMast.PttCode order by OpgDate,OpgTime", dbVgnDatabase, adOpenKeyset, adLockOptimistic
End If
Mfgrd1.FixedCols = 0
Call SmryList
...
If optMonthwise.Value = True Or optDatewise.Value = True Or optPatientNamewise.Value = True Or optPatientRegNoWise.Value = True Or optServiceWise.Value = True Then
    If optMonthwise.Value = True Then
        ...
        clsListStru.AddFields mExpr:="TrnMnYear", mTitle:="Month", mShowItem:=True, mAlign:=1, mWidth:=3000
        clsListStru.AddFields mExpr:="TrnCount", mTitle:="Count", mShowItem:=True, mAlign:=7, mWidth:=1500
        Rem clsListStru.AddFields mExpr:="TrnAmtAftDisc_sum", mTitle:="Recd.Amt", mShowItem:=True, mAlign:=7, mWidth:=1500
        Rem clsListStru.AddFields mExpr:="TrnDiscAmt_sum", mTitle:="Discount", mShowItem:=True, mAlign:=7, mWidth:=1500
...
'        End If
        ...
        datRecset.open mQryStr, dbVgnDatabase, adOpenKeyset, adLockReadOnly
        
    ElseIf optDatewise.Value = True Then
        clsListStru.AddFields mExpr:="TrnDateYMD", mAttrib:=cFAT_SYSTEM
        clsListStru.AddFields mExpr:="TrnDate", mTitle:="Date", mShowItem:=True, mAlign:=1, mWidth:=3000
        clsListStru.AddFields mExpr:="TrnCount", mTitle:="Count", mShowItem:=True, mAlign:=7, mWidth:=1500
        Rem clsListStru.AddFields mExpr:="TrnAmtAftDisc_sum", mTitle:="Recd.Amt", mShowItem:=True, mAlign:=7, mWidth:=1500
        Rem clsListStru.AddFields mExpr:="TrnDiscAmt_sum", mTitle:="Discount", mShowItem:=True, mAlign:=7, mWidth:=1500
...
ElseIf optDetailed.Value = True Then
    ...
    ' --------------------------------------
    Rem clsListStru.AddFields mExpr:="TrnAmtAftDisc", mTitle:="Recd.Amt", mAlign:=7, mWidth:=1250, mShowItem:=True
    Rem clsListStru.AddFields mExpr:="TrnDiscAmt", mTitle:="Discount", mAlign:=7, mWidth:=1250, mShowItem:=True
    ' --------------------------------------
    ...
    ' --------------------------------------
    clsListStru.AddFields mExpr:="OpgRemark", mTitle:="Remark/Note", mAlign:=1, mWidth:=4000, mShowItem:=True
    ...
    mQryStr = mQryStr & "Select " _
     ...
     & " where OpgDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
     & " and OpgCode > 0 and True = False" _
     & IIf(mQryPttCode > 0, " and OpgPttCode=" & CStr(mQryPttCode), "")
    Rem outdoor registration
    If chkFByOutdReg.Value = vbChecked Then
        mQryStr = mQryStr & " UNION ALL "
        mQryStr = mQryStr & " Select " _
...
'         & " and OhrCode > 0" _
'         & IIf(mQryPttCode > 0, " and OhrPttCode = " & CStr(mQryPttCode), "")
'    End If
'    Rem outdoor payment
'    If chkFByOutdPymt.Value = vbChecked Then
'        mQryStr = mQryStr & " UNION ALL "
...
'         & " where OphDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
'         & " and OphCode > 0" _
'         & IIf(mQryPttCode > 0, " and OphPttCode=" & CStr(mQryPttCode), "")
'    End If
'    Rem outdoor refund
'    If chkFByOutdRefd.Value = vbChecked Then
'        mQryStr = mQryStr & " UNION ALL "
...
'         & " where OfhDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
'         & " and OfhCode > 0" _
'         & IIf(mQryPttCode > 0, " and OfhPttCode=" & CStr(mQryPttCode), "")
'    End If
'    Rem outdoor bill payment
'    If chkFByOutdBlPymt.Value = vbChecked Then
'        mQryStr = mQryStr & " UNION ALL "
...
'         & " where ObphDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
'         & " and ObphCode > 0" _
'         & IIf(mQryPttCode > 0, " and ObphPttCode=" & CStr(mQryPttCode), "")
'    End If
'    Rem outdoor bill refund
'    If chkFByOutdBlRefd.Value = vbChecked Then
'        mQryStr = mQryStr & " UNION ALL "
...
'         & " where ObfhDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
'         & " and ObfhCode > 0" _
'         & IIf(mQryPttCode > 0, " and ObfhPttCode=" & CStr(mQryPttCode), "")
'    End If
'    Rem indoor advance ---------------------
'    If chkFByIndrReg.Value = vbChecked = True Then
'        mQryStr = mQryStr & " UNION ALL "
...
'         & IIf(mQryPttCode > 0, " and IpgPttCode=" & CStr(mQryPttCode), "")
'    End If
'    Rem indoor receipt received amount
'    If chkFByIndrRcpt.Value = vbChecked Then
'        mQryStr = mQryStr & " UNION ALL "
...
'         & " and IhrCode > 0" _
'         & IIf(mQryPttCode > 0, " and IhrPttCode=" & CStr(mQryPttCode), "")
'    End If
'    Rem indoor payment
'    If chkFByIndrPymt.Value = vbChecked Then
'        mQryStr = mQryStr & " UNION ALL "
...
'         & " where IphDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
'         & " and IphCode > 0" _
'         & IIf(mQryPttCode > 0, " and IphPttCode=" & CStr(mQryPttCode), "")
'    End If
'    Rem indoor refund
'    If chkFByIndrRefd.Value = vbChecked Then
'        mQryStr = mQryStr & " UNION ALL "
...
'         & " where IfhDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
'         & " and IfhCode > 0" _
'         & IIf(mQryPttCode > 0, " and IfhPttCode=" & CStr(mQryPttCode), "")
'    End If
'    Rem indoor bill payment
'    If chkFByIndrBlPymt.Value = vbChecked Then
'        mQryStr = mQryStr & " UNION ALL "
...
'         & " where IbphDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
'         & " and IbphCode > 0" _
'         & IIf(mQryPttCode > 0, " and IbphPttCode=" & CStr(mQryPttCode), "")
'    End If
'    Rem indoor bill refund
'    If chkFByIndrBlRefd.Value = vbChecked Then
'        mQryStr = mQryStr & " UNION ALL "
...
'         & " where IbfhDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
'         & " and IbfhCode > 0" _
'         & IIf(mQryPttCode > 0, " and IbfhPttCode=" & CStr(mQryPttCode), "")
'    End If
'    Rem indoor on a/c payment
'    If chkFByIndrRgPymt.Value = vbChecked Then
'        mQryStr = mQryStr & " UNION ALL "
...
'         & " where IgtDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
'         & " and IgtCode > 0" _
'         & IIf(mQryPttCode > 0, " and IgtPttCode=" & CStr(mQryPttCode), "")
'    End If
'    Rem indoor on a/c refund
'    If chkFByIndrRgRefd.Value = vbChecked Then
'        mQryStr = mQryStr & " UNION ALL "
...
'         & " where IgfDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
'         & " and IgfCode > 0" _
'         & IIf(mQryPttCode > 0, " and IgfPttCode=" & CStr(mQryPttCode), "")
'    End If
    Rem ----------------------------------
...
'            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnDiscAmt")) = ToMyNumFmt(.fields("TrnDiscAmt"))
            ...
            ' ------------------------------------
            Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OpgRemark")) = .fields("OpgRemark")
...
'    Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("TrnDiscAmt")) = ToMyNumFmt(mDiscAmt_Tot)
    ...
    Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OpgRemark")) = ""
...
Dim srow As Long, mTrnCode As Long, mTrnSysType As Integer
...
ElseIf Shift = vbCtrlMask And KeyCode = vbKeySpace Then
    If srow < Mfgrd1.Rows - 1 And (optDetailed.Value = True Or optExpanded.Value = True) Then
        ...
        If mTrnCode > 0 Then
            ...
            Case Else
                ErrorBox Me.Name & "_Mfgrd1_KeyDown_#3234_[Undefined]"
...
If Dir(OpdRegRepCRLFileFullPath) = "" Then
    fhand = FreeFile
    Open OpdRegRepCRLFileFullPath For Output As #fhand
...
cmbCRList.Clear
fhand = FreeFile
Open OpdRegRepCRLFileFullPath For Input As #fhand
Do While EOF(fhand) = False
    Input #fhand, mCRLTitle, mCRLFileName, mCRLDefault
    If Dir(OpdRegRepCRLFileFullPath(mFileName:=mCRLFileName)) <> "" Then
        cmbCRList.AddItem mCRLTitle & Space(100) & OpdRegRepCRLFileFullPath(mFileName:=mCRLFileName)
