...
Dim mPurSimCode_old As Long, mPurItmCode_old As Long, mPurItrCode_old As Long, mPurSimRefNo_old As String, mPurDiscPer_old As Double, mPurTaxPer_old As Double
Dim mPuhAmount_old As Double, mDiscTypeChanged As Boolean, mDiscPerChanged As Boolean, mDiscAmtChanged As Boolean, mTaxTypeChanged As Boolean, mTaxPerChanged As Boolean, mTaxAmtChanged As Boolean
Dim clsAH As clsAccountHead, clsSTK As clsStockJrn, clsPUR As clsGtdMultiTranEntry, clsARA As clsComMastEntry, clsSTN As clsComMastEntry, clsVTM As clsComMastEntry
...
Const X2PURBASICAMT_COL = 6
Const X2PURMRP_COL = 7
Const X2PURSRATE_COL = 8
Const X2PURDISCTYPENM_COL = 9
Const X2PURDISCPER_COL = 10
Const X2PURDISCABLEAMT_COL = 11
Const X2PURDISCAMT_COL = 12
Const X2PURTAXTYPENM_COL = 13
Const X2PURTAXPER_COL = 14
Const X2PURTAXABLEAMT_COL = 15
Const X2PURTAXAMT_COL = 16
Const X2PURAMOUNT_COL = 17
Const X2PURNARR_COL = 18
Const X2PURDISCTYPENO_COL = 19
Const X2PURTAXTYPENO_COL = 20
Const X2PURSIMCODE_COL = 21
Const X2PURITMCODE_COL = 22
Const X2PURITRCODE_COL = 23
Const X2PURSTKICODE_COL = 24
Const X2PURRECSTATE_COL = 25
...
If cmdOK.Caption = "&OK" And dtlEditCanceled = False Then
    ...
    With tRecset
    .Open "Select * from PurchDtl where PurCode=" & CStr(mPurCode) & " and PurICode=" & CStr(mPurICode) & "", dbGtdDatabase, adOpenKeyset, adLockOptimistic
    
    clsSIM.GetData .fields("PurSimCode")
...
Set clsPUR = New clsGtdMultiTranEntry
Set clsPUR.dbAcDatabase = dbAcDatabase
Set clsPUR.dbStDatabase = dbStDatabase
Set clsPUR.dbGtdDatabase = dbGtdDatabase
...
If mRemoteAccess = True Then
    datRecset.Open "Select * from PurchHdr" _
        ...
        & " order by PuhDate,PuhTime", dbGtdDatabase, adOpenKeyset, adLockOptimistic
...
colcnt = X2PURSRATE_COL: Mfgrd2.ColWidth(colcnt) = mskPurSRate.Width - mskPurSRate.Width: Mfgrd2.TextMatrix(0, colcnt) = "S.Rate": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2PURDISCTYPENM_COL: Mfgrd2.ColWidth(colcnt) = cmbPurDiscType.Width - cmbPurDiscType.Width: Mfgrd2.TextMatrix(0, colcnt) = "Disc.Type": Mfgrd2.ColAlignment(colcnt) = 1
...
colcnt = X2PURDISCABLEAMT_COL: Mfgrd2.ColWidth(colcnt) = mskPurDiscableAmt.Width - mskPurDiscableAmt.Width: Mfgrd2.TextMatrix(0, colcnt) = "Discable.Amt": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2PURDISCAMT_COL: Mfgrd2.ColWidth(colcnt) = mskPurDiscAmt.Width - mskPurDiscAmt.Width: Mfgrd2.TextMatrix(0, colcnt) = "Disc.Amt": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2PURTAXTYPENM_COL: Mfgrd2.ColWidth(colcnt) = cmbPurTaxType.Width - cmbPurTaxType.Width: Mfgrd2.TextMatrix(0, colcnt) = "Tax Type": Mfgrd2.ColAlignment(colcnt) = 1
...
colcnt = X2PURTAXABLEAMT_COL: Mfgrd2.ColWidth(colcnt) = mskPurTaxableAmt.Width - mskPurTaxableAmt.Width: Mfgrd2.TextMatrix(0, colcnt) = "Taxable.Amt": Mfgrd2.ColAlignment(colcnt) = 7
colcnt = X2PURTAXAMT_COL: Mfgrd2.ColWidth(colcnt) = mskPurTaxAmt.Width - mskPurTaxAmt.Width: Mfgrd2.TextMatrix(0, colcnt) = "Tax Amt": Mfgrd2.ColAlignment(colcnt) = 7
...
colcnt = X2PURSRATE_COL: mskPurSRate.Left = Mfgrd2.Left + Mfgrd2.ColPos(X2PURMRP_COL)
colcnt = X2PURDISCTYPENM_COL: cmbPurDiscType.Left = Mfgrd2.Left + Mfgrd2.ColPos(X2PURDISCPER_COL)
colcnt = X2PURDISCPER_COL: mskPurDiscPer.Left = Mfgrd2.Left + Mfgrd2.ColPos(X2PURDISCPER_COL)
colcnt = X2PURDISCABLEAMT_COL: mskPurDiscableAmt.Left = Mfgrd2.Left + Mfgrd2.ColPos(X2PURDISCPER_COL)
colcnt = X2PURDISCAMT_COL: mskPurDiscAmt.Left = Mfgrd2.Left + Mfgrd2.ColPos(X2PURDISCPER_COL)
colcnt = X2PURTAXTYPENM_COL: cmbPurTaxType.Left = Mfgrd2.Left + Mfgrd2.ColPos(X2PURTAXPER_COL)
colcnt = X2PURTAXPER_COL: mskPurTaxPer.Left = Mfgrd2.Left + Mfgrd2.ColPos(X2PURTAXPER_COL)
colcnt = X2PURTAXABLEAMT_COL: mskPurTaxableAmt.Left = Mfgrd2.Left + Mfgrd2.ColPos(X2PURTAXPER_COL)
colcnt = X2PURTAXAMT_COL: mskPurTaxAmt.Left = Mfgrd2.Left + Mfgrd2.ColPos(X2PURTAXPER_COL)
...
If KeyAscii = vbKeyReturn Then
    ...
    If dtlAddMode = True Then
        ...
        txtPurSimRefNo.Text = Left(ary1(0) & "/" & Format(Ctod(dtpPurDate.Text), "yymmdd") & "/" & txtPurTrnRefNo.Text, 25)
        Erase ary1
    Else
...
If dtlAddMode = True Or Val(UnMyNumFmt(mskPurSRate.Text)) = 0 Then
...
With tRecset
.Open "Select top 1 * from PurchHdr where PuhVtmCode IN (" & mFormVchTypeList & ") and PuhCmpCode = " & CStr(sFinYrCmpCode) & " order by PuhCode desc", dbGtdDatabase, adOpenKeyset, adLockOptimistic
If .EOF = False Then
...
With tRecset
.Open "Select * from PurchDtl where PurCode=" & CStr(mPurCode) & " order by PurSno", dbGtdDatabase, adOpenKeyset, adLockOptimistic
...
If .mTrnCode_lng > 0 Then   ' updated successfully
    ...
    If .mShrCode_lng > 0 Then
        If FormAddEditMode = cFORM_ADDMODE Then
            ...
            dbGtdDatabase.Execute "Update PurchHdr set PuhStkCode=" & CStr(mPurStkCode) & " where PuhCode=" & CStr(mPurCode)
            dbGtdDatabase.Execute "Update PurchDtl set PurStkCode=" & CStr(mPurStkCode) & " where PurCode=" & CStr(mPurCode)
...
Else    ' system field search has been requested by programmer
    ...
    ElseIf optMonthwise.Value = True Then
        SearchRawFlex Mfgrd1, clsListStru.GetItemIndex("PurYrMonth"), mText
    ElseIf optDatewise.Value = True Then
        SearchRawFlex Mfgrd1, clsListStru.GetItemIndex("PurDateYMD"), mText
    ElseIf optPartywise.Value = True Then
...
Dim mPurQty As Double, mPurRate As Double, mPurSRate As Double, mPurAmount As Double, mPurBasicAmt As Double, mPurDiscPer As Double, mPurDiscAmt As Double, mPurTaxPer As Double, mPurTaxAmt As Double
...
If mFormSysVchType = cCOM_VTYPE_RETNINW Then
    MsgBox "Pending !!!"
'''    mPurBasicAmt = Round(mPurQty * mPurSRate, 2)
'''    If dtlAddMode = True Or mPurTaxPer <> mPurTaxPer_old Or Val(UnMyNumFmt(mskPurTaxAmt.Text)) = 0 Then     ''' FormAddEditMode = cFORM_ADDMODE Or
...
Else
    mPurBasicAmt = Round(mPurQty * mPurRate, 2)
    If cmbPurDiscType.ListIndex = 1 Then
        mPurDiscableAmt = mPurBasicAmt
        Rem If mDiscTypeChanged = True Or (mTaxTypeChanged = True And cmbPurDiscType.ListIndex = 2) Or mDiscAmtChanged = False Or mPurDiscAmt = 0 Then
        If mDiscAmtChanged = False And mTaxAmtChanged = False And (mDiscTypeChanged = True Or mDiscPerChanged = True Or mTaxTypeChanged = True Or mTaxPerChanged = True) Then
            Rem If dtlAddMode = True Or mPurDiscPer <> mPurDiscPer_old Or mPurDiscAmt = 0 Then
                mPurDiscAmt = Round(CDec(mPurDiscableAmt) * CDec(mPurDiscPer) / 100, 2)
            Rem End If
        End If
        mPurTaxableAmt = mPurBasicAmt - mPurDiscAmt
        Rem If mTaxTypeChanged = True Or mDiscTypeChanged = True Or mTaxAmtChanged = False Or mPurTaxAmt = 0 Then
        If mDiscAmtChanged = False And mTaxAmtChanged = False And (mDiscTypeChanged = True Or mDiscPerChanged = True Or mTaxTypeChanged = True Or mTaxPerChanged = True) Then
            Rem If dtlAddMode = True Or mPurTaxPer <> mPurTaxPer_old Or mPurTaxAmt = 0 Then
                If cmbPurTaxType.ListIndex = 1 Then
    ...
    Else
        ...
        End If
    End If
    mPurAmount = Round(mPurBasicAmt - mPurDiscAmt + IIf(cmbPurTaxType.ListIndex = 1, mPurTaxAmt, 0), 2)
    
'''    mPurBasicAmt = Round(mPurQty * mPurRate, 2)
'''    If dtlAddMode = True Or mPurTaxPer <> mPurTaxPer_old Or Val(UnMyNumFmt(mskPurTaxAmt.Text)) = 0 Then     ''' FormAddEditMode = cFORM_ADDMODE Or
'''        mPurTaxAmt = Round(CDec(mPurBasicAmt) * CDec(mPurTaxPer) / 100, 2)
'''    Else
'''        mPurTaxAmt = Val(UnMyNumFmt(mskPurTaxAmt.Text))
'''    End If
'''    mPurAmount = Round(mPurBasicAmt + mPurTaxAmt, 2)
...
If IsMissing(mRowPos) = False Then
    ...
    mskPurSRate.Top = mRowPos + mskPurMRP.Height
    cmbPurDiscType.Top = mRowPos
    mskPurDiscPer.Top = mRowPos + cmbPurDiscType.Height
    mskPurDiscableAmt.Top = mRowPos + cmbPurDiscType.Height + mskPurDiscPer.Height
    mskPurDiscAmt.Top = mRowPos + cmbPurDiscType.Height + mskPurDiscPer.Height + mskPurDiscableAmt.Height
    cmbPurTaxType.Top = mRowPos
    mskPurTaxPer.Top = mRowPos + cmbPurTaxType.Height
    mskPurTaxableAmt.Top = mRowPos + cmbPurTaxType.Height + mskPurTaxPer.Height
    mskPurTaxAmt.Top = mRowPos + cmbPurTaxType.Height + mskPurTaxPer.Height + mskPurTaxableAmt.Height
...
cmbPurDiscType.Visible = mShowItem
mskPurDiscPer.Visible = mShowItem
mskPurDiscableAmt.Visible = mShowItem
mskPurDiscAmt.Visible = mShowItem
cmbPurTaxType.Visible = mShowItem
mskPurTaxPer.Visible = mShowItem
mskPurTaxableAmt.Visible = mShowItem
...
mDataOk = (Val(fcmbPrtName.BoundText) > 0 And Val(UnMyNumFmt(mskPurSno.Text)) > 0 And Val(fcmbSimName.BoundText) > 0 And Val(mskPurItmCode.Text) > 0 And Trim(txtPurSimRefNo.Text) <> "" _
    ...
    And Val(UnMyNumFmt(mskPurQty.Text)) > 0 And Val(UnMyNumFmt(mskPurRate.Text)) > 0 And Val(UnMyNumFmt(mskPurSRate.Text)) > 0 And Val(UnMyNumFmt(mskPurMRP.Text)) > 0 _
...
Dim mPurQtyTot As Double, mPurBasicAmtTot As Double, mPurDiscAmtTot As Double, mPurTaxAmtTot As Double
Dim mPuhBasicAmtTot As Double, mPuhDiscPer As Double, mPuhDiscableAmtTot As Double, mPuhDiscAmt As Double, mPuhTaxPer As Double, mPuhTaxableAmtTot As Double, mPuhTaxAmt As Double, mPuhOtherAmt As Double, mPuhROffAmt As Double, mPuhAmount As Double
Dim srow As Integer
...
'''For srow = .FixedRows To .Rows - 1
'''    If Val(UnMyNumFmt(.TextMatrix(srow, X2PURTAXAMT_COL))) = 0 Then
'''        mPuhBasicAmtTot = mPuhBasicAmtTot + Val(UnMyNumFmt(.TextMatrix(srow, X2PURBASICAMT_COL)))
'''    End If
'''Next srow
'''End With
'''mPuhTaxPer = Val(UnMyPerFmt(mskPuhTaxPer.Text))
...
'''mPuhROffAmt = Val(UnMyPerFmt(mskPuhROffAmt.Text))
'''If mPuhTaxPer <> 0 Then
'''    mPuhTaxAmt = CDec(mPuhBasicAmtTot) * CDec(mPuhTaxPer) / 100
'''Else
'''    mPuhTaxAmt = 0
'''End If
'''mPuhTaxAmt = mPuhTaxAmt + mPurTaxAmtTot
'''mPuhAmount = mPurBasicAmtTot + mPuhTaxAmt + mPuhOtherAmt + mPuhROffAmt
'''mskPuhTaxAmt.Text = ToMyNumFmt(mPuhTaxAmt)
'''lblPuhAmount.Caption = ToMyNumFmt(mPuhAmount)
