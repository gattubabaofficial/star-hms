...
Dim fcmbUrlName As clsVgnFlexSearch, fcmbUsrName As clsVgnFlexSearch
...
Call SmryList
Rem txtSearch1Text_InterActiveChange txtUsrName.Text
SearchRawFlex Mfgrd1, clsListStru.GetItemIndex("UhtCode"), CStr(Val(mskFormBoundField.Text))
...
Rem Standard Master
cmbSecuOptName.AddItem "Masters" & Space(100) & "<Masters>"
cmbSecuOptName.AddItem "Standard Master" & Space(100) & "<Standard Master>"
cmbSecuOptName.AddItem "Account Ledger" & Space(100) & "frmAcntHead"
cmbSecuOptName.AddItem "Product Master" & Space(100) & "frmItemMast"
cmbSecuOptName.AddItem "User Role Master" & Space(100) & "frmUserRoleMast"
cmbSecuOptName.AddItem "User Master" & Space(100) & "frmUserMast"
cmbSecuOptName.AddItem "Station Master" & Space(100) & "frmStationMast"
cmbSecuOptName.AddItem "Area Master" & Space(100) & "frmAreaMast"
cmbSecuOptName.AddItem "Voucher Type" & Space(100) & "frmVoucherType"

Rem Payroll Master
cmbSecuOptName.AddItem "Payroll Master" & Space(100) & "<Payroll Master>"
cmbSecuOptName.AddItem "Department Master" & Space(100) & "frmDepartmentMast"
cmbSecuOptName.AddItem "Designation Master" & Space(100) & "frmDesignationMast"
cmbSecuOptName.AddItem "Employee Master" & Space(100) & "frmEmployeeMast"

Rem Vigen Master
cmbSecuOptName.AddItem "Patient Category" & Space(100) & "frmPatCategoryMast"
cmbSecuOptName.AddItem "Attendant Category" & Space(100) & "frmDoctorCatgMast"
cmbSecuOptName.AddItem "Referred Category" & Space(100) & "frmRefCatgMast"
cmbSecuOptName.AddItem "Attendant Role" & Space(100) & "frmDoctorRoleMast"
cmbSecuOptName.AddItem "Attendant Master" & Space(100) & "frmDoctorMast"
cmbSecuOptName.AddItem "Referred By Master" & Space(100) & "frmRefByMast"
cmbSecuOptName.AddItem "Referred To Master" & Space(100) & "frmRefToMast"
cmbSecuOptName.AddItem "Service Group Master" & Space(100) & "frmServGroupMast"
cmbSecuOptName.AddItem "Service Master" & Space(100) & "frmServiceMast"
cmbSecuOptName.AddItem "Patient Master" & Space(100) & "frmPatientMast"
cmbSecuOptName.AddItem "Diagnostic Master" & Space(100) & "frmDiagnosticMast"
'cmbSecuOptName.AddItem "Bed Floor Master" & Space(100) & "frmFloorMast"
'cmbSecuOptName.AddItem "Bed Ward Master" & Space(100) & "frmWardMast"
'cmbSecuOptName.AddItem "Bed Master" & Space(100) & "frmBedMast"

Rem Outdoor Section
cmbSecuOptName.AddItem "Outdoor" & Space(100) & "<Outdoor>"
cmbSecuOptName.AddItem "OPD Registration" & Space(100) & "frmOutdoorReg"
'cmbSecuOptName.AddItem "OPD Receipt" & Space(100) & "frmOutdoorReceipt"
'cmbSecuOptName.AddItem "OPD Payment" & Space(100) & "frmOutdoorPymtRcpt"
'cmbSecuOptName.AddItem "OPD Refund" & Space(100) & "frmOutdoorRefdRcpt"
'cmbSecuOptName.AddItem "OPD Bill" & Space(100) & "frmOutdoorBill"
'cmbSecuOptName.AddItem "OPD Bill Payment" & Space(100) & "frmOutdoorBlPayment"
'cmbSecuOptName.AddItem "OPD Bill Refund" & Space(100) & "frmOutdoorBlRefund"

Rem Indoor Section
'cmbSecuOptName.AddItem "Indoor" & Space(100) & "<Indoor>"
'cmbSecuOptName.AddItem "IPD Registration" & Space(100) & "frmIndoorReg"
'cmbSecuOptName.AddItem "Bed Status" & Space(100) & "frmIndoorBedStatus"
'cmbSecuOptName.AddItem "IPD Receipt" & Space(100) & "frmIndoorReceipt"
'cmbSecuOptName.AddItem "IPD Payment" & Space(100) & "frmIndoorPymtRcpt"
'cmbSecuOptName.AddItem "IPD Refund" & Space(100) & "frmIndoorRefdRcpt"
'cmbSecuOptName.AddItem "IPD On A/c. Payment" & Space(100) & "frmIndoorRgPayment"
'cmbSecuOptName.AddItem "IPD On A/c. Refund" & Space(100) & "frmIndoorRgRefund"
'cmbSecuOptName.AddItem "IPD Bill" & Space(100) & "frmIndoorBill"
'cmbSecuOptName.AddItem "IPD Bill Payment" & Space(100) & "frmIndoorBlPayment"
'cmbSecuOptName.AddItem "IPD Bill Refund" & Space(100) & "frmIndoorBlRefund"

Rem Diagnostic / Lab
'cmbSecuOptName.AddItem "Diagnostic" & Space(100) & "<Diagnostic>"

Rem Store Keeping
'cmbSecuOptName.AddItem "Store Keeping" & Space(100) & "<Store Keeping>"

Rem Store Management
cmbSecuOptName.AddItem "Store Management" & Space(100) & "<Store Management>"
cmbSecuOptName.AddItem "Store Sales" & Space(100) & "frmMedicalSale"
cmbSecuOptName.AddItem "Sales Payment" & Space(100) & "frmMediSalesPayment"
cmbSecuOptName.AddItem "Store Purchase" & Space(100) & "frmMedicalPurch"

Rem General Transaction
'cmbSecuOptName.AddItem "General" & Space(100) & "<General>"
'cmbSecuOptName.AddItem "Journal Entry" & Space(100) & "frmJournal"
'cmbSecuOptName.AddItem "Stock Journal" & Space(100) & "frmStockJrn"

Rem Display Menu
cmbSecuOptName.AddItem "Display" & Space(100) & "<Display>"
cmbSecuOptName.AddItem "Registration Report" & Space(100) & "frmOutdoorRegViewRep"
cmbSecuOptName.AddItem "Stock Day Book" & Space(100) & "frmStockTranViewRep"
cmbSecuOptName.AddItem "Stock Register" & Space(100) & "frmStockRegRep"
'cmbSecuOptName.AddItem "Indoor Register" & Space(100) & "<IndrRegRepo>"
'cmbSecuOptName.AddItem "Ledger View" & Space(100) & "frmLedgerView"
'cmbSecuOptName.AddItem "Item View" & Space(100) & "frmItemView"

Rem Maintenance Menu
cmbSecuOptName.AddItem "Maintenance" & Space(100) & "<Maintenance>"
'cmbSecuOptName.AddItem "Standard Options" & Space(100) & "<Standard Options>"
'cmbSecuOptName.AddItem "Vigen Outdoor Options" & Space(100) & "frmVgnOpdOptions"
'cmbSecuOptName.AddItem "Vigen Indoor Options" & Space(100) & "frmVgnIpdOptions"
'cmbSecuOptName.AddItem "A/c Balance Reposting" & Space(100) & "<A/c Balance Reposting>"
cmbSecuOptName.AddItem "Remove Null Value" & Space(100) & "<Remove Null Value>"
cmbSecuOptName.AddItem "Check Data Structure" & Space(100) & "<Check Data Structure>"
...
Private Sub txtUsrName_KeyDown(KeyCode As Integer, Shift As Integer)
If MyDropDownKey(Shift, KeyCode) = True Then
    Call txtUsrName_Change
End If
