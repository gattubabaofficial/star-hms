Attribute VB_Name = "CtnDataStru"

Option Explicit

Public Sub CreateCtnCmpDatabase(ByVal mAddMode As Boolean, Optional ByRef FormProgStatus As frmProgressStatus)
...
Public Sub CreateCtnMastDatabase(ByVal mAddMode As Boolean, Optional ByRef FormProgStatus As frmProgressStatus)
Dim mTableStru As adTableStru, dbCtnDatabase As New ADODB.Connection, dbCtnCatalog As New ADOX.Catalog, clsDB As clsDataStru

If mAddMode = True Then
    If Dir(dbCtnDatabaseFullPath) = "" Then
        dbCtnCatalog.Create "Provider=" & DbProvider & ";Data Source=" & dbCtnDatabaseFullPath
        Set dbCtnCatalog = Nothing
    Else
        ErrorBox "Database " & dbCtnDatabaseFullPath & " already exist !!!"
        GoTo EndSub
    End If
End If
...
.AddColumn: .ColumnName() = "SimMaxAmtLimit": .ColumnType() = adDouble: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
.AddColumn: .ColumnName() = "SimMaxCountLimit": .ColumnType() = adSmallInt: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
.AddColumn: .ColumnName() = "SimPerDaysLimit": .ColumnType() = adSmallInt: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
...
.AddColumn: .ColumnName() = "SimProfitPer": .ColumnType() = adDouble: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = False
...
.AddColumn: .ColumnName() = "PrtMaxAmtLimit": .ColumnType() = adDouble: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
.AddColumn: .ColumnName() = "PrtMaxCountLimit": .ColumnType() = adSmallInt: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
.AddColumn: .ColumnName() = "PrtPerDaysLimit": .ColumnType() = adSmallInt: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
...
With clsDB
.ClearTableStru
.TableName = "CrLimitDtl"
Rem field definitions
.AddColumn: .ColumnName() = "CldICode": .ColumnType() = adInteger: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = False: .AutoIncrement() = True
.AddColumn: .ColumnName() = "CldPgmCode": .ColumnType() = adInteger: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
.AddColumn: .ColumnName() = "CldPrtCode": .ColumnType() = adInteger: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
.AddColumn: .ColumnName() = "CldSigCode": .ColumnType() = adInteger: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
.AddColumn: .ColumnName() = "CldSimCode": .ColumnType() = adInteger: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
.AddColumn: .ColumnName() = "CldMaxAmtLimit": .ColumnType() = adDouble: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
.AddColumn: .ColumnName() = "CldMaxCountLimit": .ColumnType() = adSmallInt: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
.AddColumn: .ColumnName() = "CldPerDaysLimit": .ColumnType() = adSmallInt: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
.AddColumn: .ColumnName() = "CldRemark": .ColumnType() = adVarWChar: .ColumnWidth() = 50: .ColumnRequired() = True: .AllowZeroLength() = True
.AddColumn: .ColumnName() = "CldRecState": .ColumnType() = adSmallInt: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = False
Rem primary key definition
.PrimaryKey = "CldICode"
Rem index definition
.AddIndex: .IndexName() = "CldPgmCode": .IndexColumn1() = "CldPgmCode"
.AddIndex: .IndexName() = "CldPrtCode": .IndexColumn1() = "CldPrtCode"
.AddIndex: .IndexName() = "CldSigCode": .IndexColumn1() = "CldSigCode"
.AddIndex: .IndexName() = "CldSimCode": .IndexColumn1() = "CldSimCode"
...
With clsDB
.ClearTableStru
.TableName = "CrLimitDtl_Log"
Rem field definitions
.AddColumn: .ColumnName() = "CldICode": .ColumnType() = adInteger: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = False
.AddColumn: .ColumnName() = "CldPgmCode": .ColumnType() = adInteger: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
.AddColumn: .ColumnName() = "CldPrtCode": .ColumnType() = adInteger: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
.AddColumn: .ColumnName() = "CldSigCode": .ColumnType() = adInteger: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
.AddColumn: .ColumnName() = "CldSimCode": .ColumnType() = adInteger: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = True
...
.AddColumn: .ColumnName() = "CldRecState": .ColumnType() = adSmallInt: .ColumnWidth() = Empty: .ColumnRequired() = True: .AllowZeroLength() = False
Rem primary key definition
Rem .PrimaryKey = "CldICode"
Rem index definition
.AddIndex: .IndexName() = "CldICode": .IndexUnique() = True: .IndexColumn1() = "CldICode"
.AddIndex: .IndexName() = "CldPgmCode": .IndexColumn1() = "CldPgmCode"
.AddIndex: .IndexName() = "CldPrtCode": .IndexColumn1() = "CldPrtCode"
.AddIndex: .IndexName() = "CldSigCode": .IndexColumn1() = "CldSigCode"
.AddIndex: .IndexName() = "CldSimCode": .IndexColumn1() = "CldSimCode"
...
Public Sub CreateCtnTranDatabase(ByVal mAddMode As Boolean, Optional ByRef FormProgStatus As frmProgressStatus)
Dim mTableStru As adTableStru, dbCtnDatabase As New ADODB.Connection, dbCtnCatalog As New ADOX.Catalog, clsDB As clsDataStru
...
Public Sub CreateCtnComDatabase(Optional ByRef FormProgStatus As frmProgressStatus)
...
With clsDB
.ClearLinkStru
.AddLink: .LinkTableName() = "SubItmMast": .LinkDbSource() = dbCtnDatabaseFullPath
.AddLink: .LinkTableName() = "SubItmGrpMst": .LinkDbSource() = dbCtnDatabaseFullPath
.AddLink: .LinkTableName() = "PartyMast": .LinkDbSource() = dbCtnDatabaseFullPath
.AddLink: .LinkTableName() = "PartyGrpMst": .LinkDbSource() = dbCtnDatabaseFullPath
.AddLink: .LinkTableName() = "PurchHdr": .LinkDbSource() = dbCtnDatabaseFullPath
.AddLink: .LinkTableName() = "PurchDtl": .LinkDbSource() = dbCtnDatabaseFullPath
.AddLink: .LinkTableName() = "SaleHdr": .LinkDbSource() = dbCtnDatabaseFullPath
.AddLink: .LinkTableName() = "SaleDtl": .LinkDbSource() = dbCtnDatabaseFullPath
