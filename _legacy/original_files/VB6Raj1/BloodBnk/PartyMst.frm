...
fcmbAhName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbHmsDatabase, mTableName:="PartyMast", mColumnName:="PrtAhCode", mRtnDefValue:=0))
txtAhName.Text = fcmbAhName.Text
fcmbPgmName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbHmsDatabase, mTableName:="PartyMast", mColumnName:="PrtPgmCode", mRtnDefValue:=0))
txtPgmName.Text = fcmbPgmName.Text
