...
Dim clsAH As clsAccountHead, clsPAT As clsBdkMasterEntry, clsPCG As clsBdkMasterEntry, clsARA As clsComMastEntry, clsSTN As clsComMastEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
Rem Dim clsHOPT As clsHmsOpdOptionsEntry
Dim fcmbAhName As clsComFlexSearch, fcmbAraName As clsComFlexSearch, fcmbStnName As clsComFlexSearch
Dim fcmbPttName As clsBdkFlexSearch, fcmbPttRegNo As clsBdkFlexSearch, fcmbPcgName As clsBdkFlexSearch
...
Set clsPAT = New clsBdkMasterEntry
Set clsPAT.dbAcDatabase = dbAcDatabase
Set clsPAT.dbBdkDatabase = dbBdkDatabase
...
Set fcmbPcgName = New clsBdkFlexSearch
Set fcmbPcgName.dbBdkDatabase = dbBdkDatabase
...
Set fcmbPttRegNo = New clsBdkFlexSearch
Set fcmbPttRegNo.dbBdkDatabase = dbBdkDatabase
Set fcmbPttRegNo.dbComDatabase = dbComDatabase
fcmbPttRegNo.blnPatMastListByRegNo = True
fcmbPttRegNo.Init

Set fcmbPttName = New clsBdkFlexSearch
Set fcmbPttName.dbBdkDatabase = dbBdkDatabase
...
'                    mPttRegNo = GetNextSeqno(dbBdkDatabase, "PatMast", "PttRegNo")
...
'
        If mPttRegNo <> 0 Then
            If ChkIsDuplicate(dbBdkDatabase, "PatMast", "PttRegNo", mPttRegNo, "PttCode", mPttCode) = True Then
...
clsListStru.AddFields mExpr:="PttRegNo", mTitle:="Reg.No", mAlign:=7, mWidth:=1000, mShowItem:=True
