...
Begin VB.Form frmMyMenu 
   ...
   Begin VB.Frame frMasterMenu 
      ...
      End
      Begin VB.CommandButton cmdMasterMenu 
         Caption         =   "Book Publ&ication Master"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
      ...
      End
      Begin VB.CommandButton cmdMasterMenu 
         Caption         =   "Student Ca&tegory Master"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
...
Dim cmdStudMast As Object, cmdPartyMast As Object, cmdBookMast As Object, cmdSubItemMast As Object, cmdStudCatgMast As Object, cmdPartyGrpMast As Object, cmdBookGrpMast As Object, cmdBookPubsMast As Object, cmdBookAthMast As Object, cmdBookEdtnMast As Object, cmdSubItemGrpMast As Object, cmdGodownMast As Object, cmdOpnStock As Object, cmdComMaster As Object, cmdPyrMaster As Object
...
Case cmdCheckDataStru
    ...
    Rem nursing database
    CreateNcbCmpDatabase mAddMode:=False, FormProgStatus:=MyProgStatForm
    CreateNcbMastDatabase mAddMode:=False, FormProgStatus:=MyProgStatForm
    CreateNcbTranDatabase mAddMode:=False, FormProgStatus:=MyProgStatForm
    CreateNcbComDatabase FormProgStatus:=MyProgStatForm
...
Case cmdStudCatgMast
    Load frmStudentCatgMast
    frmStudentCatgMast.Show 1
Case cmdPartyGrpMast
    Load frmPartyGrpMast
    frmPartyGrpMast.Show 1
Case cmdBookGrpMast
    Load frmBookGrpMast
    frmBookGrpMast.Show 1
Case cmdBookPubsMast
    Load frmBookPubsMast
    frmBookPubsMast.Show 1
Case cmdBookAthMast
    Load frmBookAuthorMast
    frmBookAuthorMast.Show 1
Case cmdBookEdtnMast
    Load frmBookEdtnMast
    frmBookEdtnMast.Show 1
Case cmdSubItemGrpMast
    Load frmSubItemGrpMast
    frmSubItemGrpMast.Show 1
Case cmdGodownMast
    Load frmGodownMast
    frmGodownMast.Show 1
Case cmdOpnStock
...
Set cmdStudMast = cmdMasterMenu(0): cmdStudMast.Caption = "Stu&dent Master"
Set cmdPartyMast = cmdMasterMenu(1): cmdPartyMast.Caption = "&Party Master"
Set cmdBookMast = cmdMasterMenu(2): cmdBookMast.Caption = "&Book Master"
Set cmdSubItemMast = cmdMasterMenu(3): cmdSubItemMast.Caption = "&Item Master"
Set cmdStudCatgMast = cmdMasterMenu(4): cmdStudCatgMast.Caption = "Student Ca&tegory Master"
Set cmdPartyGrpMast = cmdMasterMenu(5): cmdPartyGrpMast.Caption = "Party G&roup Master"
Set cmdBookGrpMast = cmdMasterMenu(6): cmdBookGrpMast.Caption = "Book Gro&up Master"
Set cmdBookPubsMast = cmdMasterMenu(7): cmdBookPubsMast.Caption = "Book Publ&ication Master"
Set cmdBookAthMast = cmdMasterMenu(8): cmdBookAthMast.Caption = "Book &Author Master"
Set cmdBookEdtnMast = cmdMasterMenu(9): cmdBookEdtnMast.Caption = "Book &Edition Master"
Set cmdSubItemGrpMast = cmdMasterMenu(10): cmdSubItemGrpMast.Caption = "Item &Group Master"
Set cmdGodownMast = cmdMasterMenu(11): cmdGodownMast.Caption = "Godo&wn Master"
Set cmdOpnStock = cmdMasterMenu(12): cmdOpnStock.Caption = "&Opening Stock"
Set cmdComMaster = cmdMasterMenu(13): cmdComMaster.Caption = "&Standard Master"
Set cmdPyrMaster = cmdMasterMenu(14): cmdPyrMaster.Caption = "Pa&yroll Master"
...
Set cmdStudMast = Nothing: Set cmdPartyMast = Nothing: Set cmdBookMast = Nothing: Set cmdSubItemMast = Nothing: Set cmdStudCatgMast = Nothing: Set cmdPartyGrpMast = Nothing: Set cmdBookGrpMast = Nothing: Set cmdBookPubsMast = Nothing: Set cmdBookAthMast = Nothing: Set cmdBookEdtnMast = Nothing: Set cmdSubItemGrpMast = Nothing: Set cmdGodownMast = Nothing: Set cmdOpnStock = Nothing: Set cmdComMaster = Nothing: Set cmdPyrMaster = Nothing
