...
Begin VB.Form frmHmsOpdOptions 
   Appearance      =   0  'Flat
   BackColor       =   &H80000005&
   ClientHeight    =   9075
   ClientLeft      =   60
   ...
   Begin VB.Frame frFormDtl 
      ...
      Begin VB.Frame frOutdReg 
         ...
         End
      End
      Begin VB.Frame frOutdRgRefd 
         Appearance      =   0  'Flat
         BackColor       =   &H00D2EAFF&
         Caption         =   "Outdoor Reg.Refund (3):"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Frame frOutdPymt 
         Appearance      =   0  'Flat
         BackColor       =   &H00D0F4EE&
         Caption         =   "Outdoor Payment Receipt (5):"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Frame frOutdRefd 
         Appearance      =   0  'Flat
         BackColor       =   &H00FAF4BE&
         Caption         =   "Outdoor Refund Receipt (6):"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Frame frOutdBlPymt 
         Appearance      =   0  'Flat
         BackColor       =   &H00C2E1FF&
         Caption         =   "Outdoor Bill Payment Receipt (8):"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Frame frOutdBlRefd 
         Appearance      =   0  'Flat
         BackColor       =   &H00FAFDEB&
         Caption         =   "Outdoor Bill Refund Receipt (9):"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.ComboBox cmbFormEntryMode 
      ...
      EndProperty
      Height          =   315
      ItemData        =   "HmsOpOpt.frx":0000
      Left            =   0
      List            =   "HmsOpOpt.frx":000D
   ...
   End
End
Attribute VB_Name = "frmHmsOpdOptions"
...
Dim clsOPT As clsHmsOpdOptionsEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
...
Const cOPT_OUTDRGREFD = 3
Const cOPT_OUTDRCPT = 4
Const cOPT_OUTDPYMT = 5
Const cOPT_OUTDREFD = 6
Const cOPT_OUTDBILL = 7
Const cOPT_OUTDBLPYMT = 8
Const cOPT_OUTDBLREFD = 9
...
Set clsOPT = New clsHmsOpdOptionsEntry
...
frOutdRgRefd.Visible = EntryMode And mOptCode = cOPT_OUTDRGREFD: frOutdRgRefd.Enabled = EntryMode And mOptCode = cOPT_OUTDRGREFD
...
Case cOPT_OUTDRGREFD
    With clsOPT
    .ResetInit
    .blnOutdRgRefdOptMast = True
    .Init
    .GetOutdRgRefdOptData
    
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode = " & CStr(cHMS_VTYPE_OUTDOOR_RGREFD) & " order by VtmName"
    fcmbVtmName.ReInit
    
    chkPttRegNoNotZero(mOptCode).Value = IIf(.mOgfPttRegNoNotZero_bln = True, vbChecked, vbUnchecked)
    fcmbVtmName.BoundText = CStr(.mOgfVtmCodeDef_lng): txtVtmName(mOptCode).Text = fcmbVtmName.Text
    ' ---------------
    chkVtmNameCFD(mOptCode).Value = IIf(.mOgfVtmCodeCfd_bln = True, vbChecked, vbUnchecked)
    End With
...
Case cOPT_OUTDRCPT
    ...
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cHMS_VTYPE_OUTDOOR_RCPT) & " order by VtmName"
    fcmbVtmName.ReInit
...
Case cOPT_OUTDPYMT
    ...
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cHMS_VTYPE_OUTDOOR_PYMT) & " order by VtmName"
    fcmbVtmName.ReInit
...
Case cOPT_OUTDREFD
    ...
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cHMS_VTYPE_OUTDOOR_REFD) & " order by VtmName"
    fcmbVtmName.ReInit
...
Case cOPT_OUTDBILL
    ...
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cHMS_VTYPE_OUTDOOR_BILL) & " order by VtmName"
    fcmbVtmName.ReInit
...
Case cOPT_OUTDBLPYMT
    ...
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cHMS_VTYPE_OUTDOOR_BLPYMT) & " order by VtmName"
    fcmbVtmName.ReInit
...
Case cOPT_OUTDBLREFD
    ...
    fcmbVtmName.mListSqlExpr = "Select * from VTypMast where VtmSysCode=" & CStr(cHMS_VTYPE_OUTDOOR_BLREFD) & " order by VtmName"
    fcmbVtmName.ReInit
...
Else
    ...
    ElseIf mOptCode = cOPT_OUTDREG Then
        .GetOutdRegOptData
    ElseIf mOptCode = cOPT_OUTDRGREFD Then
        .GetOutdRgRefdOptData
...
ElseIf mOptCode = cOPT_OUTDRGREFD Then
    .mOgfPttRegNoNotZero_bln = (chkPttRegNoNotZero(mOptCode).Value = vbChecked)
    .mOgfVtmCodeDef_lng = Val(fcmbVtmName.BoundText)
    ' ---------------
    .mOgfVtmCodeCfd_bln = (chkVtmNameCFD(mOptCode).Value = vbChecked)
...
'    Do While .EOF = False
        ...
        If Mfgrd1.Rows < srow + 1 Then
            Mfgrd1.Rows = Mfgrd1.Rows + 1
        End If
        Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OptCode")) = cOPT_OUTDRGREFD
        Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("OptName")) = "Outdoor Reg.Refund"
        ' --------------------------------
        srow = srow + 1
        If Mfgrd1.Rows < srow + 1 Then
            Mfgrd1.Rows = Mfgrd1.Rows + 1
