...
Dim dbAcDatabase As New ADODB.Connection, dbPmtDatabase As New ADODB.Connection, dbGrpDatabase As New ADODB.Connection, dbComDatabase As New ADODB.Connection
Dim datRecset As New ADODB.Recordset
Dim mPrtCode_old As Long, mPrtName_old As String, mPrtAhCode_old As Long, mPrtAraCode_old As Long
Dim clsAH As clsAccountHead, clsPRT As clsPmtMasterEntry, clsARA As clsComMastEntry, clsSTN As clsComMastEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
Dim fcmbAhName As clsComFlexSearch, fcmbAraName As clsComFlexSearch, fcmbStnName As clsComFlexSearch
Dim fcmbPrtName As clsPmtFlexSearch
