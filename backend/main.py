...
from backend.routers import auth, masters, opd, ipd, system, lab, pharmacy, reports, accounts, pathology, drugstock, acctpay
...
app.include_router(pathology.router, prefix="/api/pathology", tags=["pathology"])
app.include_router(drugstock.router, prefix="/api/drugstock", tags=["drugstock"])
app.include_router(acctpay.router, prefix="/api/acctpay", tags=["acctpay"])
