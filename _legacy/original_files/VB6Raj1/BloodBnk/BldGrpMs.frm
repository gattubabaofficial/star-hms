...
Begin VB.Form frmBloodGrpMast 
   ...
   Begin VB.ComboBox cmbFormEntryMode 
      ...
      Enabled         =   0   'False
      Height          =   315
      ItemData        =   "BldGrpMs.frx":0000
      Left            =   0
      List            =   "BldGrpMs.frx":000D
   ...
   End
End
Attribute VB_Name = "frmBloodGrpMast"
...
Dim mBdgCode As Long
Dim mRemoteAccess As Boolean, mEntrySaved As Boolean, mEntryAborted As Boolean
Dim dbBdkDatabase As New ADODB.Connection, datRecset As New ADODB.Recordset
Dim mBdgName_old As String
Dim clsBDG As clsBdkMasterEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure

Public Property Let RemoteAccessCode(ByVal mAccessCode As Long)
mRemoteAccess = True
mBdgCode = mAccessCode
End Property
...
Public Property Get BdgName() As String
BdgName = txtBdgName.Text
End Property
...
Call SmryList
txtSearch1Text_InterActiveChange txtBdgName.Text

''If txtSearch1Text.Text <> txtBdgName.Text Then
''    txtSearch1Text.Text = txtBdgName.Text
''Else
''    Call txtSearch1Text_Change
''End If
''datRecset.Find "BdgName='" & txtBdgName.Text & "'", Start:=1
''ShowRecActiveFlexRow datRecset, Mfgrd1
...
datRecset.open "Select * from BloodGrpMst" _
    & " order by BdgName" _
...
If Val(mskFormBoundField.Text) < 1 And FormAddEditMode = cFORM_EDITMODE Then
    ...
    Exit Function
End If
If Trim(txtBdgName.Text) = "" Then
    ErrorBox "Invalid Group Name !!!"
    txtBdgName.SetFocus
    Exit Function
End If

If txtBdgName.Text <> mBdgName_old Then
    If ChkIsDuplicate(dbBdkDatabase, "BloodGrpMst", "BdgName", txtBdgName.Text, "BdgCode", Val(mskFormBoundField.Text)) = True Then
...
Private Sub txtBdgDesc_GotFocus()
FlashActiveControl txtBdgDesc, True
End Sub

Private Sub txtBdgDesc_LostFocus()
FlashActiveControl txtBdgDesc, False
End Sub

Private Sub txtBdgDesc_Validate(Cancel As Boolean)
txtBdgDesc.Text = ToMyWord(txtBdgDesc.Text)
...
txtBdgName.Text = ToMyWord(txtBdgName.Text)
If Trim(txtBdgName.Text) = "" Then
...
If CanUserAddOpt(mUsrCode:=MyCompany.mUserCode, mMenuOptName:=Me.SecuMenuName) = False Then
    ...
    Exit Sub
End If
If clsBDG.BeginMast(0) = False Then
    Exit Sub
End If
mEntrySaved = False: mEntryAborted = False
...
clsBDG.Clear
mBdgCode = clsBDG.ActiveCode

mskFormBoundField.Text = mBdgCode
txtBdgName.Text = ""
txtBdgDesc.Text = ""

mBdgName_old = txtBdgName.Text
...
If CanUserEditOpt(mUsrCode:=MyCompany.mUserCode, mMenuOptName:=Me.SecuMenuName) = False Then
    ...
    Exit Sub
End If
If clsBDG.BeginMast(datRecset.fields("BdgCode")) = False Then
    Exit Sub
End If
mEntrySaved = False: mEntryAborted = False
FormAddEditMode = cFORM_EDITMODE
With datRecset
mBdgCode = .fields("BdgCode")

clsBDG.GetData mBdgCode

mskFormBoundField.Text = CStr(mBdgCode)

txtBdgName.Text = .fields("BdgName")
txtBdgDesc.Text = .fields("BdgDesc")
End With
...
.mName_str = txtBdgName.Text
.mBdgDesc_str = txtBdgDesc.Text
If FormAddEditMode = cFORM_ADDMODE Then
    If .AddNew() = True Then
...
mBdgCode = datRecset.fields("BdgCode")
mRecAbsPos = datRecset.AbsolutePosition

If clsBDG.CanDeleteMast(mBdgCode) = True Then
    If clsBDG.BeginMast(mBdgCode) = True Then
        clsBDG.DeleteMast mBdgCode
        clsBDG.UpdateMast mBdgCode
        clsBDG.EndMast mBdgCode
...
clsListStru.AddFields mExpr:="BdgCode", mAttrib:=cFAT_SYSTEM
...
If .RecordCount > 0 Then
    Do While .EOF = False
        Mfgrd1.TextMatrix(srow, clsListStru.GetItemIndex("BdgCode")) = .fields("BdgCode")
...
SearchFlex Mfgrd1, clsListStru.GetItemIndex("BdgName"), mText
