...
export default function PathologyFormatsPage() {
  ...
  const loadData = async () => {
    try {
      const res = await fetch(`${API}/api/masters/pathology/test-formats?style=Pathology`, {
        headers: authHdr(),
      });
      if (res.ok) {
        const data = await res.json();
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <div>
          <h1 className={styles.title}>Pathology Test Report Formats</h1>
          <p className={styles.subtitle}>Configure templates and formatting layout style for Pathology diagnostics [PthRptFmt.frm]</p>
        </div>
      </div>
      ...
      {!entryMode ? (
        <div className={styles.listPanel} style={{ width: '100%' }}>
          <div className={styles.searchBar}>
            ...
            <input
              ref={searchInputRef}
              type="text"
              placeholder="Search pathology formats..."
              value={search}
        ...
        <div className={styles.formContainer}>
          <h2 className={styles.formTitle}>
            {editing ? `Edit Format #${editing.TfmCode}: ${editing.TfmName}` : 'New Pathology Format'}
          </h2>
          <form onSubmit={handleSave} className={styles.gridForm}>
            <div className={styles.formGroup}>
              ...
              <input
                ...
                type="text"
                required
                placeholder="e.g. Pathology CBC Format"
                value={form.TfmName}
            ...
            <div className={styles.formGroup}>
              ...
              <input
                type="text"
                placeholder="e.g. Pathology CBC Profile"
