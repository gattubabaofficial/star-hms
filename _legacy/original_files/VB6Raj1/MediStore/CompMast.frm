...
If FormAddEditMode = cFORM_ADDMODE Then
    ...
    CreateMdsCmpDatabase mAddMode:=True
    CreateMdsMastDatabase mAddMode:=True
    CreateMdsTranDatabase mAddMode:=False    ' already created just above
    CreateMdsComDatabase
    
    Rem hospital master database
    CreateHmsMastDatabase mAddMode:=True
