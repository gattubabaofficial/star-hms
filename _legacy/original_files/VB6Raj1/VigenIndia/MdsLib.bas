...
Public Const cMEDSALEPYMT_CRLFILENAME = "MSalPymt.Crl"
...
Public Const cMDS_VTYPE_MEDPURCH = 201
Public Const cMDS_VTYPE_MEDSALE = 202
Public Const cMDS_VTYPE_MEDRETNINW = 203
Public Const cMDS_VTYPE_MEDRETNOUTW = 204
Public Const cMDS_VTYPE_MEDSALE_PYMT = 205
'Public Const cMDS_VTYPE_GENERAL = 201
...
'clsVType.AddType cVGN_VTYPE_OUTDOOR_REFD, "Outdoor Refund"
'clsVType.AddType cVGN_VTYPE_OUTDOOR_BILL, "Outdoor Bill"
'clsVType.AddType cVGN_VTYPE_OUTDOOR_BLPYMT, "Outdoor Bill Payment"
'clsVType.AddType cVGN_VTYPE_OUTDOOR_BLREFD, "Outdoor Bill Refund"
'Rem clsVType.AddType cVGN_VTYPE_OUTDOOR_RGPYMT, "Outdoor Reg. Payment"
'Rem clsVType.AddType cVGN_VTYPE_OUTDOOR_RGREFD, "Outdoor Reg. Refund"
'' ------------------------------------------
'clsVType.AddType cVGN_VTYPE_INDOOR_REG, "Indoor Registration"
'clsVType.AddType cVGN_VTYPE_INDOOR_RCPT, "Indoor Receipt"
'clsVType.AddType cVGN_VTYPE_INDOOR_PYMT, "Indoor Payment"
'clsVType.AddType cVGN_VTYPE_INDOOR_REFD, "Indoor Refund"
'clsVType.AddType cVGN_VTYPE_INDOOR_BILL, "Indoor Bill"
'clsVType.AddType cVGN_VTYPE_INDOOR_BLPYMT, "Indoor Bill Payment"
'clsVType.AddType cVGN_VTYPE_INDOOR_BLREFD, "Indoor Bill Refund"
'clsVType.AddType cVGN_VTYPE_INDOOR_RGPYMT, "Indoor On A/c.Payment"
'clsVType.AddType cVGN_VTYPE_INDOOR_RGREFD, "Indoor On A/c.Refund"
'' --------------------------------------------
'clsVType.AddType cVGN_VTYPE_LAB, "Lab"
...
Public Property Get MedSalePymtCRLFileFullPath(Optional ByVal mFilePath, Optional ByVal mFileName) As String
mFilePath = IIf(IsMissing(mFilePath) = False, mFilePath, sCmpDataPath)  ''' sAppPath
mFileName = IIf(IsMissing(mFileName) = False, mFileName, cMEDSALEPYMT_CRLFILENAME)
MedSalePymtCRLFileFullPath = AddBS(mFilePath) & mFileName
...
'    Else
'        ErrorBox "VgnLibrary_AssignUserOptRightValue_#1349_[Undefined Case]"
'    End If
'Next pos
'
'End Sub
