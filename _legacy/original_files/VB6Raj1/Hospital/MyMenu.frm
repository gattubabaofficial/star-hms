...
Begin VB.Form frmMyMenu 
   ...
   Begin VB.Frame frDiagLabMenu 
      ...
      Top             =   1140
      Width           =   3255
      Begin VB.CommandButton cmdDiagLabMenu 
         Caption         =   "LAB &Receipt"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
   ...
   Begin VB.Frame frMaintenanceMenu 
      ...
      Begin VB.CommandButton cmdMaintenanceMenu 
         Caption         =   "Diagnostic &Lab Options"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
...
Dim cmdHmsMaster As Object, cmdDglMaster As Object, cmdSkpMaster As Object, cmdMdsMaster As Object, cmdComMaster As Object, cmdPyrMaster As Object
...
Dim cmdOutdReg As Object, cmdOutdRgRefd As Object, cmdOutdRcpt As Object, cmdOutdPymt As Object, cmdOutdRefd As Object, cmdOutdBill As Object, cmdOutdBlPymt As Object, cmdOutdBlRefd As Object
...
Dim cmdLabRcpt As Object, cmdLabPymt As Object, cmdLabRefd As Object

Dim cmdSaleEntry As Object, cmdPurchEntry As Object, cmdSaleRetEntry As Object, cmdPurchRetEntry As Object
...
Dim cmdTakeBackup As Object, cmdComOptions As Object, cmdHmsOpdOptions As Object, cmdHmsIpdOptions As Object, cmdHmsLabOptions As Object, cmdAcBalRepost As Object, cmdRemoveNullValue As Object, cmdCheckDataStru As Object
...
Private Sub cmdDiagLabMenu_Click(Index As Integer)
cmdDiagLabMenu(Index).Container.Tag = Index

Select Case Screen.ActiveControl
Case cmdLabRcpt
    ChkFormAccess frmLabReceipt
    
Case cmdLabPymt
    ChkFormAccess frmLabPymtRcpt
    
Case cmdLabRefd
    ChkFormAccess frmLabRefdRcpt
...
Private Sub cmdDiagLabMenu_GotFocus(Index As Integer)
cmdDiagLabMenu(Index).BackColor = cYELLOWLIGHT
End Sub

Private Sub cmdDiagLabMenu_LostFocus(Index As Integer)
cmdDiagLabMenu(Index).BackColor = vbButtonFace
End Sub
...
Case cmdHmsLabOptions
    ChkFormAccess frmHmsLabOptions
...
Case cmdCheckDataStru
    ...
    CreateHmsLabTranDatabase mAddMode:=False, FormProgStatus:=MyProgStatForm
...
Case cmdPurchEntry
    ChkFormAccess frmMedicalPurch, cCOM_VTYPE_PURCHASE
'    Set MyForm = New frmMedicalPurch
'    Load MyForm
...
Case cmdOutdRgRefd
    ChkFormAccess frmOutdoorRgRefund
...
Case 27:
    ...
    ElseIf frDiagLabMenu.Visible = True Then
        frDiagLabMenu.Visible = False
        frMainMenu.Visible = True
...
Set cmdDiagnostic = cmdMainMenu(3): cmdDiagnostic.Caption = "Dia&gnostic Lab"
Set cmdStoreKeeping = cmdMainMenu(4): cmdStoreKeeping.Caption = "&Store Keeping"
Set cmdMedicalStore = cmdMainMenu(5): cmdMedicalStore.Caption = "Medi&cal Store"
...
Set cmdSkpMaster = cmdMasterMenu(2): cmdSkpMaster.Caption = "S&tore Keeping Master"
Set cmdMdsMaster = cmdMasterMenu(3): cmdMdsMaster.Caption = "&Medical Store Master"
...
Set cmdPatMast = cmdHmsMasterMenu(9): cmdPatMast.Caption = "&Patient Master"
...
Set cmdOutdRgRefd = cmdOutdoorMenu(1): cmdOutdRgRefd.Caption = "OPD Reg.&Refund"
Set cmdOutdRcpt = cmdOutdoorMenu(2): cmdOutdRcpt.Caption = "OPD &Receipt"
Set cmdOutdPymt = cmdOutdoorMenu(3): cmdOutdPymt.Caption = "OPD &Payment"
Set cmdOutdRefd = cmdOutdoorMenu(4): cmdOutdRefd.Caption = "OPD Ref&und"
Set cmdOutdBill = cmdOutdoorMenu(5): cmdOutdBill.Caption = "OPD &Bill"
Set cmdOutdBlPymt = cmdOutdoorMenu(6): cmdOutdBlPymt.Caption = "OPD Bill Pa&yment"
Set cmdOutdBlRefd = cmdOutdoorMenu(7): cmdOutdBlRefd.Caption = "OPD Bill R&efund"
...
Rem diagnostic lab entry menu
Set cmdLabRcpt = cmdDiagLabMenu(0): cmdLabRcpt.Caption = "LAB &Receipt"
Set cmdLabPymt = cmdDiagLabMenu(1): cmdLabPymt.Caption = "LAB &Payment"
Set cmdLabRefd = cmdDiagLabMenu(2): cmdLabRefd.Caption = "LAB Ref&und"

Rem medical store entry menu
Set cmdSaleEntry = cmdMediStoreMenu(0): cmdSaleEntry.Caption = "&Sales Entry"
Set cmdPurchEntry = cmdMediStoreMenu(1): cmdPurchEntry.Caption = "&Purchase Entry"
Set cmdSaleRetEntry = cmdMediStoreMenu(2): cmdSaleRetEntry.Caption = "Sales &Return"
Set cmdPurchRetEntry = cmdMediStoreMenu(3): cmdPurchRetEntry.Caption = "Purchase Ret&urn"
...
Set cmdHmsLabOptions = cmdMaintenanceMenu(4): cmdHmsLabOptions.Caption = "Diagnostic &Lab Options"
Set cmdAcBalRepost = cmdMaintenanceMenu(5): cmdAcBalRepost.Caption = "&A/c Balance Reposting"
Set cmdRemoveNullValue = cmdMaintenanceMenu(6): cmdRemoveNullValue.Caption = "&Remove Null Value"
Set cmdCheckDataStru = cmdMaintenanceMenu(7): cmdCheckDataStru.Caption = "&Check Data Structure"
...
mLeft = (Me.Width - frDiagLabMenu.Width) / 2
frDiagLabMenu.Top = mTop: frDiagLabMenu.Left = mLeft
...
Set cmdHmsMaster = Nothing: Set cmdDglMaster = Nothing: Set cmdSkpMaster = Nothing: Set cmdMdsMaster = Nothing: Set cmdComMaster = Nothing: Set cmdPyrMaster = Nothing
...
Set cmdOutdReg = Nothing: Set cmdOutdRgRefd = Nothing: Set cmdOutdRcpt = Nothing: Set cmdOutdPymt = Nothing: Set cmdOutdRefd = Nothing: Set cmdOutdBill = Nothing: Set cmdOutdBlPymt = Nothing: Set cmdOutdBlRefd = Nothing
...
Set cmdLabRcpt = Nothing: Set cmdLabPymt = Nothing: Set cmdLabRefd = Nothing
Set cmdSaleEntry = Nothing: Set cmdPurchEntry = Nothing: Set cmdSaleRetEntry = Nothing: Set cmdPurchRetEntry = Nothing
...
Set cmdTakeBackup = Nothing: Set cmdComOptions = Nothing: Set cmdHmsOpdOptions = Nothing: Set cmdHmsIpdOptions = Nothing: Set cmdHmsLabOptions = Nothing: Set cmdAcBalRepost = Nothing: Set cmdRemoveNullValue = Nothing: Set cmdCheckDataStru = Nothing
