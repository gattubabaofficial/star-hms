...
Dim clsAH As clsAccountHead, clsDCT As clsBdkMasterEntry, clsDCG As clsBdkMasterEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
Dim fcmbAhName As clsComFlexSearch, fcmbDcgName As clsBdkFlexSearch, fcmbDrlName As clsBdkFlexSearch
...
Set fcmbDcgName = New clsBdkFlexSearch
Set fcmbDcgName.dbBdkDatabase = dbBdkDatabase
...
If txtDctName.Text <> mDctName_old Then
    If ChkIsDuplicate(dbBdkDatabase, "DoctMast", "DctName", txtDctName.Text, "DctCode", Val(mskFormBoundField.Text)) = True Then
...
txtDctTitle.Text = "Dr."
txtDctName.Text = ""
fcmbDcgName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbBdkDatabase, mTableName:="DoctMast", mColumnName:="DctDcgCode", mOrderByColName:="DctCode", mRtnDefValue:=0))
...
fcmbAhName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbBdkDatabase, mTableName:="DoctMast", mColumnName:="DctAhCode", mOrderByColName:="DctCode", mRtnDefValue:=0))
txtAhName.Text = fcmbAhName.Text
