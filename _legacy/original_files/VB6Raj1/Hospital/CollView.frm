      ...
      Begin VB.Frame frConfigure 
         ...
         Begin VB.Frame frFilterOpt 
            ...
            Begin VB.CheckBox chkFByLab 
               ...
               Width           =   3495
            End
            Begin VB.CheckBox chkFByLabRefd 
               Appearance      =   0  'Flat
               BackColor       =   &H80000005&
               Caption         =   "Lab Rcpt Refund"
               BeginProperty Font 
                  Name            =   "Verdana"
                  Size            =   8.25
                  Charset         =   0
               ...
               Width           =   3015
            End
            Begin VB.CheckBox chkFByLabPymt 
               Appearance      =   0  'Flat
               BackColor       =   &H80000005&
               Caption         =   "Lab Rcpt Payment"
               BeginProperty Font 
                  Name            =   "Verdana"
                  Size            =   8.25
                  Charset         =   0
            ...
            Begin VB.CheckBox chkFByLabRcpt 
               ...
               Width           =   2895
            End
            Begin VB.CheckBox chkFByOutdRgRefd 
               Appearance      =   0  'Flat
               BackColor       =   &H80000005&
               Caption         =   "Outdoor Reg.Refund"
               BeginProperty Font 
                  Name            =   "Verdana"
                  Size            =   8.25
                  Charset         =   0
...
If mNewValue = 0 Or mNewValue = 1 Then
    ...
    chkFByLabPymt.Value = mNewValue
    chkFByLabRefd.Value = mNewValue
End If
If mNewValue = 0 Then
    chkFByLab.Caption = "Lab Collection (None)"
ElseIf mNewValue = 1 Then
    chkFByLab.Caption = "Lab Collection (All)"
ElseIf mNewValue = 2 Then
    chkFByLab.Caption = "Lab Collection (Partial)"
End If
...
Private Sub chkFByLabPymt_Click()
Call ChkLabItemCheck
Call ChkLabSeleCriteria
End Sub

Private Sub chkFByLabPymt_GotFocus()
FlashActiveControl chkFByLabPymt, True
End Sub

Private Sub chkFByLabPymt_LostFocus()
FlashActiveControl chkFByLabPymt, False
End Sub
...
Private Sub chkFByLabRefd_Click()
Call ChkLabItemCheck
Call ChkLabSeleCriteria
End Sub

Private Sub chkFByLabRefd_GotFocus()
FlashActiveControl chkFByLabRefd, True
End Sub

Private Sub chkFByLabRefd_LostFocus()
FlashActiveControl chkFByLabRefd, False
End Sub
...
If chkFByOutdReg.Value = 1 And chkFByOutdRgRefd.Value = 1 And chkFByOutdRcpt.Value = 1 And chkFByOutdPymt.Value = 1 And chkFByOutdRefd.Value = 1 And chkFByOutdBlPymt.Value = 1 And chkFByOutdBlRefd.Value = 1 Then
    chkFByOutdoor.Value = 1
ElseIf chkFByOutdReg.Value = 1 Or chkFByOutdRgRefd.Value = 1 Or chkFByOutdRcpt.Value = 1 Or chkFByOutdPymt.Value = 1 Or chkFByOutdRefd.Value = 1 Or chkFByOutdBlPymt.Value = 1 Or chkFByOutdBlRefd.Value = 1 Then
...
If chkFByLabRcpt.Value = 1 And chkFByLabPymt.Value = 1 And chkFByLabRefd.Value = 1 Then
    chkFByLab.Value = 1
ElseIf chkFByLabRcpt.Value = 1 Or chkFByLabPymt.Value = 1 Or chkFByLabRefd.Value = 1 Then
    chkFByLab.Value = 2
Else
    chkFByLab.Value = 0
End If
...
ElseIf chkFByLabRcpt.Value = 1 Or chkFByLabPymt.Value = 1 Or chkFByLabRefd.Value = 1 Then
    ...
    End If
    If chkFByLabPymt.Value = 1 Then
        .Caption = .Caption & chkFByLabPymt.Caption & ", "
    End If
    If chkFByLabRefd.Value = 1 Then
        .Caption = .Caption & chkFByLabRefd.Caption & ", "
    End If
    If Right(.Caption, 2) = ", " Then
        .Caption = Left(.Caption, Len(.Caption) - 2)
    End If
...
Private Sub chkFByOutdRgRefd_Click()
Call ChkOutdItemCheck
Call ChkOutdSeleCriteria
End Sub

Private Sub chkFByOutdRgRefd_GotFocus()
FlashActiveControl chkFByOutdRgRefd, True
End Sub

Private Sub chkFByOutdRgRefd_LostFocus()
FlashActiveControl chkFByOutdRgRefd, False
End Sub
...
If optMonthwise.Value = True Or optDatewise.Value = True Or optPatientNamewise.Value = True Or optPatientRegNoWise.Value = True Or optConsDoctorwise.Value = True Or optServiceWise.Value = True Or optServGrpWise.Value = True Or optServGrpNServWise.Value = True Or optVTypewise.Value = True Then
    If optMonthwise.Value = True Then
...
If chkFByLabRcpt.Value = vbChecked Then
    ...
    mQryStr = mQryStr & " Select SrvSgpCode as TrnSgpCode,ServGrpMst.SgpName as TrnSgpName" _
     ...
     & " from (LabRcpt" _
     & " inner join LabHdr on LabRcpt.LrcCode = LabHdr.LhrCode)" _
     & " inner join (ServMast inner join ServGrpMst on ServMast.SrvSgpCode = ServGrpMst.SgpCode) on LabRcpt.LrcSrvCode = ServMast.SrvCode" _
     & " where LrcDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
     & " and LrcCode > 0" _
     & IIf(mQryPttCode > 0, " and LrcPttCode = " & CStr(mQryPttCode), "") _
     & IIf(mQryCDctCode > 0, " and LhrCDctCode = " & CStr(mQryCDctCode), "") _
...
If chkFByOutdRcpt.Value = vbChecked Then
    ...
    mQryStr = mQryStr & " Select " _
     ...
     & " from OutdHdr inner join OutdReg on OutdHdr.OhrOpgCode = OutdReg.OpgCode" _
...
If chkFByLabPymt.Value = vbChecked Then
    ...
    mQryStr = mQryStr & " Select " _
     ...
     & IIf(mQrySgpCode > 0, " and 0 = 1", "") _
     & IIf(mQryVtmCode > 0, " and LphVtmCode = " & CStr(mQryVtmCode), "")
     Rem & ",-111 as TrnSrvCode,'Laboor Rcpt Payment' as TrnSrvName"
End If
Rem lab refund
If chkFByLabRefd.Value = vbChecked Then
    mQryStr = mQryStr & " UNION ALL "
...
ElseIf Shift = vbCtrlMask And KeyCode = vbKeySpace Then
    If srow < Mfgrd1.Rows - 1 And (optDetailed.Value = True Or optExpanded.Value = True) Then
        ...
        If mTrnCode > 0 Then
            ...
            Case cHMS_VTYPE_OUTDOOR_BLPYMT
                Set frmTrn = New frmOutdoorBlPayment
                
            Case cHMS_VTYPE_OUTDOOR_BLREFD
                Set frmTrn = New frmOutdoorBlRefund
