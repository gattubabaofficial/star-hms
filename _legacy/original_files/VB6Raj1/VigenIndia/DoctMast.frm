...
Dim clsAH As clsAccountHead, clsDCT As clsVgnMasterEntry, clsDCG As clsVgnMasterEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
Dim fcmbAhName As clsComFlexSearch, fcmbDcgName As clsVgnFlexSearch, fcmbDrlName As clsVgnFlexSearch
...
Set fcmbDcgName = New clsVgnFlexSearch
Set fcmbDcgName.dbVgnDatabase = dbVgnDatabase
...
If txtDctName.Text <> mDctName_old Then
    If ChkIsDuplicate(dbVgnDatabase, "DoctMast", "DctName", txtDctName.Text, "DctCode", Val(mskFormBoundField.Text)) = True Then
...
If Val(fcmbDcgName.BoundText) < 1 Then
    ErrorBox "Invalid Attendant Category Name !!!"
    txtDcgName.SetFocus
    GoTo EndSub
End If
If Val(fcmbDrlName.BoundText) < 1 Then
    ErrorBox "Invalid Attendant Role !!!"
    txtDrlName.SetFocus
    GoTo EndSub
End If
...
txtDctTitle.Text = "Dr."
txtDctName.Text = ""
fcmbDcgName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbVgnDatabase, mTableName:="DoctMast", mColumnName:="DctDcgCode", mOrderByColName:="DctCode", mRtnDefValue:=0))
txtDcgName.Text = fcmbDcgName.Text
fcmbDrlName.BoundText = "": txtDrlName.Text = ""
txtDctSpeci.Text = ""
txtDctAddr.Text = ""
txtDctTelNo.Text = ""
txtDctEmail.Text = ""
mskDctShare.Text = ToMyPerFmt(0)
fcmbAhName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbVgnDatabase, mTableName:="DoctMast", mColumnName:="DctAhCode", mOrderByColName:="DctCode", mRtnDefValue:=0))
txtAhName.Text = fcmbAhName.Text
...
clsListStru.AddFields mExpr:="DctName", mTitle:="Attendant Name", mAlign:=1, mWidth:=4000, mShowItem:=True
