...
If FormAddEditMode = cFORM_ADDMODE Then
    ...
    CreateGtdCmpDatabase mAddMode:=True, FormProgStatus:=MyProgStatForm
    CreateGtdMastDatabase mAddMode:=True, FormProgStatus:=MyProgStatForm
    CreateGtdTranDatabase mAddMode:=False, FormProgStatus:=MyProgStatForm    ' already created just above
