...
Dim clsAH As clsAccountHead, clsRTO As clsBdkMasterEntry, clsRFG As clsBdkMasterEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
...
If txtRToName.Text <> mRToName_old Then
    If ChkIsDuplicate(dbBdkDatabase, "RefToMast", "RToName", txtRToName.Text, "RToCode", Val(mskFormBoundField.Text)) = True Then
...
fcmbAhName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbBdkDatabase, mTableName:="RefToMast", mColumnName:="RToAhCode", mOrderByColName:="RToCode", mRtnDefValue:=0))
txtAhName.Text = fcmbAhName.Text
