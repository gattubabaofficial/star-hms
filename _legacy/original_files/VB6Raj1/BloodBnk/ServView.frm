      ...
      Begin VB.Frame frConfigure 
         ...
         Begin VB.Frame frFilterOpt 
            ...
            Begin VB.CheckBox chkFByIndrRcpt1 
               ...
               Width           =   3555
            End
            Begin VB.CheckBox chkFByIndrBill1 
               Appearance      =   0  'Flat
               BackColor       =   &H80000005&
               Caption         =   "Indoor Bill"
               BeginProperty Font 
            ...
            Begin VB.CheckBox chkFByOutdoor 
               Appearance      =   0  'Flat
               BackColor       =   &H80000005&
               Caption         =   "Blood Issue Service (All)"
               BeginProperty Font 
                  Name            =   "Verdana"
                  Size            =   8.25
                  Charset         =   0
            ...
            Begin VB.CheckBox chkFByIndoor1 
               ...
               Width           =   3495
            End
            Begin VB.CheckBox chkFByOutdBill1 
               Appearance      =   0  'Flat
               BackColor       =   &H80000005&
...
.mPatNameWise(mIndex) = optEntityNamewise.Value
.mPatRegNoWise(mIndex) = optEntityRegNoWise.Value
...
optEntityNamewise.Value = .mPatNameWise(mIndex)
optEntityRegNoWise.Value = .mPatRegNoWise(mIndex)
...
If chkFByOutdRcpt.Value = 1 Then ''' And chkFByOutdReg.Value = 1 And chkFByOutdBill.Value = 1 Then    ''' And chkFByOutdPymt.Value = 1 And chkFByOutdRefd.Value = 1 And chkFByOutdBlRefd.Value = 1
    chkFByOutdoor.Value = 1
ElseIf chkFByOutdRcpt.Value = 1 Then ''' Or chkFByOutdReg.Value = 1 Or chkFByOutdBill.Value = 1 Then   ''' Or chkFByOutdPymt.Value = 1 Or chkFByOutdRefd.Value = 1 Or chkFByOutdBlRefd.Value = 1
...
mFormOpgUIdFileName = "ServRep.Uid"
mFormOpgAcsPermFileName = "ServRep.Acp"
...
mQryStr = mQryStr & "Select OrcDate as TrnDate" _
 ...
 & ",OrcAmtAftDisc as TrnTotRecdAmt" _
 & ",0 as TrnTotRefdAmt" _
 & ",0 as TrnBalAmt" _
 & " from (OutdRcpt" _
...
'     & " and OblCode > 0" _
'     & IIf(mQryEttCode > 0, " and OblEttCode=" & CStr(mQryEttCode), "") _
...
'     & " and IblCode>0" _
'     & IIf(mQryEttCode > 0, " and IblEttCode=" & CStr(mQryEttCode), "") _
...
'If chkFByOutdBill.Value = vbChecked Then
'    mQryStr = mQryStr & " UNION ALL "
'    mQryStr = mQryStr & " Select OblEttCode as TrnEttCode" _
'     & ",OblAmtAftDisc as TrnAmtAftDisc" _
'     & ",OblDiscAmt as TrnDiscAmt" _
'     & ",OblDepoAmt as TrnTotRecdAmt" _
'     & ",OblRefuAmt as TrnTotRefdAmt" _
...
'If chkFByIndrBill.Value = vbChecked Then
'    mQryStr = mQryStr & " UNION ALL "
'    mQryStr = mQryStr & " Select IblEttCode as TrnEttCode" _
'     & ",IblAmtAftDisc as TrnAmtAftDisc" _
'     & ",IblDiscAmt as TrnDiscAmt" _
'     & ",IblAdvAmt+IblDpogAmt+IblDepoAmt as TrnTotRecdAmt" _
'     & ",IblRfugAmt+IblRefuAmt as TrnTotRefdAmt" _
...
'     & " from (OutdBill" _
'     & " inner join OutdBlHdr on OutdBill.OblCode = OutdBlHdr.ObhCode)" _
'     & " inner join (ServMast inner join ServGrpMst on ServMast.SrvSgpCode = ServGrpMst.SgpCode) on OutdBill.OblSrvCode = ServMast.SrvCode" _
'     & " where OblDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
'     & " and OblCode>0" _
'     & IIf(mQryEttCode > 0, " and OblEttCode=" & CStr(mQryEttCode), "") _
'     & IIf(mQrySrvCode > 0, " and OblSrvCode=" & CStr(mQrySrvCode), "") _
...
'     & " from (IndrBill" _
'     & " inner join IndrBlHdr on IndrBill.IblCode = IndrBlHdr.IbhCode)" _
'     & " inner join (ServMast inner join ServGrpMst on ServMast.SrvSgpCode = ServGrpMst.SgpCode) on IndrBill.IblSrvCode=ServMast.SrvCode" _
'     & " where IblDate between #" & CStr(ToSysDate(Ctod(dtpFromDate.Text))) & "# and #" & CStr(ToSysDate(Ctod(dtpToDate.Text))) & "#" _
'     & " and IblCode>0" _
'     & IIf(mQryEttCode > 0, " and IblEttCode=" & CStr(mQryEttCode), "") _
'     & IIf(mQrySrvCode > 0, " and IblSrvCode=" & CStr(mQrySrvCode), "") _
...
'     & " and ObhCode > 0" _
'     & IIf(mQryEttCode > 0, " and ObhEttCode = " & CStr(mQryEttCode), "") _
'     & IIf(mQrySrvCode > 0, " and True=False", "") _
'     & IIf(mQrySgpCode > 0, " and True=False", "") _
'     & IIf(mQryVtmCode > 0, " and ObhVtmCode = " & CStr(mQryVtmCode), "")
'End If
...
'     & " and IbhCode > 0" _
'     & IIf(mQryEttCode > 0, " and IbhEttCode=" & CStr(mQryEttCode), "") _
'     & IIf(mQrySrvCode > 0, " and True=False", "") _
'     & IIf(mQrySgpCode > 0, " and True=False", "") _
'     & IIf(mQryVtmCode > 0, " and IbhVtmCode=" & CStr(mQryVtmCode), "")
'End If
