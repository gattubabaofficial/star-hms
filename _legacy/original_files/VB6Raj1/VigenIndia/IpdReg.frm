...
Set fcmbOldIpdByIpdNo = New clsVgnFlexSearch
Set fcmbOldIpdByIpdNo.dbVgnDatabase = dbVgnDatabase
Set fcmbOldIpdByIpdNo.dbComDatabase = dbComDatabase
fcmbOldIpdByIpdNo.blnOldIpgListByIpgNo = True
fcmbOldIpdByIpdNo.Init

Set fcmbOldIpdByPttRegNo = New clsVgnFlexSearch
Set fcmbOldIpdByPttRegNo.dbVgnDatabase = dbVgnDatabase
...
Set fcmbOldIpdByPttName = New clsVgnFlexSearch
Set fcmbOldIpdByPttName.dbVgnDatabase = dbVgnDatabase
...
fcmbAraName.BoundText = CStr(clsVGNOPT.GetIndrRegOptBoundCode("IpgAraCode"))
fcmbStnName.BoundText = CStr(clsVGNOPT.GetIndrRegOptBoundCode("IpgStnCode"))
fcmbPcgName.BoundText = CStr(clsVGNOPT.GetIndrRegOptBoundCode("IpgPcgCode"))
fcmbAhName.BoundText = CStr(clsVGNOPT.GetIndrRegOptBoundCode("IpgPttAhCode"))
...
If Val(fcmbAraName.BoundText) = 0 Or Val(fcmbStnName.BoundText) = 0 Or Val(fcmbPcgName.BoundText) = 0 Or Val(fcmbAhName.BoundText) = 0 Then
    With tRecset
    .open "Select * from PatMast where PttCode = (Select top 1 IpgPttCode from IndrReg order by IpgCode desc)", dbVgnDatabase, adOpenKeyset, adLockOptimistic
    If .EOF = False Then
        If Val(fcmbAraName.BoundText) = 0 Then
...
fcmbVtmName.BoundText = CStr(clsVGNOPT.GetIndrRegOptBoundCode("IpgVtmCode"))
fcmbCDctName.BoundText = CStr(clsVGNOPT.GetIndrRegOptBoundCode("IpgCDctCode"))
fcmbRByName.BoundText = CStr(clsVGNOPT.GetIndrRegOptBoundCode("IpgRByCode"))
fcmbFDigName.BoundText = CStr(clsVGNOPT.GetIndrRegOptBoundCode("IpgFDigCode"))
fcmbBdmName.BoundText = CStr(clsVGNOPT.GetIndrRegOptBoundCode("IpgBdmCode"))
...
If Val(fcmbVtmName.BoundText) = 0 Or Val(fcmbCDctName.BoundText) = 0 Or Val(fcmbRByName.BoundText) = 0 Or Val(fcmbFDigName.BoundText) = 0 Or Val(fcmbBdmName.BoundText) = 0 Then
    With tRecset
    .open "Select top 1 * from IndrReg order by IpgCode desc", dbVgnDatabase, adOpenKeyset, adLockOptimistic
    If .EOF = False Then
        If Val(fcmbVtmName.BoundText) = 0 Then
