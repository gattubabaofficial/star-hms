   ...
   Begin VB.Frame frFormDtl 
      ...
      Begin VB.Frame frExtRateSys 
         ...
         Begin VB.CheckBox chkSrvDctwseRateSys 
            ...
            Width           =   5055
         End
         Begin VB.CheckBox chkSrvEtgwseRateSys 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
         ...
         Begin VB.CheckBox chkSrvDctwseDiscSys 
            ...
            Width           =   5055
         End
         Begin VB.CheckBox chkSrvEtgwseDiscSys 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
         ...
         Begin VB.CheckBox chkSrvDctwseBargSys 
            ...
            Width           =   5055
         End
         Begin VB.CheckBox chkSrvEtgwseBargSys 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
         ...
         Begin VB.CheckBox chkSrvDctwseShareSys 
            ...
            Width           =   5055
         End
         Begin VB.CheckBox chkSrvEtgwseShareSys 
            Alignment       =   1  'Right Justify
            Appearance      =   0  'Flat
            BackColor       =   &H80000005&
...
Dim dbBdkDatabase As New ADODB.Connection, dbAcDatabase As New ADODB.Connection, dbGrpDatabase As New ADODB.Connection, dbComDatabase As New ADODB.Connection
Dim datRecset As New ADODB.Recordset
Dim mSrvName_old As String, mSrvIndex_old As Integer, mSrmRow_Old As Integer
Dim clsSRV As clsBdkMasterEntry, clsAH As clsAccountHead, clsSGP As clsBdkMasterEntry, mActiveControl As Object, clsListStru As clsSelectQueryStructure
Dim clsDCT As clsBdkMasterEntry, clsETG As clsBdkMasterEntry, clsRBY As clsBdkMasterEntry, clsRTO As clsBdkMasterEntry
Dim fcmbAhName As clsComFlexSearch, fcmbSgpName As clsBdkFlexSearch, fcmbDctName As clsBdkFlexSearch, fcmbEtgName As clsBdkFlexSearch, fcmbRByName As clsBdkFlexSearch, fcmbRToName As clsBdkFlexSearch

Const X2SRMICODE_COL = 0
Const X2SRMSNO_COL = 1
Const X2DCTNAME_COL = 2
Const X2ETGNAME_COL = 3
Const X2RBYNAME_COL = 4
Const X2RTONAME_COL = 5
Const X2SRMWEFDATE_COL = 6
Const X2SRMSTARTTIMESTR_COL = 7
Const X2SRMENDTIMESTR_COL = 8
Const X2SRMRATE_COL = 9
Const X2SRMDISCPER_COL = 10
Const X2SRMINFBYPER_COL = 11
Const X2SRMDEFBYPER_COL = 12
Const X2SRMSHAREPER_COL = 13
Const X2SRMSHAREAMT_COL = 14
Const X2SRMDCTCODE_COL = 15
Const X2SRMETGCODE_COL = 16
...
Private Sub chkSrvEtgwseRateSys_GotFocus()
FlashActiveControl chkSrvEtgwseRateSys, True
End Sub

Private Sub chkSrvEtgwseRateSys_LostFocus()
FlashActiveControl chkSrvEtgwseRateSys, False
End Sub
...
Private Sub chkSrvEtgwseDiscSys_GotFocus()
FlashActiveControl chkSrvEtgwseDiscSys, True
End Sub

Private Sub chkSrvEtgwseDiscSys_LostFocus()
FlashActiveControl chkSrvEtgwseDiscSys, False
End Sub
...
Private Sub chkSrvEtgwseBargSys_GotFocus()
FlashActiveControl chkSrvEtgwseBargSys, True
End Sub

Private Sub chkSrvEtgwseBargSys_LostFocus()
FlashActiveControl chkSrvEtgwseBargSys, False
End Sub
...
Private Sub chkSrvEtgwseShareSys_GotFocus()
FlashActiveControl chkSrvEtgwseShareSys, True
End Sub

Private Sub chkSrvEtgwseShareSys_LostFocus()
FlashActiveControl chkSrvEtgwseShareSys, False
End Sub
...
If cmdOK.Caption = "&OK" And dtlEditCanceled = False Then
    ...
    Mfgrd2.TextMatrix(srow, X2ETGNAME_COL) = fcmbEtgName.Text
    ...
    Mfgrd2.TextMatrix(srow, X2SRMSTARTTIME_COL) = txtSrmStartTime.Text
    Mfgrd2.TextMatrix(srow, X2SRMENDTIME_COL) = txtSrmEndTime.Text
    ...
    Mfgrd2.TextMatrix(srow, X2SRMETGCODE_COL) = CStr(Val(fcmbEtgName.BoundText))
...
Set clsSGP = New clsBdkMasterEntry
Set clsSGP.dbBdkDatabase = dbBdkDatabase
...
Set fcmbDctName = New clsBdkFlexSearch
Set fcmbDctName.dbBdkDatabase = dbBdkDatabase
...
Set fcmbRToName = New clsBdkFlexSearch
Set fcmbRToName.dbBdkDatabase = dbBdkDatabase
...
Set clsRTO = New clsBdkMasterEntry
Set clsRTO.dbBdkDatabase = dbBdkDatabase
...
colcnt = X2DCTNAME_COL: Mfgrd2.ColWidth(colcnt) = txtDctName.Width: Mfgrd2.TextMatrix(0, colcnt) = "Doctor Name": Mfgrd2.ColAlignment(colcnt) = 1
colcnt = X2ETGNAME_COL: Mfgrd2.ColWidth(colcnt) = txtEtgName.Width: Mfgrd2.TextMatrix(0, colcnt) = "Patient Category": Mfgrd2.ColAlignment(colcnt) = 1
...
colcnt = X2SRMETGCODE_COL: Mfgrd2.ColWidth(colcnt) = 0: Mfgrd2.TextMatrix(0, colcnt) = "X2SRMETGCODE_COL": Mfgrd2.ColAlignment(colcnt) = 7
...
'colcnt = X2ETGNAME_COL: txtEtgName.Left = Mfgrd2.Left + Mfgrd2.ColPos(colcnt)
...
If txtSrvName.Text <> mSrvName_old Then
    If ChkIsDuplicate(dbBdkDatabase, "ServMast", "SrvName", txtSrvName.Text, "SrvCode", Val(mskFormBoundField.Text)) = True Then
...
Else
    With tRecset
    .open "Select SrvCode from ServMast order by SrvCode", dbBdkDatabase, adOpenKeyset, adLockOptimistic
...
txtSrvName.Text = ""
fcmbSgpName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbBdkDatabase, mTableName:="ServMast", mColumnName:="SrvSgpCode", mOrderByColName:="SrvCode", mRtnDefValue:=0))
txtSgpName.Text = fcmbSgpName.Text
fcmbAhName.BoundText = CStr(GetLastValueFromTableCol(cnn:=dbBdkDatabase, mTableName:="ServMast", mColumnName:="SrvAhCode", mOrderByColName:="SrvCode", mRtnDefValue:=0))
txtAhName.Text = fcmbAhName.Text
mskSrvIndex.Text = 0
...
chkSrvEtgwseRateSys.Value = vbUnchecked
...
chkSrvEtgwseDiscSys.Value = vbUnchecked
...
chkSrvEtgwseBargSys.Value = vbUnchecked
...
chkSrvEtgwseShareSys.Value = vbUnchecked
...
chkSrvEtgwseRateSys.Value = IIf(.fields("SrvEtgwseRateSys") = True, vbChecked, vbUnchecked)
...
chkSrvEtgwseDiscSys.Value = IIf(.fields("SrvEtgwseDiscSys") = True, vbChecked, vbUnchecked)
...
chkSrvEtgwseBargSys.Value = IIf(.fields("SrvEtgwseBargSys") = True, vbChecked, vbUnchecked)
...
chkSrvEtgwseShareSys.Value = IIf(.fields("SrvEtgwseShareSys") = True, vbChecked, vbUnchecked)
...
With tRecset
.open "Select * from ServRateMst where SrmCode=" & CStr(mSrmCode) & " order by SrmSno", dbBdkDatabase, adOpenKeyset, adLockOptimistic
If .RecordCount > 0 Then
    Do While .EOF = False
        If InList(.fields("SrmRecState"), Array(cREC_ADDED, cREC_EDITED, cREC_UNCHANGED)) = True Then
            clsDCT.GetData .fields("SrmDctCode")
            clsETG.GetData .fields("SrmEtgCode")
            ...
            Mfgrd2.TextMatrix(srow, X2ETGNAME_COL) = clsETG.mName_str
            ...
            Mfgrd2.TextMatrix(srow, X2SRMSTARTTIME_COL) = MinToTime(.fields("SrmStartTime"))
            Mfgrd2.TextMatrix(srow, X2SRMENDTIME_COL) = MinToTime(.fields("SrmEndTime"))
            ...
            Mfgrd2.TextMatrix(srow, X2SRMETGCODE_COL) = .fields("SrmEtgCode")
...
.mSrvEtgwseRateSys_bln = (chkSrvEtgwseRateSys.Value = vbChecked)
...
.mSrvEtgwseDiscSys_bln = (chkSrvEtgwseDiscSys.Value = vbChecked)
...
.mSrvEtgwseBargSys_bln = (chkSrvEtgwseBargSys.Value = vbChecked)
...
.mSrvEtgwseShareSys_bln = (chkSrvEtgwseShareSys.Value = vbChecked)
...
If .mCode_lng > 0 Then   ' updated successfully
    ...
    tRecset.open "Select * from ServMast where SrvCode<>" & CStr(.mCode_lng) & " and SrvIndex=" & .mSrvIndex_int & "", dbBdkDatabase, adOpenKeyset, adLockOptimistic
    ...
    dbBdkDatabase.BeginTrans
    dbBdkDatabase.Execute "Update ServRateMst set SrmRecState=" & cREC_DELETED & " where SrmCode=" & CStr(mSrvCode)
    
    For srow = 1 To Mfgrd2.Rows - 2
        mSrmICode = Val(Mfgrd2.TextMatrix(srow, X2SRMICODE_COL))
        With tRecset
        .open "Select * from ServRateMst where SrmICode=" & CStr(mSrmICode) & "", dbBdkDatabase, adOpenKeyset, adLockOptimistic
        If mSrmICode < 1 Then
            .AddNew
        ...
        .fields("SrmEtgCode") = Val(Mfgrd2.TextMatrix(srow, X2SRMETGCODE_COL))
        ...
        CloseTable tRecset
    Next srow
    dbBdkDatabase.Execute "Delete from ServRateMst where SrmCode=" & CStr(mSrvCode) & " and SrmRecState=" & cREC_DELETED & ""
    dbBdkDatabase.CommitTrans
...
If clsSRV.CanDeleteMast(mSrvCode) = True Then
    ...
    If clsSRV.BeginMast(mSrvCode) = True Then
        ...
        dbBdkDatabase.BeginTrans
        dbBdkDatabase.Execute "Delete from ServRateMst where SrmCode=" & CStr(mSrvCode) & ""
        dbBdkDatabase.CommitTrans
        ...
        dbBdkDatabase.BeginTrans
        dbBdkDatabase.Execute "Update ServMast set SrvIndex=SrvIndex-1 where SrvIndex>=" & CStr(clsSRV.mSrvIndex_int) & " and SrvCode<>" & CStr(mSrvCode) & ""
        dbBdkDatabase.CommitTrans
...
''        fcmbEtgName.BoundText = Mfgrd2.TextMatrix(srow, X2SRMETGCODE_COL): txtEtgName.Text = fcmbEtgName.Text
...
txtEtgName.Text = "": fcmbEtgName.BoundText = ""
...
srow = Mfgrd2.Row
mDataOk = (Val(UnMyNumFmt(mskSrmSno.Text)) > 0 And (Val(fcmbDctName.BoundText) > 0 Or Val(fcmbEtgName.BoundText) > 0 Or Val(fcmbRByName.BoundText) > 0 Or Val(fcmbRToName.BoundText) > 0 Or TimeToMin(txtSrmEndTime.Text) > TimeToMin(txtSrmStartTime.Text)) And IsDate(Ctod(dtpSrmWefDate.Text)) = True And (UnMyNumFmt(mskSrmRate.Text) > 0 Or UnMyPerFmt(mskSrmDiscPer.Text) > 0 Or UnMyPerFmt(mskSrmInfByPer.Text) > 0 Or UnMyPerFmt(mskSrmDefByPer.Text) > 0 Or UnMyPerFmt(mskSrmSharePer.Text) > 0 Or UnMyNumFmt(mskSrmShareAmt.Text) > 0))
...
Else
    ...
    mSrmEtgCode_tgt = Val(fcmbEtgName.BoundText)
...
For cnt = 1 To mLastRow
    If cnt <> srow Then
        ...
        mSrmEtgCode_src = Val(Mfgrd2.TextMatrix(cnt, X2SRMETGCODE_COL))
        ...
        If mSrmDctCode_src = mSrmDctCode_tgt And mSrmEtgCode_src = mSrmEtgCode_tgt And mSrmRByCode_src = mSrmRByCode_tgt And mSrmRToCode_src = mSrmRToCode_tgt And mSrmWefDate_src = mSrmWefDate_tgt And mSrmStartTime_src = mSrmStartTime_tgt And mSrmEndTime_src = mSrmEndTime_tgt And IIf(mSrmRate_tgt <> 0, mSrmRate_src <> 0, True) And IIf(mSrmInfByPer_tgt <> 0, mSrmInfByPer_src <> 0, True) And IIf(mSrmDefByPer_tgt <> 0, mSrmDefByPer_src <> 0, True) And IIf(mSrmSharePer_tgt <> 0, mSrmSharePer_src <> 0, True) And IIf(mSrmShareAmt_tgt <> 0, mSrmShareAmt_src <> 0, True) Then
...
'If txtEtgName.Text = "" Or Val(fcmbEtgName.BoundText) = 0 Then
