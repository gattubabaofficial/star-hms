...
'Call InitMdsVar
Call InitPyrVar
clsVType.AppName = "Blood Bank"

sAppPath = App.Path
sAppDataPath = sAppPath & "\BdkData"
sCmpDataPath = ""
...
'RemoveHmsNullValue FormProgStatus:=MyProgStatForm
RemoveBdkNullValue FormProgStatus:=MyProgStatForm
'RemoveMdsNullValue FormProgStatus:=MyProgStatForm
